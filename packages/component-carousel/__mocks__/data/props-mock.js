...
for (let index = 0; index < 8; index += 1) {
  ...
  const imageSource =
    index === 5
      ? "https://br0ken"
      : `https://source.unsplash.com/WLUHO9A_xik/${getImageFormat(index)}?a=${
          index - 1
        }`;
...
const imageCarouselItems = [
  {
    id: 1,
    imageSource: "https://source.unsplash.com/WLUHO9A_xik/800x400?a=1",
    imageAltText:
      "Random image with caption below. REPLACE with appropriate alt text for accessibility.",
  },
  {
    id: 2,
    imageSource: "https://source.unsplash.com/IydYk-LGOhc/400x200?a=2",
    imageAltText:
      "Random image with caption below. REPLACE with appropriate alt text for accessibility.",
  },
  {
    id: 3,
    imageSource: "https://source.unsplash.com/WeYamle9fDM/600x400?a=3",
    imageAltText:
      "Random image with caption below. REPLACE with appropriate alt text for accessibility.",
  },
  {
    id: 4,
    imageSource: "https://source.unsplash.com/WLUHO9A_xik/600x600?a=4",
    imageAltText:
      "Random image with caption below. REPLACE with appropriate alt text for accessibility.",
  },
  {
    id: 5,
    imageSource: "https://source.unsplash.com/WeYamle9fDM/600x500?a=5",
    imageAltText:
      "Random image with caption below. REPLACE with appropriate alt text for accessibility.",
  },
];
...
for (let index = 0; index < 8; index += 1) {
  imageGalleryCarouselItems.push({
    id: index,
    imageSource: `https://source.unsplash.com/WLUHO9A_xik/${getImageFormat(
      index
    )}?a=${index - 1}`,
    imageAltText:
      "Random image with caption below. REPLACE with appropriate alt text for accessibility.",
