...
import { Toggle } from "../../../../.storybook-config/Toggle.js";
      ...
      return (
        <AddonPanel key={key} active={!!active}>
          <div style={{ padding: "20px", fontSize: "1rem" }}>
            This component requires Javascript. <br />
            <br />
            View the documentation on{" "}
            <a href="./index.html?path=/docs/get-started-get-started--docs#-including-unity-in-your-project">
