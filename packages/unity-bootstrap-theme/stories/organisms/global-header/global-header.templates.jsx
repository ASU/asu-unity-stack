                              ...
                              <div className="container">
                                <div className="row">
                                  ...
                                  wraps"
                                      data-ga-header-component="link option 3"
                                    >
                                      Another link as an example of when
                                      something wraps
                                    </a>
                                    <a
                                      className="dropdown-item"
                              ...
                              <div className="container">
                                <div className="row">
                                  ...
                                  ultricies sit"
                                      data-ga-header-component="link option 4"
                                    >
                                      Pretium massa quis vitae pede quisque
                                      nulla ultricies sit
                                    </a>
                                    <a
                                      className="dropdown-item"
...
export const ScrolledState = () => (
  <>
    ...
    <main>
      ...
      ></div>
      <div className="bg-grayscale-2" style={{ height: "70vh" }}></div>
      <div className="bg-grayscale-3" style={{ height: "70vh" }}></div>
      <div className="bg-grayscale-4" style={{ height: "70vh" }}></div>
    </main>
  </>
);
