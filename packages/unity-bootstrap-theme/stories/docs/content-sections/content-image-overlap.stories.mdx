...
<Meta title="Organisms/Content Sections/Docs/Content Image Overlap" />
...
- Add the modifier class `content-left` to `<div className='uds-image-overlap">'` to produce the left content variant.
