...
export const ColumnSizingComponent = () => (
  <div className="container">
    ...
    <div className="row row-cols-5">
      ...
      <div className="col">
        <div className="bg-grayscale-1 text-white">
          <h3>Auto</h3>
        </div>
      </div>
      <div className="col">
    ...
    <div className="row row-cols-2 mb-6">
      <div className="col-8">
        <div className="bg-grayscale-6" style={{ height: "20rem" }}>
          <h3>Content Left</h3>
        </div>
      </div>
      <div className="col-4">
      ...
      <div className="col-4">
        <div className="bg-grayscale-4" style={{ height: "20rem" }}>
          <h3>Sidebar</h3>
        </div>
      </div>
      <div className="col-8">
