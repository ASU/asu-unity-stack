...
export const approvedBackgroundColors = () => (
  <Container>
    ...
    <Column col="6">
      <div className="background-panel grayscale-1-bg mb-3"></div>
    </Column>
    <Column col="6">
      <div className="background-panel grayscale-6-bg mb-3"></div>
    </Column>
    <Column col="6">
      <div className="background-panel grayscale-7-bg mb-3"></div>
    </Column>
    <Column col="6">
