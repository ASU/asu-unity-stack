  ...
  <div class="container-fluid mt-2">
    <div class="row">
      <div class="col-12 pb-3">
        <h3>
          <span class="highlight-black">Approved Background Colors</span>
        </h3>
      </div>
...
export const approvedBackgroundPatterns = createStory(
  <div class="container-fluid mt-2">
    <div class="row">
      <div class="col-12 pb-3">
        <h3>
          <span class="highlight-black">Approved Background Patterns</span>
        </h3>
      </div>
...
export const imageBackgrounds = createStory(
  <div class="container-fluid mt-2">
    <div class="row">
      <div class="col-12 pb-3">
        <h3>
          <span class="highlight-black">Image Backgrounds</span>
        </h3>
      </div>
  ...
  <div class="container-fluid max-size-container scaling-container">
    ...
    <div class="content-description-container scaling-container">
      <div class="container scaling-container">
        ...
        <div class="section-line"></div>
        <div class="container content-container">Section Content</div>
      </div>
    </div>
  </div>
);
...
export const PatternDividersAndBackgroundPatterns = createStory(
  <div>
    ...
    <div
      style={{ height: "250px" }}
      class="container-fluid bg morse-code-white"
    ></div>
    <div
      style={{ height: "250px" }}
      class="container-fluid bg morse-code-black"
    ></div>
    <div
      style={{ height: "250px" }}
      class="container-fluid bg topo-white"
    ></div>
    <div
      style={{ height: "250px" }}
      class="container-fluid bg topo-black"
    ></div>
    <div
      style={{ height: "250px" }}
      class="container-fluid bg network-white"
    ></div>
    <div
      style={{ height: "250px" }}
      class="container-fluid bg network-black"
    ></div>
  </div>
);
