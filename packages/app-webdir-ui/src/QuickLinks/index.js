...
const QuickLinks = () => {
  ...
  return (
    <QuickLinksTemplate>
      ...
      <button type="button" onClick={goToFaculty} className="plain-button" >ASU directory</button>
      <a href="https://students.asu.edu/advising">ASU advising directory by college</a>
      <a href="https://www.asu.edu/academics/colleges-schools">ASU's Colleges and schools</a>
      ...
      <a href="https://search.lib.asu.edu/discovery/search?vid=01ASU_INST:01ASU">ASU Library One Search</a>
