...
By default, the Article component will output the news layout for an article, which will not render several props.

The following props render ONLY when passing "event" to the type prop:
        • calendarUrl
        • eventTime
        • eventLocation
        • registrationUrl
...
The following prop renders ONLY when passing "news" to the type prop, which is the default prop value:
        • headerImageUrl
