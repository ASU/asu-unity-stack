...
export default createComponent('Content Sections/Card Arrangements', 'Organisms', 'Templates', extraOptions);
...
export const CardArrangement = createStory(
  (args) => {
    ...
    return (
      <div class={`uds-card-arrangement ${args.vertical ? 'uds-card-arrangement-vertical' : ''}`}>
        ...
        <div class={`uds-card-arrangement-card-container  ${args.autoArrangement ? 'auto-arrangement' : ''}`}>
          { cards }
        </div>
      </div>
    )
