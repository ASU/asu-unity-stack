...
export const FullWidthQuoteOnImageBackground = createStory(
  <div
  ...
  >
    <div class="uds-quote-image-background-container asu-header-align">
...
export const FullWidthQuoteOnImageBackgroundWithImage = createStory(
  <div
    class="uds-quote-image-background"
    style={{
      'background-image':
...
export const AlignedQuoteOnImageBackground = createStory(
  <div class="container">
    <div class="row">
      <div class="col">
