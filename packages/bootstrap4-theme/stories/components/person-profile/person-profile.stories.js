...
export const AlignedPersonProfile = createStory(
  <div class="container">
    <div class="row">
      <div class="col">
        <div class="asu-header-align">
          ...
          <div class="uds-person-profile">
            ...
            <div class="person">
              ...
              <p class="person-description">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sed
                ultrices nisl, at vestibulum tortor. Phasellus ut interdum
                turpis, et dignissim nisi. In sed volutpat lectus. Lorem ipsum
                dolor sit amet.
              </p>
              <ul class="person-social-medias">
                <li>
