...
<div class="uds-tooltip-bg-white">
  <div class="uds-tooltip-container">
    <button tabindex="0" class="uds-tooltip uds-tooltip-white" aria-describedby="tooltip-desc-1">
      <span class="fa-stack">
...
<div class="uds-tooltip-bg-gray-1">
  <div class="uds-tooltip-container">
    <button tabindex="0" class="uds-tooltip uds-tooltip-gray-1" aria-describedby="tooltip-desc-2">
      <span class="fa-stack">
        <i class="fas fa-circle fa-stack-2x"></i>
        <i class="fas fa-info fa-stack-1x"></i>
      </span>
...
<div class="uds-tooltip-bg-gray">
   <div class="uds-tooltip-container">
    <button tabindex="0" class="uds-tooltip uds-tooltip-gray" aria-describedby="tooltip-desc-3">
      <span class="fa-stack">
        <i class="fas fa-circle fa-stack-2x"></i>
        <i class="fas fa-info fa-stack-1x"></i>
      </span>
...
<div class="uds-tooltip-bg-dark">
  <div class="uds-tooltip-container">
    <button tabindex="0" class="uds-tooltip uds-tooltip-dark" aria-describedby="tooltip-desc-4">
      <span class="fa-stack">
        <i class="fas fa-circle fa-stack-2x"></i>
        <i class="fas fa-info fa-stack-1x"></i>
      </span>
