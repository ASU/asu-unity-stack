...
storiesOf('Components/Button Groups', module)
  ...
  .add('Basic example', () => `<div class="btn-group" role="group" aria-label="Basic example">
  <button type="button" class="btn btn-secondary">Left</button>
  <button type="button" class="btn btn-secondary">Middle</button>
  <button type="button" class="btn btn-secondary">Right</button>
</div>`)

  .add('Button toolbar', () => `<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
...
<div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
  ...
  .add('Nesting', () => `<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
  <button type="button" class="btn btn-secondary">1</button>
  <button type="button" class="btn btn-secondary">2</button>
  ...
  .add('Vertical variation', () => `<div class="bd-example">
