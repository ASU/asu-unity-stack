...
export default createComponent('Content Sections/Inset Box');


const BasicExampleMarkUp = (
...
const ExampleWithBlockquoteMarkUp = (
...
export const BasicExample = createStory(
  <div class="container">
    <div class="row">
      { BasicExampleMarkUp }
    </div>
...
export const ExampleWithBlockquote = createStory(
  <div class="container">
    <div class="row">
      { ExampleWithBlockquoteMarkUp }
    </div>
  </div>
)
export const ExampleWithList = createStory(
  <div class="container">
    <div class="row">
      { ExampleWithListMarkUp }
    </div>
  </div>
)
