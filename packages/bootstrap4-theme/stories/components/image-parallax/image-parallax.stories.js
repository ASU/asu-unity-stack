...
export default createComponent('Image Parallax');
...
export const demoTwoImagesInPageOfSections = createStory(
  <div>
    <div
...
export const demoTwoImagesWithContentInPageOfSections = createStory(
  <div>
    <div
      class="d-flex flex-column justify-content-center align-items-center"
      style={{ height: '500px' }}
    ...
    <section class="parallax-container asu-for-you">
      ...
      <div class="parallax-container-content">
        ...
        <p>
          ...
          at every stage of life. ASU for You is the first step in a larger
          movement — a movement that's breaking down education barriers and
          building up high quality, affordable and accessible learning
