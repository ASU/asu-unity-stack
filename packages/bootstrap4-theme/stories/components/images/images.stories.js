...
export default createComponent('Images');
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        {/* Component end */}
        <p>
          Captions can be provided for content inside a figure tag along with a
          figcaption tag. Use a figcaption to provide a summary or additional
          information related to the image that may not be directly apparent
          from reviewing the figure or its alt text. You must still provide alt
          text, but the figcaption should not duplicate it. Web Standards
          captions are limited to 255 chars.
        </p>
      </div>
    </div>
  </div>
