...
.add('Button sizes', () => `<div class="container-fluid"><div class="col col-sm-12 p-3"><button type="button" class="btn btn-gold">Default button</button> <button type="button" class="btn btn-maroon">Default button</button><hr/>
...
<div class="col col-sm-4 bg-dark p-3"><a href="#" class="text-gold">This is a link on a dark background</a></div></div></div>`)
...
.add('Close button', () => `<div class="container-fluid"><div class="row"><div class="col col-sm-4 bg-white p-3"><button type="button" class="btn btn-circle btn-circle-alt-white">x</button></div>
<div class="col col-sm-4 bg-light p-3"><button type="button" class="btn btn-circle btn-circle-alt-gray">x</button></div>
<div class="col col-sm-4 bg-dark p-3"><button type="button" class="btn btn-circle btn-circle-alt-black">x</button></div></div></div>`)

.add('Prev/next buttons', () => `<div class="container-fluid"><div class="row"><div class="col col-sm-4 bg-white p-3"><button type="button" class="btn btn-circle btn-circle-alt-white btn-circle-large"><</button> <button type="button" class="btn btn-circle btn-circle-alt-white btn-circle-large">></button></div>
<div class="col col-sm-4 bg-light p-3"><button type="button" class="btn btn-circle btn-circle-alt-gray btn-circle-large"><</button> <button type="button" class="btn btn-circle btn-circle-alt-gray btn-circle-large">></button></div>
<div class="col col-sm-4 bg-dark p-3"><button type="button" class="btn btn-circle btn-circle-alt-black btn-circle-large"><</button> <button type="button" class="btn btn-circle btn-circle-alt-black btn-circle-large">></button></div></div></div>`);
