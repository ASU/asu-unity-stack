...
export const SidebarComponent = createStory(
  <>
    <div
    ...
    <nav id="sidebar-left" class="sidebar collapse m-4" aria-label="Secondary">
...
export const AlignedSidebar = createStory(
  <div class="container">
    <div class="row">
      <div class="col">
        ...
        <div class="asu-header-align">
          <div class="row">
            ...
            <div class="col-md-8 mt-2">
              <p>
                This story isn't about the page content itself. Rather, you
                should focus your attention on the sidebar navigation element to
                the left.
              </p>
              <p>
