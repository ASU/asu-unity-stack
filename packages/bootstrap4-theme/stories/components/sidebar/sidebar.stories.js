...
storiesOf('Components/Sidebar', module)
  ...
  .add(
    'White Background Sidebar Navigation',
    () => `
  ...
  .add(
    'Gray 7 Background Sidebar Navigation',
    () => `

  <div class="container my-5 gray-7-bg">

    <div class="row mt-4">
      <div class="col-md-12 pb-4"><h1><span class="highlight-gold">Take a look at the sidebar</span></h1></div>
      <div class="col-md-4">

        <h3 class="text-white">Lorem ipsum</h3>
        <!-- Component Start -->
        <nav id="sidebar-left" class="sidebar accordion gray-7-bg" aria-label="Secondary">
      ...
      <div class="col-md-8">
        ...
        <p class="text-white">This story isn't about the page content itself. Rather, you should focus your attention on the sidebar navigation element to the left.</p>
        <p class="text-white">Foldable cards can be mixed in with static navigation links to create a section of content which behaves like an accordion and reveals navigation items which are nested two levels deep.</p>

        <h2 class="text-white">Ligula aenean leo porttitor eu conseq</h2>
        ...
        <h2 class="text-white">Aenean commodo ligula eget dolor aenean massa</h2>
