...
export default createComponent('Content Sections/Card And Image', 'Molecules', 'Templates', extraOptions);

export const LeftFloatedCard = createStory(
  (args) => {
    return (
      <div
          class={`uds-card-and-image ${args.left ? '' : 'uds-card-and-image-right'}`}
          style={{
            'background-image':
