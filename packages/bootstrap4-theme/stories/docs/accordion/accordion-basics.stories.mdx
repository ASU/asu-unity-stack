...
<div className="card card-foldable">
  <div className="card-header">
    <h4>
      <a id="example-header-1" className="collapsed" data-toggle="collapse" href="#example-content-1" role="button" aria-expanded="false" aria-controls="example-content-1">Header Text
        <span className="fas fa-chevron-up"></span>
      </a>
    </h4>
  </div>
  <div id="example-content-1" className="collapse card-body" aria-labelledby="example-header-1">
...
<div className="card card-foldable mt-3 card-maroon">
  <div className="card-header card-header-icon">
    <h4>
      <a id="cardOne" className="collapsed" href="#cardBodyOne" data-toggle="collapse" data-target="#cardBodyOne" role="button" aria-expanded="false" aria-controls="cardBodyOne">
  ...
  <div id="cardOne" className="collapse card-body" aria-labelledby="cardOne">
    ...
  </div>
</div>
```
...
<div className="accordion" id="accordionExample">
  ...
  <div className="card card-foldable mt-3">
    ...
    <div id="cardBodyOne" className="collapse card-body" aria-labelledby="cardOne" data-parent="#accordionExample">
      ...
    </div>
  </div>
  ...
  <div className="card card-foldable mt-3">
    ...
    <div id="cardBodyTwo" className="collapse card-body" aria-labelledby="cardTwo" data-parent="#accordionExample">
      ...
    </div>
  </div>
