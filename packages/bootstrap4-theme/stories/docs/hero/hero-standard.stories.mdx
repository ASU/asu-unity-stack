...
Images optimized for mobile should be cropped to the following dimentions.
...
- A background gradiant is automatically applied to the background image when viewing the hero on a tablet or desktop sized viewport.
...
- The `srcset` sizes offer additional opportinites for art direction via specific cropping of the original image.
...
- For best results, consider including this kind of content within a medium (`uds-hero-md`) or large (`uds-hero-lg`) hero section omly.
...
<div class="uds-hero-lg">
  ...
  <div class="content text-white">
    ...
    <p>If multiple paragraphs are desired, that should be OK in most circumatances.</p>
  </div>
  ...
</div>
```
...
If you would like to prevent this content from being displayed at all, include a `hide-content` class along with the initial size declarartion for the hero.
