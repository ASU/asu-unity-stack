...
<div class="navbar navbar-expand-xl">
    ...
    <div class="navbar-container">
        ...
        <div class="collapse" id="menubar">
            ...
            <div class="navbar-mobile-footer pinned">...</div>
        </div>
    </div>
</div>
```
