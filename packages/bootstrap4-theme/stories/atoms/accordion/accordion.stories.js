...
export default createComponent('Accordions', 'Atoms');

export const FoldableCardDefaultClosed = createStory(
  <div class="card card-foldable">
    <div class="card-header">
      <h4>
        <a
          ...
          href="#example-content-1"
          role="button"
          aria-expanded="false"
          aria-controls="example-content-1"
        >
          This card unfolds.
    ...
    <div
      ...
      aria-labelledby="example-header-1"
    >
    ...
    <div class="card card-foldable mt-3">
      <div class="card-header">
        <h4>
          ...
          >
            These are sections within an accordion.
            <span class="fas fa-chevron-up"></span>
          </a>
        </h4>
      </div>
    ...
    <div class="card card-foldable mt-3">
      <div class="card-header">
        <h4>
          ...
          >
            The inactive panels should collapse while the active one
            expands.
            <span class="fas fa-chevron-up"></span>
          </a>
        </h4>
