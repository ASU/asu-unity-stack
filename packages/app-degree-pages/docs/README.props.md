...
* [ListingPage(props)](#ListingPage) ⇒ <code>JSX.Element</code>
    * [~applyFilters(activeFilters)](#ListingPage..applyFilters)
    * [~onFilterApply(activeFilters)](#ListingPage..onFilterApply)
    * [~onFilterChange(filters)](#ListingPage..onFilterChange)

<a name="ListingPage..applyFilters"></a>

### ListingPage~applyFilters(activeFilters)
**Kind**: inner method of [<code>ListingPage</code>](#ListingPage)  

| Param | Type |
| --- | --- |
| activeFilters | <code>FiltersState</code> | 

<a name="ListingPage..onFilterApply"></a>

### ListingPage~onFilterApply(activeFilters)
**Kind**: inner method of [<code>ListingPage</code>](#ListingPage)  
...
<a name="ListingPage..onFilterChange"></a>

### ListingPage~onFilterChange(filters)
**Kind**: inner method of [<code>ListingPage</code>](#ListingPage)  

| Param | Type |
| --- | --- |
| filters | <code>FiltersState</code> | 
