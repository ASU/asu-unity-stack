...
storiesOf('Kitchen Sink', module)
  ...
  .add('Bootstrap 4 Example ', () => `

  <style>
    h1.section {margin-top:1.5em;}
  </style>
...
<div class="container">
  <div class="row">
    <div class="col">
      ...
      <h1 class="section">Display headings</h1>
      <hr>
      ...
      <h1 class="section">Inline text elements</h1>
      <hr>
      ...
      <h1 class="section">Abbreviations</h1>
      <hr>
      <p><abbr title="attribute">attr</abbr></p>
      <p><abbr title="HyperText Markup Language" class="initialism">HTML</abbr></p>

      <h1 class="section">Blockquotes</h1>
      <hr>
      ...
      <div class="row">
        <div class="col"><img src="http://via.placeholder.com/200x200" class="rounded mx-auto d-block" alt="..."></div>
      </div>
      ...
      <h1 class="section">Table head options</h1>
      <hr>
      <table class="table">
      ...
      <h1 class="section">Striped rows</h1>
      <hr>
      ...
      <h1 class="section">Bordered table</h1>
      <hr>
      ...
      <h1 class="section">Borderless table</h1>
      <hr>
      ...
      <h1 class="section">Hoverable rows</h1>
      <hr>
      ...
      <h1 class="section">Small table</h1>
      <hr>
      ...
      <h1 class="section">Contextual classes</h1>
      <hr>
      <table class="table">
        <thead>
          <tr>
      ...
      <h1 class="section">Alerts > Link color</h1>
      <hr>
      <div class="alert alert-primary" role="alert">
      ...
      <h1 class="section">Badges > Pills</h1>
      ...
      <h1 class="section">Badges > Links</h1>
      ...
      <h1 class="section">Badges > In Elements</h1>
      <hr>
      ...
      <h1 class="section">Badges > In Buttons</h1>
      <hr><button type="button" class="btn btn-primary">
        Notifications <span class="badge badge-light">4</span>
      </button>

      <h1 class="section">Breadcrumbs</h1>
      <hr>
      ...
      <h1 class="section">Buttons > Outline</h1>
      ...
      <h1 class="section">Buttons > Sizes</h1>
      ...
      <h1 class="section">Button groups</h1>
      <hr>
      ...
      <h1 class="section">Button groups > Vertical</h1>
      <hr>
      ...
      <h1 class="section">Button groups > Button Toolbar</h1>
      <hr>
      ...
      <h1 class="section">Button groups > Sizing</h1>
      <hr>
      ...
      <h1 class="section">Cards (No Image)</h1>
      <hr>
      <div class="card" style="width: 18rem;">
        <div class="card-body">
          <h5 class="card-title">Card title</h5>
      ...
      <h1 class="section">Cards > Card styles</h1>
      <hr>
      ...
      <h1 class="section">Cards > Card groups</h1>
      <hr>
      ...
      <h1 class="section">Cards > Card decks</h1>
      <hr>
      <div class="card-deck">
        <div class="card">
          <img class="card-img-top" src="http://via.placeholder.com/400x200" alt="Card image cap">
      ...
      <h1 class="section">Carousel > With Controls</h1>
      <hr>
      ...
      <h1 class="section">Collapse > Multiple targets</h1>
      <hr>
      <p>
      ...
      <h1 class="section">Collapse > Accordion</h1>
      <hr>
      ...
      <h1 class="section">Forms > Form controls</h1>
      <hr>
      <form>
        <div class="form-group">
      ...
      <h1 class="section">Forms > Sizing</h1>
      <hr>
      <form>
      ...
      <h1 class="section">Forms > Checkboxes and radios</h1>
      <hr>
      <form>
      ...
      <h1 class="section">Forms > Custom Elements</h1>
      <hr>
      ...
      <h1 class="section">List group</h1>
      <hr>
      <ul class="list-group">
      ...
      <h1 class="section">List group > Active items</h1>
      <hr>
      <ul class="list-group">
      ...
      <h1 class="section">List group > Disabled items</h1>
      <hr>
      <ul class="list-group">
      ...
      <h1 class="section">List group > Links and buttons</h1>
      <hr>
      ...
      <h1 class="section">List group > Flush</h1>
      <hr>
      ...
      <h1 class="section">List group > Contextual classes</h1>
      <hr>
      <ul class="list-group">
        <li class="list-group-item">Dapibus ac facilisis in</li>
      ...
      <h1 class="section">List group > With badges</h1>
      <hr>
      <ul class="list-group">
      ...
      <h1 class="section">List group > Custom content</h1>
      <hr>
      <div class="list-group">
      ...
      <h1 class="section">Navs > Vertical</h1>
      <hr>
      ...
      <h1 class="section">Navs > Pills</h1>
      <hr>
      ...
      <h1 class="section">Navs > Fill and justify</h1>
      <hr>
      ...
      <h1 class="section">Navbar > Color schemes</h1>
      <hr>
      ...
      <h1 class="section">Pagination</h1>
      <hr>
      ...
      <h1 class="section">Pagination > Disabled and active states</h1>
      <hr>
      <nav aria-label="...">
        <ul class="pagination">
      ...
      <h1 class="section">Progress > Labels</h1>
      <hr>
      <div class="progress">
        <div class="progress-bar" role="progressbar" style="width: 25%;" aria-valuenow="25" aria-valuemin="0"
      ...
      <h1 class="section">Progress > Height</h1>
      <hr>
      ...
      <h1 class="section">Progress > Backgrounds</h1>
      <hr>
      <div class="progress">
      ...
      <h1 class="section">Progress > Multiple bars</h1>
      <hr>
      <div class="progress">
      ...
      <h1 class="section">Progress > Striped</h1>
      <hr>
      <div class="progress">
      ...
      <h1 class="section">Borders > Subtractive</h1>
      <hr>
      ...
      <h1 class="section">Borders > Border color</h1>
      <hr>
      ...
      <h1 class="section">Borders > Border-radius</h1>
      ...
      <h1 class="section">Close icon</h1>
      <hr>
      <div class="clearfix">
      ...
      <h1 class="section">Colors > Background color</h1>
      <hr>
      ...
      <h1 class="section">Display property</h1>
      <hr>
      <div class="d-inline p-2 bg-primary text-white">d-inline</div>
      <div class="d-inline p-2 bg-dark text-white">d-inline</div>
      <span
        class="d-block p-2 bg-primary text-white">d-block</span>
      <span class="d-block p-2 bg-dark text-white">d-block</span>

      <h1 class="section">Floats</h1>
      <hr>
      <div class="clearfix">
      ...
      <h1 class="section">Text alignment</h1>
      <hr>
      ...
      <h1 class="section">Text wrapping and overflow</h1>
      <hr><!-- Block level -->
      <div class="row">
      ...
      <h1 class="section">Text transform</h1>
      <hr>
      <p class="text-lowercase">Lowercased text.</p>
      <p class="text-uppercase">Uppercased text.</p>
      <p class="text-capitalize">CapiTaliZed text.</p>

      <h1 class="section">Font weight and italics</h1>
      <hr>
      ...
      <h1 class="section">Vertical alignment</h1>
