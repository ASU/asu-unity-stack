...
export const gold = () => <Button gold medium onclick={action('clicked')}>Gold button</Button>;
export const maroon = () => <Button maroon medium onclick={action('clicked')}>Maroon button</Button>;
export const light = () => <Button light medium onclick={action('clicked')}>Light button</Button>;
export const dark = () => <Button dark medium onclick={action('clicked')}>Dark button</Button>;
...
export const link = () => <Button gold medium href="https://asu.edu">Gold Link button</Button>;
