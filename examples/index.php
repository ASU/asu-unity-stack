...
<html>
    <head>
        ...
        <script type="text/javascript" src="http://localhost:3000/js/core.js"></script>
    </head>
    <body>
        ...
        <script>
            ...
            ReactDOM.hydrate(React.createElement(ASUnity.core.HeaderContainer, {headerObj: ASUHeader}), document.getElementById("create-asu-header"));
        </script>
