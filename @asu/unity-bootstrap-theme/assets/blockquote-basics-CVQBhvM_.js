import{Y as e}from"./iframe-C5aesD81.js";import{u as o,d as l}from"./blocks-C-K7N3sB.js";import"./preload-helper-Dp1pzeXC.js";import"./index-D6SiRNK3.js";function i(n){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Atoms/Blockquotes and Testimonials/Readme"}),`
...
`})}),`
`,e.jsxs(t.p,{children:["The SVG glyph is the opening double quote glyph from within ",e.jsx(t.strong,{children:"Arial Bold"}),". See the ",e.jsx(t.a,{href:"https://practicaltypography.com/straight-and-curly-quotes.html",rel:"nofollow",children:"following page"})," for details about alternate ways to produce that glyph."]})]})}function h(n={}){const{wrapper:t}={...o(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(i,{...n})}):i(n)}export{h as default};
