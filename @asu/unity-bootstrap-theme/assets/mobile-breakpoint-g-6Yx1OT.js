import{Y as e}from"./iframe-BncExNcm.js";import{u as i,d as r}from"./blocks-CUg8hd1B.js";import"./preload-helper-Dp1pzeXC.js";import"./index-Ct2UYZun.js";function o(t){const n={code:"code",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Organisms/Global Header/Docs/Mobile Breakpoint"}),`
...
`,e.jsxs(n.p,{children:["Locate any instance of ",e.jsx(n.code,{children:"@include media-breakpoint-up(xl)"})," in the SASS partial and replace the ",e.jsx(n.code,{children:"(xl)"})," with the breakpoint of your choice."]})]})}function d(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{d as default};
