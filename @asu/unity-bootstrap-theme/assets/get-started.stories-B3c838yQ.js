import{M as i}from"./chunk-HLWAVYOI-BXyT6gil.js";import{j as e}from"./jsx-runtime-DAFs00V8.js";import{useMDXComponents as r}from"./index-0_jiJ7ii.js";import"./iframe-D5aHw13O.js";import"../sb-preview/runtime.js";import"./index-RYns6xqu.js";import"./react-18-CWbnM-_i.js";import"./index-Cu4lwwaE.js";import"./index-HRfTNzeJ.js";import"./index-DrFu-skq.js";function s(t){const n=Object.assign({h1:"h1",h2:"h2",p:"p",h3:"h3",ul:"ul",li:"li",strong:"strong",a:"a",code:"code",em:"em",h4:"h4",pre:"pre"},r(),t.components);return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Get Started/Get Started"}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Font Awesome is no longer included with Unity!"})," If using in a project outside of webspark, you will need to include Font Awesome yourself. See ",e.jsx(n.a,{href:"https://fontawesome.com/start",target:"_blank",rel:"nofollow noopener noreferrer",children:"here"})," for instructions on how to do that."]}),`
`]}),`
...
`,e.jsx(n.p,{children:`All you need to do is include the script on your page, the scripts will execute with the window load event.
We provide 3 formats ("UMD", "CJS", "ES").`}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsx(n.p,{children:"Unity File Formats"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"dist/js/unity-bootstrap.umd.js"})," (universal)",`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["creates a global variable ",e.jsx(n.code,{children:"unityBootstrap"})," if you need to manaully call the init function ex: ",e.jsx(n.code,{children:"unityBootstrap.initAnchorMenu()"})]}),`
`]}),`
`]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"dist/js/unity-bootstrap.cjs.js"})," (common js)"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"dist/js/unity-bootstrap.es.js"})," (module)"]}),`
`]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(n.p,{children:"Vendor Files"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"dist/js/bootstrap.bundle.min.js"})," (unaltered bootstrap version)"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"dist/js/chart.min.js"})," (only needed if you are using the donut chart)"]}),`
`]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(n.p,{children:"Exports:"}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsx(n.li,{children:e.jsx(n.code,{children:"initDataLayer"})}),`
`,e.jsx(n.li,{children:e.jsx(n.code,{children:"initFixedTable"})}),`
`,e.jsx(n.li,{children:e.jsx(n.code,{children:"initGlobalHeader"})}),`
...
`,e.jsxs(n.p,{children:["See the ",e.jsx(n.a,{href:"https://github.com/ASU/asu-unity-stack?tab=readme-ov-file#how-to-use-the-private-package-registry",target:"_blank",rel:"nofollow noopener noreferrer",children:"Unity README"})," for instructions on how to use the private package registry."]}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.a,{href:"https://asu-tech.slack.com/archives/C01ABUVU8LQ/p1695234506292239",target:"_blank",rel:"nofollow noopener noreferrer",children:"This slack thread"})," has some more information about this issue and using Gulp. ",e.jsx(n.em,{children:"Must be a member of the ASU Community Slack workspace to view."})]}),`
...
`,e.jsxs(n.p,{children:["See ",e.jsx(n.a,{href:"https://github.com/ASU/asu-unity-stack#advanced-details-for-unity-developers-and-contributors",target:"_blank",rel:"nofollow noopener noreferrer",children:"this section"})," of our README for more information about the Unity monorepo and how to contribute to the project."]}),`
...
`,e.jsxs(n.p,{children:["This is enabled using the window ",e.jsx(n.code,{children:"dataLayer"})," object. For components in each package of this repository we take the ",e.jsx(n.code,{children:"dataLayer"})," object, with GTM and the dataLayer having already been initialized (by the host application or CMS - see ",e.jsx(n.a,{href:"https://unity.web.asu.edu",target:"_blank",rel:"nofollow noopener noreferrer",children:"https://unity.web.asu.edu"})," for details on GTM setup), and push events using the ",e.jsx(n.code,{children:"push()"})," method of the ",e.jsx(n.code,{children:"dataLayer"}),". For each object included in the array, Google Tag manager catches that event."]}),`
...
`})}),`
`,e.jsxs(n.p,{children:["Check ",e.jsx(n.a,{href:"https://unity.web.asu.edu/",target:"_blank",rel:"nofollow noopener noreferrer",children:"https://unity.web.asu.edu/"})," as well as the README.md's in individual Unity packages for more Google Analytics, Google Tag Manager and data layer implementation details."]}),`
`,e.jsxs(n.p,{children:["To read more about Google Tag Manager and dataLayer usage, see ",e.jsx(n.a,{href:"https://developers.google.com/tag-platform/tag-manager/datalayer",target:"_blank",rel:"nofollow noopener noreferrer",children:"here"}),"."]})]})}function a(t={}){const{wrapper:n}=Object.assign({},r(),t.components);return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}const d=()=>{throw new Error("Docs-only story")};d.parameters={docsOnly:!0};const o={title:"Get Started/Get Started",tags:["stories-mdx"],includeStories:["__page"]};o.parameters=o.parameters||{};o.parameters.docs={...o.parameters.docs||{},page:a};const f=["__page"];export{f as __namedExportsOrder,d as __page,o as default};
