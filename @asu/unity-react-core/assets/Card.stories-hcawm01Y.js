import{C as u,j as e,d as p}from"./iframe-BM_mM0YI.js";import{i as F}from"./index-BMjp-peT.js";import"./preload-helper-Dp1pzeXC.js";const o=F(),J={title:"Components/Card",component:u,parameters:{docs:{description:{component:`The Card component can be used to generate UDS-compliant default, degree, story, news and event cards.
...
The \`cardLink\` prop provides the destination URL.
  ...
  </div>`,...(I=(W=m.parameters)==null?void 0:W.docs)==null?void 0:I.source}}};const K=["Default","DefaultBorderless","Icon","Degree","Event","News","Story","HorizontalStoryCard","AsuNewsStory"];export{m as AsuNewsStory,s as Default,t as DefaultBorderless,r as Degree,i as Event,d as HorizontalStoryCard,c as Icon,l as News,n as Story,K as __namedExportsOrder,J as default};
