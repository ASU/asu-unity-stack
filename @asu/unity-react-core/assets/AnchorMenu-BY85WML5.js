import{j as a}from"./jsx-runtime-VU7BY01E.js";import{r as u}from"./index-BebQxa19.js";import{q as N}from"./html-utils-K3upQ8ml.js";import{t as R,d as F}from"./timers-DqmY83kz.js";import{P as r}from"./Layout-BJiG6VbP.js";import{c as w}from"./index-X6w4Ppxe.js";import{B as L}from"./Button-DLkUS2dB.js";import{u as P,G as T}from"./GaEventWrapper-CYSgpRo7.js";import{q as O}from"./styled-components.browser.esm-BltV_-4f.js";function D(t){const[c,p]=u.useState(!1);return u.useEffect(()=>{const s=window.matchMedia(t);s.matches!==c&&p(s.matches);const f=()=>{p(s.matches)};return s.addEventListener("change",f),()=>s.removeEventListener("change",f)},[c,t]),c}const $=O.div`
  &.sticky {
    position: fixed;
    top: 0;
    left: 0;
