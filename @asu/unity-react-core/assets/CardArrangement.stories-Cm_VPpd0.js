...
/>
\`\`\`
      `}}};const m=a.bind({});m.args={cards:Z,cardType:"ranking",columns:2};m.storyName="Ranking cards (small)";m.parameters={docs:{description:{story:`
...
\`\`\`
    ...
    <CardArrangement {...args} />
  </div>`,...(D=(M=c.parameters)==null?void 0:M.docs)==null?void 0:D.source}}};var W,B,F;m.parameters={...m.parameters,docs:{...(W=m.parameters)==null?void 0:W.docs,source:{originalSource:`args => <div className="container">
    <CardArrangement {...args} />
  </div>`,...(F=(B=m.parameters)==null?void 0:B.docs)==null?void 0:F.source}}};var H,P,O;l.parameters={...l.parameters,docs:{...(H=l.parameters)==null?void 0:H.docs,source:{originalSource:`args => <div className="container">
    <CardArrangement {...args} />
  </div>`,...(O=(P=l.parameters)==null?void 0:P.docs)==null?void 0:O.source}}};const te=["ThreeColumns","TwoColumns","FourColumns","HorizontalCards","SingleColumn","MixedCardTypesNoColProvided","WithoutImages","RankingCardsLarge","RankingCardsSmall","ImageCards"];export{i as FourColumns,o as HorizontalCards,l as ImageCards,s as MixedCardTypesNoColProvided,c as RankingCardsLarge,m as RankingCardsSmall,n as SingleColumn,r as ThreeColumns,t as TwoColumns,d as WithoutImages,te as __namedExportsOrder,re as default};
