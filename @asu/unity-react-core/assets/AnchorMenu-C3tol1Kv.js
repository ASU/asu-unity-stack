import{j as a}from"./jsx-runtime-Dmx1myWC.js";import{c as w}from"./index-DbSsuYgj.js";import{P as r}from"./index-Cqy-YfF9.js";import{r as u}from"./index-mEo-t6td.js";import{q as N}from"./html-utils-CCLBBnXX.js";import{t as R,d as F}from"./timers-DqmY83kz.js";import"./googleAnalytics-bhG-ZSut.js";import{B as L}from"./Button-CLsasMTo.js";import{u as P,G as T}from"./GaEventWrapper-D-bs3D7C.js";import{q as O}from"./styled-components.browser.esm-DabYpdjN.js";function D(t){const[c,p]=u.useState(!1);return u.useEffect(()=>{const s=window.matchMedia(t);s.matches!==c&&p(s.matches);const f=()=>{p(s.matches)};return s.addEventListener("change",f),()=>s.removeEventListener("change",f)},[c,t]),c}const $=O.div`
  &.sticky {
    position: fixed;
    top: 0;
    left: 0;
