import{j as q}from"./jsx-runtime-Dmx1myWC.js";import"./index-mEo-t6td.js";import"./Layout-E1v40Iot.js";import{i as E}from"./index-BMjp-peT.js";import{H as f}from"./Hero-BFWGZ34s.js";import"./_commonjsHelpers-B3tUAs5q.js";import"./index-DbSsuYgj.js";import"./shared-prop-types-Xcv4Laxd.js";import"./styled-components.browser.esm-DabYpdjN.js";const s=E(),G={title:"Components/Heroes",component:f,parameters:{docs:{description:{component:" "}}},argTypes:{title:{control:{type:"object"},description:"Options for highlightColor are gold, white, black, or none"}}},i=({image:z,title:P,contents:_,contentsColor:k})=>q.jsx(f,{title:P,image:z,contents:_,contentsColor:k}),e=i.bind({});e.args={image:{url:s,altText:"Hero image",size:"small"},title:{text:"Heading with a long title 1",highlightColor:"none"}};e.parameters={docs:{description:{story:" "}}};const t=i.bind({});t.args={image:{url:s,altText:"Hero image",size:"small"},title:{text:"Heading with a long title 2",highlightColor:"gold",maxWidth:"100%"}};t.parameters={docs:{description:{story:" "}}};const o=i.bind({});o.args={image:{url:s,altText:"Hero image",size:"medium"},title:{text:"Heading 1",highlightColor:"black"},contentsColor:"white",contents:[{text:`Lorem ipsum dolor sit amet, consectetur adipiscing elit,
     ...
     sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`}]};r.parameters={docs:{description:{story:" "}}};var n,a,c,m,l;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`({
  image,
  title,
  contents,
  contentsColor
}) => <Hero title={title} image={image} contents={contents} contentsColor={contentsColor} />`,...(c=(a=e.parameters)==null?void 0:a.docs)==null?void 0:c.source},description:{story:"@type {{ args: HeroProps, parameters: object }}",...(l=(m=e.parameters)==null?void 0:m.docs)==null?void 0:l.description}}};var p,d,g,u,H;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`({
  image,
  title,
  contents,
  contentsColor
  ...
  contents,
  contentsColor
}) => <Hero title={title} image={image} contents={contents} contentsColor={contentsColor} />`,...(w=(T=r.parameters)==null?void 0:T.docs)==null?void 0:w.source},description:{story:"@type {{ args: HeroProps, parameters: object }}",...(S=(L=r.parameters)==null?void 0:L.docs)==null?void 0:S.description}}};const I=["HeroSmall","HeroLongTitle","HeroMedium","HeroLarge"];export{r as HeroLarge,t as HeroLongTitle,o as HeroMedium,e as HeroSmall,I as __namedExportsOrder,G as default};
