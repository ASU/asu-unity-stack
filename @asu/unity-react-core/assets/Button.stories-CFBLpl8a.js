...
<Button
  onClick: handleClick,
/>Default Button</Button>`}}};const r=n.bind({});r.args={color:"gold",label:"Small Gold Button",onClick:o,size:"small"};r.parameters={docs:{description:{story:`When the Button component is provided with an onClick handler function, the Button is rendered as a \`<button type="button">\`.
...
<Button
  ...
  onClick: handleClick,
  size: "small",
/>Small Gold Button</Button>`}}};const l=n.bind({});l.args={color:"gold",icon:["fas","rocket"],label:"Icon Button",onClick:o};l.parameters={docs:{description:{story:`To include a Font Awesome icon in the button label, import the desired React icon and pass it to the Button component via the \`icon\` prop.:
...
<Router>
...
}`,...(B=(v=a.parameters)==null?void 0:v.docs)==null?void 0:B.source}}};var g,f,b;r.parameters={...r.parameters,docs:{...(g=r.parameters)==null?void 0:g.docs,source:{originalSource:`args => {
  return <div className="container-fluid">
      <div className="col col-sm-12 p-3">
        <Button {...args} />
      </div>
    </div>;
}`,...(b=(f=r.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};var C,x,y;l.parameters={...l.parameters,docs:{...(C=l.parameters)==null?void 0:C.docs,source:{originalSource:`args => {
  return <div className="container-fluid">
      <div className="col col-sm-12 p-3">
        <Button {...args} />
      </div>
    </div>;
}`,...(y=(x=l.parameters)==null?void 0:x.docs)==null?void 0:y.source}}};var R,w,N;s.parameters={...s.parameters,docs:{...(R=s.parameters)==null?void 0:R.docs,source:{originalSource:`args => {
  return <div className="container-fluid">
      <div className="col col-sm-12 p-3">
        <Button {...args} />
      </div>
  ...
  </div>`,...(E=(M=m.parameters)==null?void 0:M.docs)==null?void 0:E.source}}};const le=["DefaultButton","SmallGoldButton","IconButton","LinkButton","TargetBlankButton","ReactRouterLinkButton","FilledButton","OutlineButton","BorderlessButton","AllVariants"];export{m as AllVariants,u as BorderlessButton,a as DefaultButton,c as FilledButton,l as IconButton,s as LinkButton,d as OutlineButton,i as ReactRouterLinkButton,r as SmallGoldButton,p as TargetBlankButton,le as __namedExportsOrder,re as default};
