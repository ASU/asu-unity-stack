import{j as o}from"./jsx-runtime-Dmx1myWC.js";import{c as w}from"./index-DbSsuYgj.js";import{P as i}from"./index-Cqy-YfF9.js";import{r as d}from"./index-mEo-t6td.js";import{q as N}from"./html-utils-CCLBBnXX.js";import"./googleAnalytics-bhG-ZSut.js";import{B as R}from"./Button-DpoLhx_d.js";import{G as T}from"./GaEventWrapper-DdP7fsIO.js";import{q as L}from"./styled-components.browser.esm-DabYpdjN.js";function P(t){const[a,p]=d.useState(!1);return d.useEffect(()=>{const r=window.matchMedia(t);r.matches!==a&&p(r.matches);const l=()=>{p(r.matches)};return r.addEventListener("change",l),()=>r.removeEventListener("change",l)},[a,t]),a}let y=!1;const F=(t,a)=>{y||(y=!0,setTimeout(()=>{t(),y=!1},a))};let k;const O=(t,a)=>{window.clearTimeout(k),k=window.setTimeout(t,a)},D=L.div`
  &.sticky {
    position: fixed;
    top: 0;
    left: 0;
