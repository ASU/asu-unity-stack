import{j as g}from"./jsx-runtime-VU7BY01E.js";import"./index-BebQxa19.js";import"./Layout-XUDhei8Q.js";import{i as q}from"./index-BMjp-peT.js";import{C as V}from"./CardArrangement-Bbn7oH-0.js";import"./_commonjsHelpers-NT8qMgGI.js";import"./index-X6w4Ppxe.js";import"./Card-BMRrGTJt.js";import"./html-utils-Cf06jDgj.js";import"./Button-B8s0eqac.js";import"./shared-prop-types-BiNDl1K6.js";import"./GaEventWrapper-C3Yx4ICT.js";import"./ButtonTag-B62aadc1.js";import"./Image-DPWP6VF1.js";import"./styled-components.browser.esm-BltV_-4f.js";import"./RankingCard-C5z4J8Tu.js";const e=q(),ye={title:"Components/Card Arrangement",component:V,argTypes:{cards:{description:'Array of card objects to render. Each object should contain props for the Card, Image or RankingCard component. Cards will wrap naturally based on their intrinsic min/max widths. When using the Card component, cards can supply a type of "default", "degree", "event" or "story"'}},parameters:{docs:{description:{component:`The CardArrangement component renders multiple cards that wrap naturally based on their intrinsic sizing.
...
/>
\`\`\`
      `}}};const c=a.bind({});c.args={cards:Z,cardType:"ranking",columns:2};c.storyName="Ranking cards (small)";c.parameters={docs:{description:{story:`
...
/>
\`\`\`
      `}}};const l=a.bind({});l.args={cards:X,cardType:"image",columns:3};l.storyName="Image cards";l.parameters={docs:{description:{story:`
...
\`\`\`
    ...
    <CardArrangement {...args} />
  </div>`,...(U=(I=d.parameters)==null?void 0:I.docs)==null?void 0:U.source}}};var j,M,D;m.parameters={...m.parameters,docs:{...(j=m.parameters)==null?void 0:j.docs,source:{originalSource:`args => <div className="container">
    <CardArrangement {...args} />
  </div>`,...(D=(M=m.parameters)==null?void 0:M.docs)==null?void 0:D.source}}};var W,B,F;c.parameters={...c.parameters,docs:{...(W=c.parameters)==null?void 0:W.docs,source:{originalSource:`args => <div className="container">
    <CardArrangement {...args} />
  </div>`,...(F=(B=c.parameters)==null?void 0:B.docs)==null?void 0:F.source}}};var H,P,O;l.parameters={...l.parameters,docs:{...(H=l.parameters)==null?void 0:H.docs,source:{originalSource:`args => <div className="container">
    <CardArrangement {...args} />
  </div>`,...(O=(P=l.parameters)==null?void 0:P.docs)==null?void 0:O.source}}};const ue=["ThreeColumns","TwoColumns","FourColumns","HorizontalCards","SingleColumn","MixedCardTypesNoColProvided","WithoutImages","RankingCardsLarge","RankingCardsSmall","ImageCards"];export{i as FourColumns,o as HorizontalCards,l as ImageCards,s as MixedCardTypesNoColProvided,m as RankingCardsLarge,c as RankingCardsSmall,n as SingleColumn,r as ThreeColumns,t as TwoColumns,d as WithoutImages,ue as __namedExportsOrder,ye as default};
