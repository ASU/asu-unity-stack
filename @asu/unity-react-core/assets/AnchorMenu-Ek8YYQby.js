import{j as a}from"./jsx-runtime-Dmx1myWC.js";import{r as u}from"./index-mEo-t6td.js";import{q as N}from"./html-utils-b2f94cik.js";import{t as R,d as F}from"./timers-DqmY83kz.js";import{P as r}from"./Layout-E1v40Iot.js";import{c as w}from"./index-DbSsuYgj.js";import{B as L}from"./Button-J9laBm1Z.js";import{u as P,G as T}from"./GaEventWrapper-B6VcQiAT.js";import{q as O}from"./styled-components.browser.esm-DabYpdjN.js";function D(t){const[c,p]=u.useState(!1);return u.useEffect(()=>{const s=window.matchMedia(t);s.matches!==c&&p(s.matches);const f=()=>{p(s.matches)};return s.addEventListener("change",f),()=>s.removeEventListener("change",f)},[c,t]),c}const $=O.div`
  &.sticky {
    position: fixed;
    top: 0;
    left: 0;
