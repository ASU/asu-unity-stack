...
Ke || (Ke = function(e, n, a) {
  return e.apply(n, a);
});
Ze || (Ze = function(e, n) {
  return new e(...n);
});
const ie = G(Array.prototype.forEach), io = G(Array.prototype.lastIndexOf), oa = G(Array.prototype.pop), Ht = G(Array.prototype.push), so = G(Array.prototype.splice), fe = G(String.prototype.toLowerCase), Me = G(String.prototype.toString), ia = G(String.prototype.match), jt = G(String.prototype.replace), lo = G(String.prototype.indexOf), co = G(String.prototype.trim), K = G(Object.prototype.hasOwnProperty), W = G(RegExp.prototype.test), zt = fo(TypeError);
function G(t) {
  return function(e) {
...
function Za() {
  ...
  const Bn = w({}, [...sa, ...He, ...je, ...ze, ...la]);
  let F = null;
  const kn = w({}, [...ca, ...Xe, ...fa, ...se]);
  ...
  })), Bt = null, Ce = null, Fn = !0, Pe = !0, Rn = !1, Mn = !0, ht = !1, Ne = !0, dt = !1, Se = !1, Le = !1, bt = !1, $t = !1, te = !1, Hn = !0, jn = !1;
  const Gr = "user-content-";
  let De = !0, kt = !1, vt = {}, yt = null;
  ...
  let wt = nt, Be = !1, ke = null;
  const Yr = w({}, [ee, ne, nt], Me);
  ...
  const Vr = n.createElement("form"), Gn = function(i) {
    ...
    if (!(Tt && Tt === i)) {
      ...
      Jr.indexOf(i.PARSER_MEDIA_TYPE) === -1 ? Qr : i.PARSER_MEDIA_TYPE, B = Ft === "application/xhtml+xml" ? Me : fe, I = K(i, "ALLOWED_TAGS") ? w({}, i.ALLOWED_TAGS, B) : Bn, F = K(i, "ALLOWED_ATTR") ? w({}, i.ALLOWED_ATTR, B) : kn, ke = K(i, "ALLOWED_NAMESPACES") ? w({}, i.ALLOWED_NAMESPACES, Me) : Yr, Ie = K(i, "ADD_URI_SAFE_ATTR") ? w(mt(Un), i.ADD_URI_SAFE_ATTR, B) : Un, Xn = K(i, "ADD_DATA_URI_TAGS") ? w(mt(Wn), i.ADD_DATA_URI_TAGS, B) : Wn, yt = K(i, "FORBID_CONTENTS") ? w({}, i.FORBID_CONTENTS, B) : zn, Bt = K(i, "FORBID_TAGS") ? w({}, i.FORBID_TAGS, B) : {}, Ce = K(i, "FORBID_ATTR") ? w({}, i.FORBID_ATTR, B) : {}, vt = K(i, "USE_PROFILES") ? i.USE_PROFILES : !1, Fn = i.ALLOW_ARIA_ATTR !== !1, Pe = i.ALLOW_DATA_ATTR !== !1, Rn = i.ALLOW_UNKNOWN_PROTOCOLS || !1, Mn = i.ALLOW_SELF_CLOSE_IN_ATTR !== !1, ht = i.SAFE_FOR_TEMPLATES || !1, Ne = i.SAFE_FOR_XML !== !1, dt = i.WHOLE_DOCUMENT || !1, bt = i.RETURN_DOM || !1, $t = i.RETURN_DOM_FRAGMENT || !1, te = i.RETURN_TRUSTED_TYPE || !1, Le = i.FORCE_BODY || !1, Hn = i.SANITIZE_DOM !== !1, jn = i.SANITIZE_NAMED_PROPS || !1, De = i.KEEP_CONTENT !== !1, kt = i.IN_PLACE || !1, In = i.ALLOWED_URI_REGEXP || Va, wt = i.NAMESPACE || nt, ae = i.MATHML_TEXT_INTEGRATION_POINTS || ae, re = i.HTML_INTEGRATION_POINTS || re, P = i.CUSTOM_ELEMENT_HANDLING || {}, i.CUSTOM_ELEMENT_HANDLING && Gn(i.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (P.tagNameCheck = i.CUSTOM_ELEMENT_HANDLING.tagNameCheck), i.CUSTOM_ELEMENT_HANDLING && Gn(i.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (P.attributeNameCheck = i.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), i.CUSTOM_ELEMENT_HANDLING && typeof i.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (P.allowCustomizedBuiltInElements = i.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), ht && (Pe = !1), $t && (bt = !0), vt && (I = w({}, la), F = [], vt.html === !0 && (w(I, sa), w(F, ca)), vt.svg === !0 && (w(I, He), w(F, Xe), w(F, se)), vt.svgFilters === !0 && (w(I, je), w(F, Xe), w(F, se)), vt.mathMl === !0 && (w(I, ze), w(F, fa), w(F, se))), i.ADD_TAGS && (I === Bn && (I = mt(I)), w(I, i.ADD_TAGS, B)), i.ADD_ATTR && (F === kn && (F = mt(F)), w(F, i.ADD_ATTR, B)), i.ADD_URI_SAFE_ATTR && w(Ie, i.ADD_URI_SAFE_ATTR, B), i.FORBID_CONTENTS && (yt === zn && (yt = mt(yt)), w(yt, i.FORBID_CONTENTS, B)), De && (I["#text"] = !0), dt && w(I, ["html", "head", "body"]), I.table && (w(I, ["tbody"]), delete Bt.tbody), i.TRUSTED_TYPES_POLICY) {
  ...
  }, Yn = w({}, [...He, ...je, ...mo]), qn = w({}, [...ze, ...po]), Kr = function(i) {
    let f = S(i);
    (!f || !f.tagName) && (f = {
      namespaceURI: wt,
      tagName: "template"
    ...
    return ke[i.namespaceURI] ? i.namespaceURI === ne ? f.namespaceURI === nt ? A === "svg" : f.namespaceURI === ee ? A === "svg" && (E === "annotation-xml" || ae[E]) : !!Yn[A] : i.namespaceURI === ee ? f.namespaceURI === nt ? A === "math" : f.namespaceURI === ne ? A === "math" && re[E] : !!qn[A] : i.namespaceURI === nt ? f.namespaceURI === ne && !re[E] || f.namespaceURI === ee && !ae[E] ? !1 : !qn[A] && (qr[A] || !Yn[A]) : !!(Ft === "application/xhtml+xml" && ke[i.namespaceURI]) : !1;
  }, Z = function(i) {
    Ht(e.removed, {
      element: i
    });
    ...
    if (!f || !f.documentElement) {
      ...
      try {
        f.documentElement.innerHTML = Be ? k : E;
      } catch {
      }
    }
  ...
  const Kn = function(i) {
    let f = null;
    if (at(z.beforeSanitizeElements, i, null), Re(i))
      return Z(i), !0;
    const A = B(i.nodeName);
    if (at(z.uponSanitizeElement, i, {
      tagName: A,
      allowedTags: I
    }), i.hasChildNodes() && !Vn(i.firstElementChild) && W(/<[/\w!]/g, i.innerHTML) && W(/<[/\w!]/g, i.textContent) || i.nodeType === Wt.progressingInstruction || Ne && i.nodeType === Wt.comment && W(/<[/\w]/g, i.data))
      return Z(i), !0;
    if (!I[A] || Bt[A]) {
    ...
    return i instanceof u && !Kr(i) || (A === "noscript" || A === "noembed" || A === "noframes") && W(/<\/no(script|embed|frames)/i, i.innerHTML) ? (Z(i), !0) : (ht && i.nodeType === Wt.text && (f = i.textContent, ie([Oe, xe, Ee], (E) => {
      f = jt(f, E, " ");
    ...
    for (; E--; ) {
      ...
      if (A.attrName = Rt, A.attrValue = X, A.keepAttr = !0, A.forceKeepAttr = void 0, at(z.uponSanitizeAttribute, i, A), X = A.attrValue, jn && (Rt === "id" || Rt === "name") && (oe(R, i), X = Gr + X), Ne && W(/((--!?|])>)|<\/(style|title)/i, X)) {
        oe(R, i);
        continue;
      }
      ...
      if (Zn(ta, Rt, X)) {
        ...
        try {
          Y ? i.setAttributeNS(Y, R, X) : i.setAttribute(R, X), Re(i) ? Z(i) : oa(e.removed);
        } catch {
        }
      }
    }
  ...
  return e.sanitize = function(b) {
    ...
    if (Be = !b, Be && (b = "<!-->"), typeof b != "string" && !Vn(b))
    ...
    if (!e.isSupported)
      return b;
    if (Se || Fe(i), e.removed = [], typeof b == "string" && (kt = !1), kt) {
      if (b.nodeName) {
    ...
    if (bt) {
      if ($t)
        for (H = Te.call(f.ownerDocument); f.firstChild; )
...
let bn = {}, tr = {}, er = null, nr = {
  mark: Aa,
  measure: Aa
};
try {
  typeof window < "u" && (bn = window), typeof document < "u" && (tr = document), typeof MutationObserver < "u" && (er = MutationObserver), typeof performance < "u" && (nr = performance);
} catch {
}
const {
  userAgent: ha = ""
} = bn.navigator || {}, ct = bn, x = tr, ba = er, le = nr;
ct.document;
...
const rt = "___FONT_AWESOME___", tn = 16, lr = "fa", cr = "svg-inline--fa", gt = "data-fa-i2svg", en = "data-fa-pseudo-element", ri = "data-fa-pseudo-element-pending", vn = "data-prefix", yn = "data-icon", wa = "fontawesome-i2svg", oi = "async", ii = ["HTML", "HEAD", "STYLE", "SCRIPT"], fr = (() => {
  try {
...
const si = Zt(ur), nn = c({}, Wo);
nn[j] = c(c(c(c({}, {
  duotone: "fad"
}), nn[j]), ya.kit), ya["kit-duotone"]);
const Ta = Zt(nn), an = c({}, _e);
an[j] = c(c({}, an[j]), Jo.kit);
const wn = Zt(an), rn = c({}, Zo);
rn[j] = c(c({}, rn[j]), Yo.kit);
Zt(rn);
const li = ko, dr = "fa-layers-text", ci = Fo, fi = c({}, jo);
Zt(fi);
const ui = ["class", "data-prefix", "data-icon", "data-fa-transform", "data-fa-mask"], Ge = Ro, di = [...Go, ...ni], qt = ct.FontAwesomeConfig || {};
function mi(t) {
...
function sn(t, e) {
  ...
  typeof et.hooks.addPack == "function" && !a ? et.hooks.addPack(t, Ea(e)) : et.styles[t] = c(c({}, et.styles[t] || {}), r), t === "fas" && sn("fa", e);
}
const {
  styles: Vt,
  shims: Ci
} = et, br = Object.keys(wn), Pi = br.reduce((t, e) => (t[e] = Object.keys(wn[e]), t), {});
let xn = null, vr = {}, yr = {}, wr = {}, Tr = {}, Or = {};
function Ni(t) {
  return ~di.indexOf(t);
}
function Si(t, e) {
...
const xr = () => {
  ...
  wr = n.names, Tr = n.unicodes, xn = ve(h.styleDefault, {
    family: h.familyDefault
  });
};
gi((t) => {
  xn = ve(t.styleDefault, {
    family: h.familyDefault
  });
});
xr();
...
function ye(t) {
  ...
  let a = null;
  const r = $e.concat(Vo), o = Ca(t.filter((y) => r.includes(y))), s = Ca(t.filter((y) => !$e.includes(y))), l = o.filter((y) => (a = y, !or.includes(y))), [u = null] = l, d = Ii(o), g = c(c({}, Bi(s)), {}, {
    prefix: ve(u, {
      family: d
    })
  });
...
const Fi = ir.filter((t) => t !== j || t !== he), Ri = Object.keys(_e).filter((t) => t !== j).map((t) => Object.keys(_e[t])).flat();
function Mi(t) {
  const {
    values: e,
    family: n,
...
class Hi {
  ...
  add() {
    ...
    Object.keys(r).forEach((o) => {
      this.definitions[o] = c(c({}, this.definitions[o] || {}), r[o]), sn(o, r[o]);
      const s = wn[j][o];
      s && sn(s, r[o]), xr();
    });
  }
...
function fn(t) {
  ...
  return Array.isArray(a) ? r = {
    tag: "g",
    attributes: {
      class: "".concat(h.cssPrefix, "-").concat(Ge.GROUP)
    },
    children: [{
      tag: "path",
      attributes: {
        class: "".concat(h.cssPrefix, "-").concat(Ge.SECONDARY),
        fill: "currentColor",
        d: a[0]
      }
    }, {
      tag: "path",
      attributes: {
        class: "".concat(h.cssPrefix, "-").concat(Ge.PRIMARY),
        fill: "currentColor",
        d: a[1]
      }
    }]
...
const Sa = () => {
}, dn = h.measurePerformance && le && le.mark && le.measure ? le : {
  mark: Sa,
  measure: Sa
}, Yt = 'FA "6.7.2"', Ki = (t) => (dn.mark("".concat(Yt, " ").concat(t, " begins")), () => Nr(t)), Nr = (t) => {
  dn.mark("".concat(Yt, " ").concat(t, " ends")), dn.measure("".concat(Yt, " ").concat(t), "".concat(Yt, " ").concat(t, " begins"), "".concat(Yt, " ").concat(t, " ends"));
};
var Pn = {
  begin: Ki,
  end: Nr
...
function Zi(t) {
  const e = t.getAttribute ? t.getAttribute(vn) : null, n = t.getAttribute ? t.getAttribute(yn) : null;
  return e && n;
}
function _i(t) {
...
const de = {
  ...
  nest: function(t) {
    const e = t[0], n = t[1];
    if (~Tn(e).indexOf(h.replacementClass))
      return de.replace(t);
    ...
    Lt(o).forEach((l) => {
      if (l.type === "childList" && l.addedNodes.length > 0 && !La(l.addedNodes[0]) && (h.searchPseudoElements && a(l.target), e(l.target)), l.type === "attributes" && l.target.parentNode && h.searchPseudoElements && a(l.target.parentNode), l.type === "attributes" && La(l.target) && ~ui.indexOf(l.attributeName))
        if (l.attributeName === "class" && Zi(l.target)) {
          ...
          l.target.setAttribute(vn, u || s), d && l.target.setAttribute(yn, d);
...
function os(t) {
  ...
  let r = ye(Tn(t));
  return r.prefix || (r.prefix = ft()), e && n && (r.prefix = e, r.iconName = n), r.iconName && r.prefix || (r.prefix && a.length > 0 && (r.iconName = Li(r.prefix, t.innerText) || En(r.prefix, on(t.innerText))), !r.iconName && h.autoFetchSvg && t.firstChild && t.firstChild.nodeType === Node.TEXT_NODE && (r.iconName = t.firstChild.data)), r;
}
function is(t) {
...
function Ba(t) {
  ...
  const {
    ...
    prefix: a,
    rest: r
  } = os(t), o = is(t), s = ln("parseNodeAttributes", {}, t);
...
function ka(t) {
  ...
  if (l.length > 0)
    ...
    return Promise.resolve();
  const u = Pn.begin("onTree"), d = l.reduce((g, y) => {
    try {
      const v = Ir(y);
      v && g.push(v);
    } catch (v) {
...
function us(t) {
  return function(e) {
    ...
    const a = (e || {}).icon ? e : cn(e || {});
    let {
      mask: r
    } = n;
    return r && (r = (r || {}).icon ? r : cn(r || {})), t(a, c(c({}, n), {}, {
      mask: r
    }));
  };
}
const ds = function(t) {
  ...
  return we(c({
    ...
    iconDefinition: t,
    params: e
  }), h.autoA11y && (s ? d["aria-labelledby"] = "".concat(h.replacementClass, "-title-").concat(l || Qt()) : (d["aria-hidden"] = "true", d.focusable = "false")), Cn({
    icons: {
      main: fn(T),
      mask: r ? fn(r.icon) : {
        found: !1,
  ...
  provides(t) {
    t.i2svg = function(e) {
      ...
      return new Promise((v, T) => {
        Promise.all([un(a, s), d.iconName ? un(d.iconName, d.prefix) : Promise.resolve({
          found: !1,
          width: 512,
          height: 512,
          icon: {}
      ...
      let u;
      return On(o) && (u = ut("generateAbstractTransformGrouping", {
        main: r,
        transform: o,
...
}), zo), ai), Ko), pn = Object.keys(Ra).reduce((t, e) => (t[e.toLowerCase()] = Ra[e], t), {}), bs = Object.keys(pn).reduce((t, e) => {
  const n = pn[e];
...
function Ma(t, e) {
  ...
  return new Promise((a, r) => {
    if (t.getAttribute(n) !== null)
      return a();
    const s = Lt(t.children).filter((v) => v.getAttribute(en) === e)[0], l = ct.getComputedStyle(t, e), u = l.getPropertyValue("font-family"), d = u.match(ci), g = l.getPropertyValue("font-weight"), y = l.getPropertyValue("content");
    if (s && !d)
    ...
    if (d && y !== "none" && y !== "") {
      ...
      if (D && !q && (!s || s.getAttribute(vn) !== T || s.getAttribute(yn) !== N)) {
        t.setAttribute(n, N), s && t.removeChild(s);
        const S = ss(), {
          extra: O
        } = S;
        O.attributes[en] = e, un(D, T).then((k) => {
          const Dt = Cn(c(c({}, S), {}, {
            icons: {
              main: k,
              mask: Cr()
          ...
          e === "::before" ? t.insertBefore(It, t.firstChild) : t.appendChild(It), It.outerHTML = Dt.map((Te) => _t(Te)).join(`
...
function Ts(t) {
  return t.parentNode !== document.head && !~ii.indexOf(t.tagName.toUpperCase()) && !t.getAttribute(en) && (!t.parentNode || t.parentNode.tagName !== "svg");
}
function Ha(t) {
  if (it)
    return new Promise((e, n) => {
      const a = Lt(t.querySelectorAll("*")).filter(Ts).map(ws), r = Pn.begin("searchPseudoElements");
...
var xs = {
  ...
  hooks() {
    return {
      bootstrap() {
        Ia(ln("mutationObserverCallbacks", {}));
      },
      noAuto() {
        as();
      },
      watch(t) {
        ...
        ja ? mn() : Ia(ln("mutationObserverCallbacks", {
          observeMutationsRoot: e
        }));
      }
    };
...
function Ms(t, e) {
  if (t) {
    ...
    if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return hn(t, e);
  }
}
function hn(t, e) {
...
function kr(t, e) {
  ...
  return r.attrs.style = $($({}, r.attrs.style), s), t.apply(void 0, [e.tag, $($({}, r.attrs), l)].concat(An(a)));
}
var Fr = !1;
try {
...
var Ga = {
  ...
  var n = $($({}, Ga), t), a = n.icon, r = n.mask, o = n.symbol, s = n.className, l = n.title, u = n.titleId, d = n.maskId, g = Ua(a), y = Ve("classes", [].concat(An(js(n)), An((s || "").split(" ")))), v = Ve("transform", typeof n.transform == "string" ? gn.transform(n.transform) : n.transform), T = Ve("mask", Ua(r)), L = Ds(g, $($($($({}, y), v), T), {}, {
    symbol: o,
    title: l,
    titleId: u,
    maskId: d
...
const Vs = {
  ...
  social: { logoUrl: t, unitLogo: e = al, mediaLinks: n = rl }
...
const ol = () => /* @__PURE__ */ m.jsxs(m.Fragment, { children: [
  /* @__PURE__ */ m.jsx(Js, {}),
  /* @__PURE__ */ m.jsx(Qs, {})
  ...
  t && /* @__PURE__ */ m.jsx(Ln, { social: t }),
  e && /* @__PURE__ */ m.jsx(Sn, { contact: e }),
  /* @__PURE__ */ m.jsx(ol, {})
] }));
Mr.propTypes = {
  social: J.shape(Ln.propTypes),
  contact: J.shape(Sn.propTypes)
};
const il = (t, e, n) => {
  Ya(n).render(Ae.createElement(t, e));
}, cl = ({ targetSelector: t, props: e }) => {
  il(Mr, e, document.querySelector(t));
};
export {
  Mr as ASUFooter,
  cl as initASUFooter
