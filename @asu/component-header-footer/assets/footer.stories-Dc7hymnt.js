import{p as e,F as k,j as ye,P as t,q as c,g as we,t as o,o as ke,n as pe,r as Se}from"./index.es-yuDyps7C.js";import{r as f}from"./iframe-DowZIl2k.js";import"./preload-helper-Dp1pzeXC.js";const ge=""+new URL("endorsedLogo-DPPmUtP1.png",import.meta.url).href,O=({columnIndex:r,column:{title:n,links:a},isOpen:d=!1,onToggle:g})=>{const[A,b]=f.useState(d),xe=typeof window<"u"?window.innerWidth>=1260:!1,[h,be]=f.useState(xe),L=f.useRef(null);f.useEffect(()=>{!h&&g&&V(d),b(d)},[d,h,g]),f.useEffect(()=>{const s=window.matchMedia("screen and (min-width: 1260px)"),i=M=>be(M.matches);return s.addEventListener("change",i),i(s),()=>s.removeEventListener("change",i)},[]);const V=s=>{const i=L==null?void 0:L.current;if(!i||!i.animate)return;i.classList.add("footer-collapsing");const M=i.animate([{maxHeight:s?`${i.scrollHeight}px`:"0px"}],{duration:250,easing:"ease-in-out",fill:"forwards"});M.onfinish=()=>{i.classList.remove("footer-collapsing"),s?i.classList.add("footer-column-show"):i.classList.remove("footer-column-show")}},ve=()=>{if(h){b(!0);return}g?g():b(s=>{const i=!s;return V(i),i})};return e.jsx("div",{className:"col-xl flex-footer testname-column",children:e.jsxs("div",{className:"card accordion-item desktop-disable-xl",children:[e.jsx("div",{className:"footer-accordion-header",children:e.jsx("div",{className:"h5",children:h?e.jsx("p",{className:"accordion-button",children:n}):e.jsxs("button",{id:`footlink-header-${r}`,className:"footer-accordion-button","aria-expanded":A||h,"aria-controls":`footlink-${r}`,onClick:ve,type:"button",disabled:h,children:[n,e.jsx(k,{className:A||h?"column-open":"",icon:ye})]})})}),e.jsx("div",{id:`footlink-${r}`,className:"footer-accordion-body",role:"region",ref:L,children:a.map(s=>e.jsx("a",{className:"nav-link",href:s.url,title:s.title,children:s.text},`footlink-${n}-link-${s.text}`))})]})})};O.propTypes={columnIndex:t.number.isRequired,column:c.shape({title:t.string,links:c.arrayOf(c.shape({url:t.string.isRequired,title:t.string,text:t.string.isRequired}))}),isOpen:t.bool,onToggle:t.func};O.__docgenInfo={description:`@param {Object} props - The component props
