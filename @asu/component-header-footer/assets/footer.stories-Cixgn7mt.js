import{j as e,F as k,f as ye,P as t,p as c,B as we,t as o,q as ke,A as pe,a as Se}from"./index.es-BQDsIzam.js";import{r as f}from"./index-B2SEcK1p.js";import"./_commonjsHelpers-B3tUAs5q.js";const ge=""+new URL("endorsedLogo-DPPmUtP1.png",import.meta.url).href,O=({columnIndex:r,column:{title:n,links:a},isOpen:d=!1,onToggle:g})=>{const[L,b]=f.useState(d),xe=typeof window<"u"?window.innerWidth>=1260:!1,[h,be]=f.useState(xe),I=f.useRef(null);f.useEffect(()=>{!h&&g&&V(d),b(d)},[d,h,g]),f.useEffect(()=>{const s=window.matchMedia("screen and (min-width: 1260px)"),i=M=>be(M.matches);return s.addEventListener("change",i),i(s),()=>s.removeEventListener("change",i)},[]);const V=s=>{const i=I==null?void 0:I.current;if(!i||!i.animate)return;i.classList.add("footer-collapsing");const M=i.animate([{maxHeight:s?`${i.scrollHeight}px`:"0px"}],{duration:250,easing:"ease-in-out",fill:"forwards"});M.onfinish=()=>{i.classList.remove("footer-collapsing"),s?i.classList.add("footer-column-show"):i.classList.remove("footer-column-show")}},ve=()=>{if(h){b(!0);return}g?g():b(s=>{const i=!s;return V(i),i})};return e.jsx("div",{className:"col-xl flex-footer testname-column",children:e.jsxs("div",{className:"card accordion-item desktop-disable-xl",children:[e.jsx("div",{className:"footer-accordion-header",children:e.jsx("div",{className:"h5",children:h?e.jsx("p",{className:"accordion-button",children:n}):e.jsxs("button",{id:`footlink-header-${r}`,className:"footer-accordion-button","aria-expanded":L||h,"aria-controls":`footlink-${r}`,onClick:ve,type:"button",disabled:h,children:[n,e.jsx(k,{className:L||h?"column-open":"",icon:ye})]})})}),e.jsx("div",{id:`footlink-${r}`,className:"footer-accordion-body",role:"region",ref:I,children:a.map(s=>e.jsx("a",{className:"nav-link",href:s.url,title:s.title,children:s.text},`footlink-${n}-link-${s.text}`))})]})})};O.propTypes={columnIndex:t.number.isRequired,column:c.shape({title:t.string,links:c.arrayOf(c.shape({url:t.string.isRequired,title:t.string,text:t.string.isRequired}))}),isOpen:t.bool,onToggle:t.func};O.__docgenInfo={description:`@param {Object} props - The component props
...
`,Re=()=>e.jsxs(e.Fragment,{children:[e.jsx(he,{}),e.jsx(fe,{})]}),R=({social:r,contact:n})=>(f.useEffect(()=>{typeof window<"u"&&Se({packageName:"component-StyledFooter",component:"Component Footer",type:"NA",configuration:{social:r,contact:n}})},[]),e.jsxs(_e,{role:"contentinfo",children:[r&&e.jsx(F,{social:r}),n&&e.jsx(_,{contact:n}),e.jsx(Re,{})]}));R.propTypes={social:c.shape(F.propTypes),contact:c.shape(_.propTypes)};R.__docgenInfo={description:`@param {import("./core/models/types").ASUFooter} props
