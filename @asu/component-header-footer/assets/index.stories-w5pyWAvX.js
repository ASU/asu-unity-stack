...
`,Oe={section:"topbar"},mt=()=>{const{loggedIn:e,userName:s,logoutLink:n,loginLink:i,onLoginClick:u,onLogoutClick:r,breakpoint:f}=M();return a.jsx(Yt,{className:R(t.NAV_LINK,t.LOGIN_STATUS),breakpoint:f,children:e?a.jsxs(a.Fragment,{children:[s?a.jsx("span",{className:t.USER_NAME,"data-testid":"user-name",children:s}):"",a.jsx("a",{className:t.SIGNOUT,href:n,onFocus:()=>C({...Oe,text:"sign out"}),onClick:A=>r==null?void 0:r(A),children:"Sign Out"})]}):a.jsx("a",{href:i,onFocus:()=>C({...Oe,text:"sign in"}),onClick:A=>u==null?void 0:u(A),children:"Sign In"})})};mt.__docgenInfo={description:"",methods:[],displayName:"Login"};const zt=V.form`
  display: flex;
  align-items: center;
  button {
    border: none;
...
`,ce=({inputRef:e,hasInputValue:s,setHasInputValue:n,isMobile:i,style:u={},className:r="",onBlur:f})=>{const A=b=>{const v=b.target.value;n(v.length>0)},w={ref:e,className:`form-control ${r}`,type:"search",name:"q",placeholder:"Search asu.edu",required:!0,onChange:A,onBlur:f,style:{paddingLeft:s&&i?"1rem":void 0,...u}};return i?a.jsxs(a.Fragment,{children:[!s&&a.jsx(z,{className:t.SEARCH_ICON,icon:ge}),a.jsx("input",{...w}),s&&a.jsx("button",{type:"submit","aria-label":"Submit search",className:t.SUBMIT_SEARCH,children:a.jsx(z,{icon:ge,size:"lg"})})]}):a.jsx("input",{...w})};ce.propTypes={inputRef:c.shape({current:c.instanceOf(Element)}).isRequired,hasInputValue:c.bool.isRequired,setHasInputValue:c.func.isRequired,isMobile:c.bool.isRequired,style:c.object,className:c.string,onBlur:c.func};ce.__docgenInfo={description:`Reusable search input component
@param {Object} props
...
@param {React.FocusEventHandler<HTMLInputElement>} [props.onBlur] - Optional blur handler`,methods:[],displayName:"SearchInput",props:{style:{defaultValue:{value:"{}",computed:!1},description:"",type:{name:"object"},required:!1},className:{defaultValue:{value:'""',computed:!1},description:"",type:{name:"string"},required:!1},inputRef:{description:"",type:{name:"shape",value:{current:{name:"instanceOf",value:"Element",required:!1}}},required:!0},hasInputValue:{description:"",type:{name:"bool"},required:!0},setHasInputValue:{description:"",type:{name:"func"},required:!0},isMobile:{description:"",type:{name:"bool"},required:!0},onBlur:{description:"",type:{name:"func"},required:!1}}};const Ie={event:"search",action:"type",name:"onenter",type:"main search",region:"navbar",section:"topbar"},we=()=>{const{breakpoint:e,searchUrl:s="",site:n=""}=M(),i=ue(e),u=g.useRef(null),[r,f]=g.useState(!1),[A,w]=g.useState(!1);g.useEffect(()=>{var l;r&&typeof((l=u==null?void 0:u.current)==null?void 0:l.focus)=="function"&&u.current.focus()},[r]);const b=l=>{const m=l==null?void 0:l.currentTarget;l.preventDefault();let k=!1;const y=()=>{!k&&typeof(m==null?void 0:m.submit)=="function"&&(k=!0,m.submit())},D=m&&m.elements?m.elements.namedItem("q"):null;setTimeout(y,2e3),C({...Ie,text:D?D.value:"",eventCallback:y,eventTimeout:2e3})},v=()=>{f(l=>{const m=!l;return C({...Ie,event:"link",action:"click",name:"onclick",text:m?"search icon":"close search icon"}),m})};return a.jsx("search",{children:a.jsxs(zt,{breakpoint:e,action:s,onSubmit:b,method:"get",name:"gs",className:r?t.OPEN_SEARCH:"","data-testid":"universal-nav-search-form",role:"search",children:[i?a.jsx("label",{children:a.jsx(ce,{inputRef:u,hasInputValue:A,setHasInputValue:w,isMobile:i})}):a.jsxs(a.Fragment,{children:[!r&&a.jsxs("button",{type:"button","aria-label":"Search asu.edu",onClick:v,className:t.SEARCH_BUTTON,"data-testid":"search-button",children:[a.jsx("span",{children:"Search"}),a.jsx(z,{icon:ge})]}),r&&a.jsxs(a.Fragment,{children:[a.jsx(ce,{inputRef:u,hasInputValue:A,setHasInputValue:w,isMobile:i,onBlur:()=>{A||f(!1)}}),a.jsx(G,{color:"dark",text:"Search",as:"button",classes:t.SUBMIT_BUTTON})]})]}),a.jsx("input",{name:"url_host",value:n,type:"hidden"}),a.jsx("input",{name:"site",value:"default_collection",type:"hidden"}),a.jsx("input",{name:"sort",value:"date:D:L:d1",type:"hidden"}),a.jsx("input",{name:"output",value:"xml_no_dtd",type:"hidden"}),a.jsx("input",{name:"ie",value:"UTF-8",type:"hidden"}),a.jsx("input",{name:"oe",value:"UTF-8",type:"hidden"}),a.jsx("input",{name:"client",value:"asu_frontend",type:"hidden"}),a.jsx("input",{name:"proxystylesheet",value:"asu_frontend",type:"hidden"})]})})};we.__docgenInfo={description:"",methods:[],displayName:"Search"};const Gt={event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"topbar",text:""},xe=()=>{const{breakpoint:e}=M(),s=ue(e);function n(){try{return window.location.href}catch(u){return console.error(u),""}}const i=[{className:R(t.NAV_LINK,t.VISUALLY_HIDDEN_FOCUSABLE),href:"#skip-to-content",text:"Skip to main content"},{className:R(t.NAV_LINK,t.VISUALLY_HIDDEN_FOCUSABLE),href:`https://accessibility.asu.edu/report#a11yref=${n()}`,text:"Report an accessibility problem"},{className:t.NAV_LINK,href:"https://asu.edu",text:"ASU Home"},{className:t.NAV_LINK,href:"https://my.asu.edu",text:"My ASU"},{className:t.NAV_LINK,href:"https://www.asu.edu/academics/colleges-schools",text:"Colleges and Schools"}];return a.jsx(Kt,{breakpoint:e,className:t.UNIVERSAL_NAV,"data-testid":"universal-navbar","data-elastic-exclude":"data-elastic-exclude",children:a.jsx("div",{className:"container-xl",children:a.jsx("div",{className:t.HEADER_TOP,children:a.jsxs("nav",{className:"nav","aria-label":"ASU Global",children:[a.jsxs("div",{className:t.LINKS_CONTAINER,children:[i.map(u=>a.jsx("a",{className:u.className,href:u.href,onClick:()=>C({...Gt,text:u.text}),children:u.text},u.href)),a.jsx(mt,{})]}),!s&&a.jsx(we,{})]})})})})};xe.__docgenInfo={description:"",methods:[],displayName:"UniversalNavbar"};const Zt=V.div`
  background-color: ${Q};
  border-bottom: 1px solid ${U};
  padding: 0 12px;
  .navbar {
...
`,ft=""+new URL("arizona-state-university-logo-vertical-uITMCR3E.png",import.meta.url).href,At=""+new URL("arizona-state-university-logo-Dgr35ctq.png",import.meta.url).href,Jt=V.a`
  display: unset;
  padding: 0;
  margin: 0;
  font-size: unset;
  line-height: unset;
  white-space: unset;
`,wt=()=>{const{logo:e}=M();return a.jsxs(Jt,{href:(e==null?void 0:e.brandLink)??"https://asu.edu",className:t.NAVBAR_BRAND,"data-testid":"logo",onFocus:()=>C({text:"asu logo"}),children:[a.jsx("img",{className:t.LOGO_VERT,src:(e==null?void 0:e.src)??ft,alt:(e==null?void 0:e.alt)??"Arizona State University logo",title:(e==null?void 0:e.title)??"ASU homepage",width:"303",height:"234",decoding:"async",fetchpriority:"high"}),a.jsx("img",{className:t.LOGO_HORIZ,src:(e==null?void 0:e.mobileSrc)??At,alt:(e==null?void 0:e.alt)??"Arizona State University logo",title:(e==null?void 0:e.title)??"ASU homepage",width:"400",height:"72",decoding:"async",fetchpriority:"high"})]})};wt.__docgenInfo={description:"",methods:[],displayName:"Logo"};const _t=V.nav`
  white-space: nowrap;
  > .${t.CONTENT_CONTAINER} {
    display: flex;
    align-items: center;
...
`,ea={event:"link",action:"click",name:"onclick",type:"internal link",region:"navbar",section:"main navbar",component:"dropdown menu",text:""},xt=({text:e})=>a.jsx("h3",{className:t.UL_HEADING,children:e});xt.propTypes={text:c.string};const bt=({link:e,dropdownName:s,handleLinkEvent:n})=>a.jsx("div",{className:t.NAV_BUTTON,children:a.jsx(G,{text:e.text,color:e.color||"maroon",href:e.href,onClick:i=>n(i,e),onKeyDown:i=>n(i,e)})});bt.propTypes={link:c.shape({text:c.string,color:c.string,href:c.string}),dropdownName:c.string,handleLinkEvent:c.func};const yt=({link:e,dropdownName:s,handleLinkEvent:n})=>a.jsx("li",{className:t.NAV_LINK,children:a.jsx("a",{...e.href?{}:{tabIndex:0},href:e.href,onClick:i=>n(i,e),onKeyDown:i=>n(i,e),children:e.text})});yt.propTypes={link:c.shape({text:c.string,href:c.string}),dropdownName:c.string,handleLinkEvent:c.func};const be=({dropdownName:e,items:s=[],buttons:n=[],classes:i="",listId:u,opened:r,parentLink:f})=>{const{breakpoint:A,headerHeight:w,setItemOpened:b,setMobileMenuOpen:v,mobileMenuOpen:l}=M(),m=s.reduce((o,p)=>p!=null&&p[0]?o+(p[0].span||1):o,0),k=m>2,y=g.useRef(null),[D,x]=g.useState(!1),N=s.length>1;g.useEffect(()=>{var o;if(typeof window<"u"&&y.current){const p=(o=y==null?void 0:y.current)==null?void 0:o.getBoundingClientRect().left,h=window.innerWidth*.55;x(p>h)}},[]),g.useEffect(()=>{var o;r&&((o=y==null?void 0:y.current)!=null&&o.parentElement)&&y.current.parentElement.scrollIntoView({behavior:"smooth",block:"start"})},[y,r]);const O=o=>o==null?void 0:o.stopPropagation(),E=(o,p)=>{var Y,K;const{key:h,type:L,target:I}=o,S=I==null?void 0:I.parentElement,T=()=>{var X;const B=(X=S==null?void 0:S.nextElementSibling)==null?void 0:X.firstChild;typeof(B==null?void 0:B.focus)=="function"&&B.focus()},W=()=>{var X;const B=(X=S==null?void 0:S.previousElementSibling)==null?void 0:X.firstChild;typeof(B==null?void 0:B.focus)=="function"&&B.focus()};O(o),h==="ArrowDown"?(o.preventDefault(),T()):h==="ArrowUp"?(o.preventDefault(),W()):h==="Escape"&&r?(b(),typeof((Y=f==null?void 0:f.current)==null?void 0:Y.focus)=="function"&&f.current.focus()):h==="Escape"&&!r&&l?v(!1):(h==="Enter"||h===" "||L==="click")&&(v(!1),b(),(K=p==null?void 0:p.onClick)==null||K.call(p,o),C({...ea,text:p.text}))},H=(o,p)=>{if(!o)return null;const h=`${o.text}-${o.href}-${p}`;return o.type==="heading"?a.jsx(xt,{text:o.text},h):o.type==="button"?a.jsx(bt,{link:o,dropdownName:e,handleLinkEvent:E},h):a.jsx(yt,{link:o,dropdownName:e,handleLinkEvent:E},h)};let j=w;return n.length>0&&(j+=64),a.jsxs($t,{ref:y,className:`${i}${D?" aligned-right":""}${k?" mega":""}`,breakpoint:A,heightOffset:j,children:[a.jsx("div",{style:{"--cols":m<3?4:m},id:N?u:"",className:t.DROPDOWN_CONTAINER,children:a.jsx(a.Fragment,{children:s==null?void 0:s.map((o,p)=>{const L=ht(`dropdown-item-${p}-`).next().value;return o!=null&&o.length?a.jsx("div",{className:t.DROPDOWN_CONTAINER_COLUMN,style:{"--span":o[0].span||1},id:N?`${u}-${L}`:u,children:(()=>{let I=[];const S=[];return o.forEach((T,W)=>{T.type==="heading"?(I.length>0&&(S.push(I),I=[]),S.push([T])):T.type==="button"?(I.length>0&&(S.push(I),I=[]),S.push([T])):I.push(T)}),I.length>0&&S.push(I),S.map((T,W)=>{const Y=`${L}-group-${W}`;return T.length===1&&T[0].type==="heading"||T.length===1&&T[0].type==="button"?H(T[0],W):a.jsx("ul",{children:T.map((K,B)=>H(K,B))},Y)})})()},`${u}-${L}`):null})})}),n.length>0&&a.jsx("div",{className:t.DROPDOWN_BUTTON_CONTAINER,children:a.jsx("div",{children:n.map((o,p)=>a.jsx(G,{color:o.color,text:o.text,href:o.href,onClick:O},`${o.text}-${o.href||p}`))})})]})};be.propTypes={dropdownName:c.string,items:c.arrayOf(c.arrayOf(c.shape({text:c.string,selected:c.bool,onClick:c.func,href:c.string}))),buttons:c.arrayOf(c.shape(Ut)),classes:c.string,listId:c.string,opened:c.bool,setItemOpened:c.func,parentLink:c.shape({current:c.instanceOf(HTMLElement)})};be.__docgenInfo={description:`@param {DropdownItemProps} props
...
`,aa={event:"collapse",type:"click"},pe={event:"link",action:"click",name:"onclick",type:"internal link",region:"navbar",section:"main navbar",component:"navigation link",text:""},vt=({children:e})=>a.jsxs(a.Fragment,{children:[a.jsx(z,{icon:Lt,className:t.ICON_NAV_ITEM,alt:""}),a.jsx("span",{className:t.MOBILE_ONLY,children:e})]});vt.propTypes={children:c.node};const ye=({link:e,setItemOpened:s,itemOpened:n})=>{const i=g.useRef(null),u=g.useRef(null),r=e.id===n,{breakpoint:f,expandOnHover:A=!1,title:w,mobileMenuOpen:b=!1,setMobileMenuOpen:v}=M(),l=ue(f);g.useEffect(()=>{const x=O=>{var E;r&&!l&&!((E=i==null?void 0:i.current)!=null&&E.contains(O==null?void 0:O.target))&&s()},N=()=>{requestAnimationFrame(()=>{const O=i.current;r&&!l&&O&&!O.contains(document.activeElement)&&s()})};return document.addEventListener("click",x,!0),document.addEventListener("focusin",N),()=>{document.removeEventListener("click",x,!0),document.removeEventListener("focusin",N)}},[r,s,l]);const m=g.useMemo(()=>{var x;return e.type==="icon-home"?a.jsx(vt,{children:e.text}):a.jsxs("span",{children:[e.text,!!((x=e.items)!=null&&x.length)&&a.jsx(z,{icon:Dt,className:R(t.CHEVRON_ICON,r&&t.OPEN),alt:""})]})},[e]),k=()=>{var E;const x=!!((E=e.items)!=null&&E.length),N=r?"close":"open",{text:O}=e;C(x?{...pe,...aa,action:N,text:O}:{...pe,text:e.type==="icon-home"?"home button":O})},y=x=>{var E,H,j,o;if(!e.items&&(e.href||e.onClick)&&(x.key==="Enter"||x.key===" "||x.type==="click")){C({...pe,text:e.text}),v(!1),s(),(E=e.onClick)==null||E.call(e,x);return}const{key:N}=x;if(["ArrowUp","ArrowDown","ArrowLeft","ArrowRight","Enter"," ","Escape","Click"].includes(N)){if(x.preventDefault(),N==="Escape"&&r){typeof((H=i==null?void 0:i.current)==null?void 0:H.focus)=="function"&&i.current.focus(),s();return}if(N==="Escape"&&!r&&b){v(!1);return}if((N==="Enter"||N===" ")&&(e.items?s():(v(!1),s(),(j=e.onClick)==null||j.call(e,x)),k()),(N==="ArrowDown"||N==="ArrowRight")&&r){const p=document.querySelector(`.${Ce(e.id)} li.${t.NAV_LINK} a`);typeof(p==null?void 0:p.focus)=="function"&&p.focus()}}else x.type==="click"&&e.items?(x.preventDefault(),k(),s()):x.type==="click"&&(k(),(o=e.onClick)==null||o.call(e,x))},D=()=>{A&&!l&&(s(),k())};return a.jsxs(ta,{breakpoint:f,ref:i,onMouseEnter:D,onMouseLeave:D,children:[a.jsx("a",{onKeyDown:y,onClick:y,href:e.href,...e.items?{"aria-expanded":r}:{},...e.href?{}:{tabIndex:0},"aria-owns":e.items?`dropdown-${e.id}`:null,className:R(e.class,e.selected&&t.NAV_ITEM_SELECTED,r&&t.OPEN_LINK),"data-testid":"nav-item",title:e.type==="icon-home"&&w?`${w} home page`:e.text,ref:u,children:m}),e.items&&a.jsx(be,{items:e.items,buttons:e.buttons,dropdownName:e.text,classes:R(Ce(e.id),r&&t.OPENED),listId:`dropdown-${e.id}`,opened:r,parentLink:u})]})};ye.propTypes={link:Vt,setItemOpened:c.func,itemOpened:c.number};ye.__docgenInfo={description:`@param {{ link: NavTreeProps, setItemOpened: Function, itemOpened: number }} props
@returns {JSX.Element}`,methods:[],displayName:"NavItem",props:{link:{description:"",type:{name:"shape",value:{id:{name:"number",required:!1},href:{name:"string",required:!1},text:{name:"string",required:!1},type:{name:"string",required:!1},selected:{name:"bool",required:!1},items:{name:"arrayOf",value:{name:"arrayOf",value:{name:"object"}},required:!1},buttons:{name:"arrayOf",value:{name:"shape",value:{text:{name:"string",required:!0},color:{name:"enum",value:[{value:'"gold"',computed:!1},{value:'"maroon"',computed:!1},{value:'"light"',computed:!1},{value:'"dark"',computed:!1}],required:!1},href:{name:"string",required:!1},classes:{name:"string",required:!1},onClick:{name:"func",required:!1},onFocus:{name:"func",required:!1}}},required:!1},class:{name:"string",required:!1}}},required:!1},setItemOpened:{description:"",type:{name:"func"},required:!1},itemOpened:{description:"",type:{name:"number"},required:!1}}};const sa="Header buttons cannot have both an onClick and an href property as this breaks accessibility. Please remove one",me=()=>{const{navTree:e=[],mobileNavTree:s=[],buttons:n=[],breakpoint:i,itemOpened:u,setItemOpened:r}=M(),f=ue(i),A=l=>{u===l?r(()=>{}):setTimeout(()=>r(()=>l),1)},w=l=>{l.onClick&&l.href&&console.error(sa)},b=l=>()=>{C({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:l.text}),l.onClick&&l.onClick()},v=(l,m)=>{const k={...l,id:m},D=ht(`${l.text}-${m}-`).next().value;return a.jsx(ye,{link:k,setItemOpened:()=>A(m),itemOpened:u},D)};return a.jsxs(_t,{breakpoint:i,"data-testid":"navigation","aria-label":"Site",children:[!!(e.length||s.length||n.length)&&a.jsxs("div",{className:t.CONTENT_CONTAINER,children:[!!(e!=null&&e.length||s!=null&&s.length)&&a.jsx("ul",{className:t.NAV_LIST,children:s!=null&&s.length&&f?s==null?void 0:s.map((l,m)=>v(l,m)):e==null?void 0:e.map((l,m)=>v(l,m))}),!!(n!=null&&n.length)&&a.jsx("form",{className:t.BUTTONS_CONTAINER,"data-testid":"buttons-container",children:n.map(l=>(w(l),g.createElement(G,{...l,key:l.text,onClick:b(l)})))})]}),f&&a.jsx(xe,{})]})};me.__docgenInfo={description:"",methods:[],displayName:"NavbarContainer"};const na=""+new URL("asu-starbucks-CqsAj6pt.png",import.meta.url).href,ra=V.div`
  margin: 0.5rem 0;
  a {
    display: inline-block;
    &:not(:last-child) {
...
`,Tt=()=>{const{partnerLogo:e,logo:s,breakpoint:n}=M();return a.jsxs(ra,{breakpoint:n,"data-testid":"partner",children:[a.jsx("a",{href:(e==null?void 0:e.brandLink)??"https://starbucks.asu.edu/",onClick:()=>C({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:"partner logo"}),children:a.jsx("img",{src:(e==null?void 0:e.src)??na,alt:(e==null?void 0:e.alt)??"ASU Starbucks logo",width:"232",height:"81",decoding:"async",fetchpriority:"high"})}),a.jsxs("a",{href:(s==null?void 0:s.brandLink)??"https://asu.edu",onClick:()=>C({text:"asu logo"}),children:[a.jsx("img",{className:t.LOGO_VERT,src:(s==null?void 0:s.src)??ft,alt:(s==null?void 0:s.alt)??"Arizona State University logo",width:"303",height:"234",decoding:"async",fetchpriority:"high"}),a.jsx("img",{className:t.LOGO_HORIZ,src:(s==null?void 0:s.mobileSrc)??At,alt:(s==null?void 0:s.alt)??"Arizona State University logo",width:"400",height:"72",decoding:"async",fetchpriority:"high"})]})]})};Tt.__docgenInfo={description:"",methods:[],displayName:"Partner"};const ia=(e,s)=>{const n=new Date(e);return n.setMinutes(n.getMinutes()+s),n},oa=e=>{const s="localhost",n="title_loaded",i=new Date,u=e||window.location.hostname,r=localStorage.getItem("title_loaded"),f=i.getTime()>parseInt(r,10),A=u===s,w=document.referrer.includes(u);if(A||!w&&(!r||f)){const v=ia(i,10).getTime();return localStorage.setItem(n,v.toString()),!0}return!1},ua={"992px":"993px","1260px":"1261px"},Se=V.div`
  line-height: 1;
  font-size: 1rem;
  font-weight: 700;
  ...
  @media (min-width: ${({breakpoint:e})=>ua[e]}) {
    line-height: 1;
    font-weight: 700;
    padding: 0;
...
`,ve=()=>{const[e,s]=g.useState(!1),{title:n,parentOrg:i,parentOrgUrl:u,baseUrl:r,breakpoint:f,animateTitle:A}=M();return g.useEffect(()=>{if(A!==!1){let w=r==="/"?window.location.hostname:r;!w.includes(window.location.hostname)&&w.indexOf("/")===0&&(w=window.location.hostname+w),oa(w)&&s(!0)}},[e,A,r]),i?a.jsxs(Se,{breakpoint:f,className:t.TITLE,"data-testid":"title",children:[a.jsx("a",{className:t.UNIT_NAME,href:u,onClick:()=>C({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:i}),title:`${i} home page`,children:i}),a.jsx("a",{className:R(t.SUBUNIT_NAME,e&&"active"),href:r,onClick:()=>C({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:n}),title:`${n} home page`,children:n})]}):a.jsx(Se,{breakpoint:f,className:t.TITLE,"data-testid":"title",children:a.jsx("a",{className:R(t.TITLE_SUBUNIT_NAME,e&&"active"),href:r,onClick:()=>C({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:n}),title:`${n} home page`,children:n})})};ve.propTypes={...Pt};ve.__docgenInfo={description:"",methods:[],displayName:"Title",props:{baseUrl:{description:"",type:{name:"string"},required:!1},parentOrg:{description:"",type:{name:"string"},required:!1},parentOrgUrl:{description:"",type:{name:"string"},required:!1},animate:{description:"",type:{name:"bool"},required:!1}}};const Nt=()=>{const{breakpoint:e,isPartner:s,hasNavigation:n,itemOpened:i,setItemOpened:u,mobileMenuOpen:r,setMobileMenuOpen:f,mobileMenuToggleRef:A,headerTop:w}=M(),b=ue(e),v=()=>{f(m=>!m)};g.useEffect(()=>(document.body.style.overflow=r||i!==void 0?"hidden":"unset",()=>{document.body.style.overflow="unset"}),[r,i,b]),g.useEffect(()=>{f(!1),u()},[b]);const l=()=>{v(),C({event:"collapse",action:r?"close":"open",type:"click",text:"menu button tablet"})};return a.jsxs(a.Fragment,{children:[!b&&a.jsx(xe,{}),a.jsx(Zt,{breakpoint:e,headerTop:w,children:a.jsx("div",{className:"container-xl",children:a.jsx("div",{className:t.HEADER_MAIN,children:a.jsxs("div",{className:R(t.NAVBAR,t.NAVBAR_EXPAND_XL,s&&t.PARTNER,r&&t.MOBILE_MENU_OPEN),children:[!s&&a.jsx(wt,{}),a.jsxs("button",{ref:A,className:R(t.NAVBAR_TOGGLER,!r&&t.COLLAPSED),type:"button",onClick:l,"aria-label":r?"Close menu":"Open menu","aria-expanded":r,children:[a.jsx("img",{src:Qt,alt:"Menu and Search Icon",className:t.MENU_SEARCH_ICON}),a.jsx(z,{icon:Rt,alt:"",className:t.MENU_CLOSE_ICON})]}),a.jsxs("div",{className:R(!s&&t.EXPAND_TITLE,s&&t.PARTNER_TITLE,!n&&t.NO_NAVIGATION),children:[s?a.jsx(Tt,{}):a.jsx(ve,{}),!b&&a.jsx(me,{})]}),r&&b&&a.jsx(we,{}),r&&b&&a.jsx(me,{})]})})})})]})};Nt.__docgenInfo={description:"",methods:[],displayName:"HeaderMain"};const da=(e,s)=>e==null?void 0:e.findIndex(n=>{var i;return(n==null?void 0:n.href)===s||Array.isArray(n.items)&&((i=n.items)==null?void 0:i.flat().find(({href:u})=>u===s))}),la=e=>e==null?void 0:e.find(s=>s.selected),Ee=e=>{if(!Array.isArray(e)||e.length===0||la(e))return e;let s="";if(window!=null&&window.location&&(s=window.location.pathname+window.location.search),!s)return e;const n=da(e,s);if(n===-1)return e;const i=[...e];return i[n].selected=!0,i},Ct={Lg:"992px",Xl:"1260px"},ca=qt`
  html {
  ...
  *::after {
  ...
  a {
    ...
    &:focus {
      ...
      box-shadow:
        0px 0px 0px 2px ${Q},
        0px 0px 0px 4px ${P} !important;
    }
  }
  @media (min-width: ${({breakpoint:e})=>Ct[e]}) {
    &.scrolled {
      .${t.TITLE} {
        margin: 0.5rem 0 0 0;
      }
...
`,de=({isPartner:e=!1,navTree:s,title:n,baseUrl:i="/",parentOrg:u,parentOrgUrl:r,partnerLogo:f,logo:A,loggedIn:w,userName:b,loginLink:v,onLoginClick:l,logoutLink:m,onLogoutClick:k,buttons:y,breakpoint:D="Xl",animateTitle:x=!1,expandOnHover:N=!1,mobileNavTree:O,searchUrl:E,site:H,renderDiv:j="false"})=>{const o=Ee(s)||[],p=Ee(O)||[],h=g.useRef(null),L=g.useRef(null),[I,S]=g.useState(void 0),[T,W]=g.useState(!1),[Y,K]=g.useState(150),[B,X]=g.useState(0),Te=(q=void 0)=>{S(q)},Ne=(q=!1)=>{L!=null&&L.current&&typeof L.current.focus=="function"&&L.current.focus(),W(q)},Ot=()=>{h!=null&&h.current&&(h.current.focus(),typeof window<"u"&&window.scrollTo(0,0)),Ne(),Te(),typeof document<"u"&&(document.body.style.overflow="unset")},It=()=>{if(typeof window>"u")return;const q=window.scrollY;h!=null&&h.current&&(q>h.current.getBoundingClientRect().top?h.current.classList.add("scrolled"):h.current.classList.remove("scrolled"),X(h.current.getBoundingClientRect().top),K(h.current.getBoundingClientRect().bottom))};g.useEffect(()=>{typeof window<"u"&&Mt({packageName:"component-header",component:"Component Header",type:"NA",configuration:{site:H,isPartner:e,searchUrl:E,navTree:o,parentOrg:u,buttons:y,mobileNavTree:p}})},[]),g.useEffect(()=>{h!=null&&h.current&&(K(h.current.getBoundingClientRect().bottom),X(h.current.getBoundingClientRect().top))},[h,T]),g.useEffect(()=>{if(typeof window>"u")return;const q=()=>Ht(It,100);return window.addEventListener("scroll",q),()=>{window.removeEventListener("scroll",q)}},[]);const St=()=>{const q=j==="true"?pa:ha;return a.jsx(q,{id:"asuHeader",breakpoint:D,ref:h,children:a.jsx(Nt,{})})};return a.jsxs(Ae,{initialValue:{isPartner:e,navTree:o,title:n,baseUrl:i,parentOrg:u,parentOrgUrl:r,partnerLogo:f,logo:A,loggedIn:w,userName:b,loginLink:v,onLoginClick:l,logoutLink:m,onLogoutClick:k,buttons:y,breakpoint:D,animateTitle:x,expandOnHover:N,mobileNavTree:p,hasNavigation:!!(o!=null&&o.length)||!!(p!=null&&p.length),searchUrl:E,headerTop:B,headerHeight:Y,itemOpened:I,setItemOpened:Te,mobileMenuOpen:T,setMobileMenuOpen:Ne,singlePageAppReset:Ot,mobileMenuToggleRef:L,site:H},children:[a.jsx(ca,{}),St()]})};de.propTypes={...Ft};de.__docgenInfo={description:`@param {HeaderProps} props
@returns {JSX.Element}`,methods:[],displayName:"ASUHeader",props:{isPartner:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},baseUrl:{defaultValue:{value:'"/"',computed:!1},description:"",type:{name:"string"},required:!1},breakpoint:{defaultValue:{value:'"Xl"',computed:!1},description:"",type:{name:"enum",value:[{value:'"Lg"',computed:!1},{value:'"Xl"',computed:!1}]},required:!1},animateTitle:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},expandOnHover:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},renderDiv:{defaultValue:{value:'"false"',computed:!1},description:"",type:{name:"enum",value:[{value:'"true"',computed:!1},{value:'"false"',computed:!1}]},required:!1},navTree:{description:"",type:{name:"arrayOf",value:{name:"custom",raw:"NavTreePropTypes"}},required:!1},partnerLogo:{description:"",type:{name:"shape",value:{alt:{name:"string",required:!1},title:{name:"string",required:!1},src:{name:"string",required:!1},mobileSrc:{name:"string",required:!1},brandLink:{name:"string",required:!1}}},required:!1},logo:{description:"",type:{name:"shape",value:{alt:{name:"string",required:!1},title:{name:"string",required:!1},src:{name:"string",required:!1},mobileSrc:{name:"string",required:!1},brandLink:{name:"string",required:!1}}},required:!1},title:{description:"",type:{name:"string"},required:!1},parentOrg:{description:"",type:{name:"string"},required:!1},parentOrgUrl:{description:"",type:{name:"string"},required:!1},loggedIn:{description:"",type:{name:"bool"},required:!1},userName:{description:"",type:{name:"string"},required:!1},loginLink:{description:"",type:{name:"string"},required:!1},onLoginClick:{description:"",type:{name:"func"},required:!1},logoutLink:{description:"",type:{name:"string"},required:!1},onLogoutClick:{description:"",type:{name:"func"},required:!1},buttons:{description:"",type:{name:"arrayOf",value:{name:"shape",value:{text:{name:"string",required:!0},color:{name:"enum",value:[{value:'"gold"',computed:!1},{value:'"maroon"',computed:!1},{value:'"light"',computed:!1},{value:'"dark"',computed:!1}],required:!1},href:{name:"string",required:!1},classes:{name:"string",required:!1},onClick:{name:"func",required:!1},onFocus:{name:"func",required:!1}}}},required:!1},mobileNavTree:{description:"",type:{name:"arrayOf",value:{name:"custom",raw:"NavTreePropTypes"}},required:!1},hasNavigation:{description:"",type:{name:"bool"},required:!1},searchUrl:{description:"",type:{name:"string"},required:!1},site:{description:"",type:{name:"string"},required:!1}}};const ba={title:"UDS/ASU Header",component:de,argTypes:{renderDiv:{control:"select",options:["true","false"],description:"Either 'true' or 'false'. If 'true', the header will be rendered as a div instead of a header element."}}},fe="Disabled",ga="Enabled";function ke(e){e.preventDefault(),e.returnValue=""}function ma(e){e.target.textContent===fe?(window.addEventListener("beforeunload",ke),e.target.textContent=ga):(window.removeEventListener("beforeunload",ke),e.target.textContent=fe)}const F=e=>a.jsxs(a.Fragment,{children:[a.jsx(de,{...e}),a.jsxs("div",{id:"skip-to-content",style:{width:"100%",height:"200vh",background:"#f0f0f0",paddingTop:40,marginTop:140,fontFamily:"Arial"},children:[a.jsxs("h1",{style:{textAlign:"center"},children:["Scroll section to test header scroll behavior"," "]}),a.jsxs("div",{style:{maxWidth:"1200px",width:"calc(100% - 4rem)",padding:"2rem",textAlign:"center",margin:"2rem auto"},children:[a.jsx("h2",{children:"Add Page Unload Warning"}),a.jsx("p",{children:"This button toggles a page unload warning that prompts the user to confirm before leaving the page. This is useful for testing the header's behavior when there is a potential for unintentionally navigating away from the page."}),a.jsx("p",{children:"This button also serves as a focusable element for testing accessibility."}),a.jsx("p",{children:a.jsx(G,{color:"dark",tabIndex:0,onClick:ma,text:fe})})]})]})]}),fa=e=>{const s=()=>{localStorage.getItem("title_loaded")&&localStorage.removeItem("title_loaded"),setTimeout(()=>{window.location.reload()},1e3)};return a.jsxs(a.Fragment,{children:[a.jsx(de,{...e,animateTitle:!0}),a.jsx("div",{style:{marginTop:200,textAlign:"center"},children:a.jsx(G,{text:"Animate Title",color:"dark",onClick:s})})]})},Z=F.bind({});Z.args={loggedIn:!1,userName:"",navTree:oe,title:"Subdomain name Lorem ipsum dolor sit amet, consectetur adipiscing elit",breakpoint:"Lg",searchUrl:"https://search.asu.edu/search",site:"subdomain",renderDiv:"false"};const J=F.bind({});J.args={};const _=F.bind({});_.args={title:"Subdomain name Lorem ipsum dolor sit amet, consectetur adipiscing elit",loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const $=F.bind({});$.args={title:"Subdomain name Lorem ipsum dolor sit amet, consectetur adipiscing elit",buttons:[{href:"/",text:"CTA Button 1",color:"gold"},{text:"CTA Button 2",href:"#",color:"light"}],loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const ee=F.bind({});ee.args={loggedIn:!1,userName:"",logoutLink:"/caslogout",loginLink:"/cas",navTree:oe,title:"Subdomain name Lorem ipsum dolor sit amet, consectetur adipiscing elit",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const te=F.bind({});te.args={loggedIn:!1,userName:"",logoutLink:"/caslogout",loginLink:"/cas",navTree:oe,mobileNavTree:Xt,title:"Subdomain name Lorem ipsum dolor sit amet, consectetur adipiscing elit",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const ae=F.bind({});ae.args={navTree:Wt,title:"Subdomain name Lorem ipsum dolor sit amet, consectetur adipiscing elit",buttons:[{href:"/",text:"CTA Button 1",color:"gold",classes:"custom-class"},{text:"CTA Button 2",href:"#",color:"light"}],loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const se=F.bind({});se.args={navTree:pt,title:"Subdomain name Lorem ipsum dolor sit amet, consectetur adipiscing elit",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const ne=F.bind({});ne.args={navTree:pt,title:"Subdomain name Lorem ipsum dolor sit amet, consectetur adipiscing elit",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",expandOnHover:!0,searchUrl:"https://search.asu.edu/search",site:"subdomain"};const re=F.bind({});re.args={isPartner:!0,navTree:oe,loggedIn:!1,userName:"",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const ie=fa.bind({});ie.args={title:"Subdomain name Lorem ipsum dolor sit amet, consectetur adipiscing elit",navTree:oe,loggedIn:!1,logoutLink:"/caslogout",loginLink:"/cas",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain",animateTitle:!0};var Be,Ue,De;Z.parameters={...Z.parameters,docs:{...(Be=Z.parameters)==null?void 0:Be.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
  ...
  </>`,...(De=(Ue=Z.parameters)==null?void 0:Ue.docs)==null?void 0:De.source}}};var Le,Ve,Pe;J.parameters={...J.parameters,docs:{...(Le=J.parameters)==null?void 0:Le.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div id="skip-to-content" style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(it=(rt=re.parameters)==null?void 0:rt.docs)==null?void 0:it.source}}};var ot,ut,dt;ie.parameters={...ie.parameters,docs:{...(ot=ie.parameters)==null?void 0:ot.docs,source:{originalSource:`args => {
  const handleClick = () => {
...
}`,...(dt=(ut=ie.parameters)==null?void 0:ut.docs)==null?void 0:dt.source}}};const ya=["Default","Empty","NoNavigation","NoNavigationWithButtons","BreakpointXL","WithMobileNavTree","WithButtons","WithMenuColumns","ExpandOnHover","Partner","AnimatedTitle"];export{ie as AnimatedTitle,ee as BreakpointXL,Z as Default,J as Empty,ne as ExpandOnHover,_ as NoNavigation,$ as NoNavigationWithButtons,re as Partner,ae as WithButtons,se as WithMenuColumns,te as WithMobileNavTree,ya as __namedExportsOrder,ba as default};
