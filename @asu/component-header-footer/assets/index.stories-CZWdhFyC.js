...
`,ge={section:"topbar"},st=()=>{const{loggedIn:e,userName:a,logoutLink:r,loginLink:s,onLoginClick:i,onLogoutClick:o,breakpoint:p}=L();return n.jsx(Lt,{className:E(t.NAV_LINK,t.LOGIN_STATUS),breakpoint:p,children:e?n.jsxs(n.Fragment,{children:[a?n.jsx("span",{className:t.USER_NAME,"data-testid":"user-name",children:a}):"",n.jsx("a",{className:t.SIGNOUT,href:r,onFocus:()=>N({...ge,text:"sign out"}),onClick:h=>o==null?void 0:o(h),children:"Sign Out"})]}):n.jsx("a",{href:s,onFocus:()=>N({...ge,text:"sign in"}),onClick:h=>i==null?void 0:i(h),children:"Sign In"})})};st.__docgenInfo={description:"",methods:[],displayName:"Login"};const Ut=O.form`
  display: flex;
  align-items: center;
  button {
    border: none;
...
`,re=({inputRef:e,hasInputValue:a,setHasInputValue:r,isMobile:s,style:i={},className:o="",onBlur:p})=>{const h=x=>{const v=x.target.value;r(v.length>0)},A={ref:e,className:`form-control ${o}`,type:"search",name:"q",placeholder:"Search asu.edu",required:!0,onChange:h,onBlur:p,style:{paddingLeft:a&&s?"1rem":void 0,...i}};return s?n.jsxs(n.Fragment,{children:[!a&&n.jsx(Q,{className:t.SEARCH_ICON,icon:oe}),n.jsx("input",{...A}),a&&n.jsx("button",{type:"submit","aria-label":"Submit search",className:t.SUBMIT_SEARCH,children:n.jsx(Q,{icon:oe,size:"lg"})})]}):n.jsx("input",{...A})};re.propTypes={inputRef:l.shape({current:l.instanceOf(Element)}).isRequired,hasInputValue:l.bool.isRequired,setHasInputValue:l.func.isRequired,isMobile:l.bool.isRequired,style:l.object,className:l.string,onBlur:l.func};re.__docgenInfo={description:`Reusable search input component
@param {Object} props
...
@param {React.FocusEventHandler<HTMLInputElement>} [props.onBlur] - Optional blur handler`,methods:[],displayName:"SearchInput",props:{style:{defaultValue:{value:"{}",computed:!1},description:"",type:{name:"object"},required:!1},className:{defaultValue:{value:'""',computed:!1},description:"",type:{name:"string"},required:!1},inputRef:{description:"",type:{name:"shape",value:{current:{name:"instanceOf",value:"Element",required:!1}}},required:!0},hasInputValue:{description:"",type:{name:"bool"},required:!0},setHasInputValue:{description:"",type:{name:"func"},required:!0},isMobile:{description:"",type:{name:"bool"},required:!0},onBlur:{description:"",type:{name:"func"},required:!1}}};const fe={event:"search",action:"type",name:"onenter",type:"main search",region:"navbar",section:"topbar"},ue=()=>{const{breakpoint:e,searchUrl:a,site:r}=L(),s=te(e),i=g.useRef(null),[o,p]=g.useState(!1),[h,A]=g.useState(!1);g.useEffect(()=>{o&&i.current&&i.current.focus()},[o]);const x=c=>{const f=c.currentTarget;c.preventDefault();const T=f.elements.namedItem("q");N({...fe,text:T?T.value:""}),setTimeout(()=>{f.submit()},100)},v=()=>{p(c=>{const f=!c;return N({...fe,event:"link",action:"click",name:"onclick",text:f?"search icon":"close search icon"}),f})};return n.jsx("search",{children:n.jsxs(Ut,{breakpoint:e,action:a,onSubmit:x,method:"get",name:"gs",className:o?t.OPEN_SEARCH:"","data-testid":"universal-nav-search-form",role:"search",children:[s?n.jsx("label",{children:n.jsx(re,{inputRef:i,hasInputValue:h,setHasInputValue:A,isMobile:s})}):n.jsxs(n.Fragment,{children:[!o&&n.jsxs("button",{type:"button","aria-label":"Search asu.edu",onClick:v,className:t.SEARCH_BUTTON,"data-testid":"search-button",children:[n.jsx("span",{children:"Search"}),n.jsx(Q,{icon:oe})]}),o&&n.jsxs(n.Fragment,{children:[n.jsx(re,{inputRef:i,hasInputValue:h,setHasInputValue:A,isMobile:s,onBlur:()=>{h||p(!1)}}),n.jsx($,{color:"dark",text:"Search",as:"button",classes:t.SUBMIT_BUTTON})]})]}),n.jsx("input",{name:"url_host",value:r,type:"hidden"}),n.jsx("input",{name:"site",value:"default_collection",type:"hidden"}),n.jsx("input",{name:"sort",value:"date:D:L:d1",type:"hidden"}),n.jsx("input",{name:"output",value:"xml_no_dtd",type:"hidden"}),n.jsx("input",{name:"ie",value:"UTF-8",type:"hidden"}),n.jsx("input",{name:"oe",value:"UTF-8",type:"hidden"}),n.jsx("input",{name:"client",value:"asu_frontend",type:"hidden"}),n.jsx("input",{name:"proxystylesheet",value:"asu_frontend",type:"hidden"})]})})};ue.__docgenInfo={description:"",methods:[],displayName:"Search"};const kt={event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"topbar",text:""},ce=()=>{const{breakpoint:e}=L(),a=te(e);function r(){try{return window.location.href}catch(i){return console.error(i),""}}const s=[{className:E(t.NAV_LINK,t.VISUALLY_HIDDEN_FOCUSABLE),href:"#skip-to-content",text:"Skip to main content"},{className:E(t.NAV_LINK,t.VISUALLY_HIDDEN_FOCUSABLE),href:`https://accessibility.asu.edu/report#a11yref=${r()}`,text:"Report an accessibility problem"},{className:t.NAV_LINK,href:"https://asu.edu",text:"ASU Home"},{className:t.NAV_LINK,href:"https://my.asu.edu",text:"My ASU"},{className:t.NAV_LINK,href:"https://www.asu.edu/academics/colleges-schools",text:"Colleges and Schools"}];return n.jsx(St,{breakpoint:e,className:t.UNIVERSAL_NAV,"data-testid":"universal-navbar","data-elastic-exclude":"data-elastic-exclude",children:n.jsx("div",{className:"container-xl",children:n.jsx("div",{className:t.HEADER_TOP,children:n.jsxs("nav",{className:"nav","aria-label":"ASU Global",children:[n.jsxs("div",{className:t.LINKS_CONTAINER,children:[s.map(i=>n.jsx("a",{className:i.className,href:i.href,onClick:()=>N({...kt,text:i.text}),children:i.text},i.href)),n.jsx(st,{})]}),!a&&n.jsx(ue,{})]})})})})};ce.__docgenInfo={description:"",methods:[],displayName:"UniversalNavbar"};const Dt=O.div`
  background-color: ${R};
  border-bottom: 1px solid ${C};
  padding: 0 12px;
  .navbar {
...
`,it=""+new URL("arizona-state-university-logo-vertical-uITMCR3E.png",import.meta.url).href,ot=""+new URL("arizona-state-university-logo-Dgr35ctq.png",import.meta.url).href,qt=O.a`
  display: unset;
  padding: 0;
  margin: 0;
  font-size: unset;
  line-height: unset;
  white-space: unset;
`,dt=()=>{const{logo:e}=L();return n.jsxs(qt,{href:(e==null?void 0:e.brandLink)??"https://asu.edu",className:t.NAVBAR_BRAND,"data-testid":"logo",onFocus:()=>N({text:"asu logo"}),children:[n.jsx("img",{className:t.LOGO_VERT,src:(e==null?void 0:e.src)??it,alt:(e==null?void 0:e.alt)??"Arizona State University logo",title:(e==null?void 0:e.title)??"ASU homepage",width:"303",height:"234",decoding:"async",fetchpriority:"high"}),n.jsx("img",{className:t.LOGO_HORIZ,src:(e==null?void 0:e.mobileSrc)??ot,alt:(e==null?void 0:e.alt)??"Arizona State University logo",title:(e==null?void 0:e.title)??"ASU homepage",width:"400",height:"72",decoding:"async",fetchpriority:"high"})]})};dt.__docgenInfo={description:"",methods:[],displayName:"Logo"};const Vt=O.nav`
  white-space: nowrap;
  > .${t.CONTENT_CONTAINER} {
    display: flex;
    align-items: center;
...
`,Pt={event:"link",action:"click",name:"onclick",type:"internal link",region:"navbar",section:"main navbar",text:""},lt=({text:e})=>n.jsx("h3",{className:t.UL_HEADING,children:e});lt.propTypes={text:l.string};const ut=({link:e,dropdownName:a,handleLinkEvent:r})=>n.jsx("li",{className:t.NAV_BUTTON,children:n.jsx($,{text:e.text,color:e.color||"dark",href:e.href,onClick:s=>r(s,e)})});ut.propTypes={link:l.shape({text:l.string,color:l.string,href:l.string}),dropdownName:l.string,handleLinkEvent:l.func};const ct=({link:e,dropdownName:a,handleLinkEvent:r})=>n.jsx("li",{className:t.NAV_LINK,children:n.jsx("a",{...e.href?{}:{tabIndex:0},href:e.href,onClick:s=>r(s,e),onKeyDown:s=>r(s,e),children:e.text})});ct.propTypes={link:l.shape({text:l.string,href:l.string}),dropdownName:l.string,handleLinkEvent:l.func};const pe=({dropdownName:e,items:a,buttons:r,classes:s,listId:i,setItemOpened:o,parentLink:p})=>{const{breakpoint:h}=L(),A=(a==null?void 0:a.length)>2,x=g.useRef(null),[v,c]=g.useState(!1),f=(a==null?void 0:a.length)>1;g.useEffect(()=>{var u;if(window&&x.current){const m=(u=x==null?void 0:x.current)==null?void 0:u.getBoundingClientRect().left,y=window.innerWidth*.55;c(m>y)}},[]);const T=u=>u.stopPropagation(),w=(u,m)=>{var S;const{key:y,type:B,target:P}=u,{parentElement:X}=P,k=()=>{var V;const q=(V=X.nextElementSibling)==null?void 0:V.firstChild;q&&q.focus()},D=()=>{var V;const q=(V=X.previousElementSibling)==null?void 0:V.firstChild;q&&q.focus()};T(u),y==="ArrowDown"?(u.preventDefault(),k()):y==="ArrowUp"?(u.preventDefault(),D()):y==="Escape"?(o(),p!=null&&p.current&&p.current.focus()):(y==="Enter"||y===" "||B==="click")&&((S=m==null?void 0:m.onClick)==null||S.call(m,u),N({...Pt,text:m.text}))},b=(u,m)=>{const y=`${u.text}-${u.href||m}`;return u.type==="heading"?n.jsx(lt,{text:u.text},y):u.type==="button"?n.jsx(ut,{link:u,dropdownName:e,handleLinkEvent:w},y):n.jsx(ct,{link:u,dropdownName:e,handleLinkEvent:w},y)};return n.jsxs(Rt,{ref:x,className:`${s}${v?" aligned-right":""}${A?" mega":""}`,breakpoint:h,children:[n.jsx("div",{id:f?i:"",className:t.DROPDOWN_CONTAINER,children:a==null?void 0:a.map((u,m)=>{const B=nt(`dropdown-item-${m}-`).next().value;return n.jsx("ul",{id:f?`${i}-${B}`:i,children:u.map((P,X)=>b(P,X))},B)})}),r&&n.jsx("div",{className:t.DROPDOWN_BUTTON_CONTAINER,children:n.jsx("div",{children:r.map((u,m)=>n.jsx($,{color:u.color,text:u.text,href:u.href,onClick:T},`${u.text}-${u.href||m}`))})})]})};pe.propTypes={dropdownName:l.string,items:l.arrayOf(l.shape({text:l.string,selected:l.bool,onClick:l.func,href:l.string})),buttons:l.arrayOf(l.shape(wt)),classes:l.string,listId:l.string,setItemOpened:l.func,parentLink:l.shape({focus:l.func,current:l.instanceOf(HTMLElement)})};pe.__docgenInfo={description:`@param {DropdownItemProps} props
@returns {JSX.Element}`,methods:[],displayName:"DropdownItem",props:{dropdownName:{description:"",type:{name:"string"},required:!1},items:{description:"",type:{name:"arrayOf",value:{name:"shape",value:{text:{name:"string",required:!1},selected:{name:"bool",required:!1},onClick:{name:"func",required:!1},href:{name:"string",required:!1}}}},required:!1},buttons:{description:"",type:{name:"arrayOf",value:{name:"shape",value:{text:{name:"string",required:!0},color:{name:"enum",value:[{value:'"gold"',computed:!1},{value:'"maroon"',computed:!1},{value:'"light"',computed:!1},{value:'"dark"',computed:!1}],required:!1},href:{name:"string",required:!1},classes:{name:"string",required:!1},onClick:{name:"func",required:!1},onFocus:{name:"func",required:!1}}}},required:!1},classes:{description:"",type:{name:"string"},required:!1},listId:{description:"",type:{name:"string"},required:!1},setItemOpened:{description:"",type:{name:"func"},required:!1},parentLink:{description:"",type:{name:"shape",value:{focus:{name:"func",required:!1},current:{name:"instanceOf",value:"HTMLElement",required:!1}}},required:!1}}};const Xt=O.li`
  position: relative;
  padding: 0;
  max-width: 100%;
  margin: 0 0.5rem 0 0;
...
`,Ft={event:"collapse",type:"click"},ie={event:"link",action:"click",name:"onclick",type:"internal link",region:"navbar",section:"main navbar",text:""},pt=({children:e})=>n.jsxs(n.Fragment,{children:[n.jsx(Q,{icon:bt,className:t.ICON_NAV_ITEM,alt:""}),n.jsx("span",{className:t.MOBILE_ONLY,children:e})]});pt.propTypes={children:l.node};const he=({link:e,setItemOpened:a,itemOpened:r})=>{const s=g.useRef(null),i=g.useRef(null),o=e.id===r,{breakpoint:p,expandOnHover:h,title:A}=L(),x=te(p);g.useEffect(()=>{const w=u=>{var m;o&&!((m=s==null?void 0:s.current)!=null&&m.contains(u.target))&&a()},b=()=>{requestAnimationFrame(()=>{const u=s.current;o&&u&&!u.contains(document.activeElement)&&a()})};return document.addEventListener("click",w,!0),document.addEventListener("focusin",b),()=>{document.removeEventListener("click",w,!0),document.removeEventListener("focusin",b)}},[o]);const v=g.useMemo(()=>{var w;return e.type==="icon-home"?n.jsx(pt,{children:e.text}):n.jsxs("span",{children:[e.text,!!((w=e.items)!=null&&w.length)&&n.jsx(Q,{icon:xt,className:E(t.CHEVRON_ICON,o&&t.OPEN),alt:""})]})},[e]),c=()=>{var m;const w=!!((m=e.items)!=null&&m.length),b=o?"close":"open",{text:u}=e;N(w?{...ie,...Ft,action:b,text:u}:{...ie,text:e.type==="icon-home"?"home button":u})},f=w=>{var m,y;if(!e.items&&e.href){N({...ie,text:e.text});return}const{key:b}=w;if(["ArrowUp","ArrowDown","ArrowLeft","ArrowRight","Enter"," ","Escape","Click"].includes(b)){if(w.preventDefault(),b==="Escape"&&o){a();return}if((b==="Enter"||b===" ")&&(e.items&&(!h&&!x||x)&&a(),c(),(m=e.onClick)==null||m.call(e,w)),(b==="ArrowDown"||b==="ArrowRight")&&o){const B=document.querySelectorAll(`.${Ae(e.id)} li.${t.NAV_LINK} a`);B.length&&B[0].focus()}}else w.type==="click"&&e.items?(w.preventDefault(),c(),a()):w.type==="click"&&(c(),(y=e.onClick)==null||y.call(e,w))},T=()=>{h&&!x&&(a(),c())};return n.jsxs(Xt,{breakpoint:p,ref:s,onMouseEnter:T,onMouseLeave:T,children:[n.jsx("a",{onKeyDown:f,onClick:f,href:e.href,...e.items?{"aria-expanded":o}:{},...e.href?{}:{tabIndex:0},"aria-owns":e.items?`dropdown-${e.id}`:null,className:E(e.class,e.selected&&t.NAV_ITEM_SELECTED,o&&t.OPEN_LINK),"data-testid":"nav-item",title:e.type==="icon-home"&&A?`${A} home page`:e.text,ref:i,children:v}),e.items&&n.jsx(pe,{items:e.items,buttons:e.buttons,dropdownName:e.text,classes:E(Ae(e.id),o&&t.OPENED),listId:`dropdown-${e.id}`,setItemOpened:a,parentLink:i==null?void 0:i.current})]})};he.propTypes={link:yt,setItemOpened:l.func,itemOpened:l.number};he.__docgenInfo={description:`@param {{ link: NavTreeProps, setItemOpened: Function, itemOpened: number }} props
@returns {JSX.Element}`,methods:[],displayName:"NavItem",props:{link:{description:"",type:{name:"shape",value:{id:{name:"number",required:!1},href:{name:"string",required:!1},text:{name:"string",required:!1},type:{name:"string",required:!1},selected:{name:"bool",required:!1},items:{name:"arrayOf",value:{name:"arrayOf",value:{name:"object"}},required:!1},buttons:{name:"arrayOf",value:{name:"shape",value:{text:{name:"string",required:!0},color:{name:"enum",value:[{value:'"gold"',computed:!1},{value:'"maroon"',computed:!1},{value:'"light"',computed:!1},{value:'"dark"',computed:!1}],required:!1},href:{name:"string",required:!1},classes:{name:"string",required:!1},onClick:{name:"func",required:!1},onFocus:{name:"func",required:!1}}},required:!1},class:{name:"string",required:!1}}},required:!1},setItemOpened:{description:"",type:{name:"func"},required:!1},itemOpened:{description:"",type:{name:"number"},required:!1}}};const Qt="Header buttons cannot have both an onClick and an href property as this breaks accessibility. Please remove one",de=()=>{const{navTree:e,mobileNavTree:a,buttons:r,breakpoint:s}=L(),i=te(s),[o,p]=g.useState(void 0),h=c=>{p(f=>o===c?void 0:c)},A=c=>{c.onClick&&c.href&&console.error(Qt)},x=c=>()=>{N({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:c.text}),c.onClick&&c.onClick()},v=(c,f)=>{const T={...c,id:f},b=nt(`${c.text}-${f}-`).next().value;return n.jsx(he,{link:T,setItemOpened:()=>h(f),itemOpened:o},b)};return n.jsxs(Vt,{breakpoint:s,"data-testid":"navigation","aria-label":"Site",children:[((e==null?void 0:e.length)||(a==null?void 0:a.length)||(r==null?void 0:r.length))&&n.jsxs("div",{className:t.CONTENT_CONTAINER,children:[((e==null?void 0:e.length)||(a==null?void 0:a.length))&&n.jsx("ul",{className:t.NAV_LIST,children:a!=null&&a.length&&i?a==null?void 0:a.map((c,f)=>v(c,f)):e==null?void 0:e.map((c,f)=>v(c,f))}),!!(r!=null&&r.length)&&n.jsx("form",{className:t.BUTTONS_CONTAINER,"data-testid":"buttons-container",children:r.map(c=>(A(c),g.createElement($,{...c,key:c.text,onClick:x(c)})))})]}),i&&n.jsx(ce,{})]})};de.__docgenInfo={description:"",methods:[],displayName:"NavbarContainer"};const Ht=""+new URL("asu-starbucks-CqsAj6pt.png",import.meta.url).href,Mt=O.div`
  margin: 0.5rem 0;
  a {
    display: inline-block;
    &:not(:last-child) {
...
`,ht=()=>{const{partnerLogo:e,logo:a,breakpoint:r}=L();return n.jsxs(Mt,{breakpoint:r,"data-testid":"partner",children:[n.jsx("a",{href:(e==null?void 0:e.brandLink)??"https://starbucks.asu.edu/",onClick:()=>N({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:"partner logo"}),children:n.jsx("img",{src:(e==null?void 0:e.src)??Ht,alt:(e==null?void 0:e.alt)??"ASU Starbucks logo",width:"232",height:"81",decoding:"async",fetchpriority:"high"})}),n.jsxs("a",{href:(a==null?void 0:a.brandLink)??"https://asu.edu",onClick:()=>N({text:"asu logo"}),children:[n.jsx("img",{className:t.LOGO_VERT,src:(a==null?void 0:a.src)??it,alt:(a==null?void 0:a.alt)??"Arizona State University logo",width:"303",height:"234",decoding:"async",fetchpriority:"high"}),n.jsx("img",{className:t.LOGO_HORIZ,src:(a==null?void 0:a.mobileSrc)??ot,alt:(a==null?void 0:a.alt)??"Arizona State University logo",width:"400",height:"72",decoding:"async",fetchpriority:"high"})]})]})};ht.__docgenInfo={description:"",methods:[],displayName:"Partner"};const jt=(e,a)=>{const r=new Date(e);return r.setMinutes(r.getMinutes()+a),r},Wt=e=>{const a="localhost",r="title_loaded",s=new Date,i=e||window.location.hostname,o=localStorage.getItem("title_loaded"),p=s.getTime()>parseInt(o,10),h=i===a,A=document.referrer.includes(i);if(h||!A&&(!o||p)){const v=jt(s,10).getTime();return localStorage.setItem(r,v.toString()),!0}return!1},Kt={"992px":"993px","1260px":"1261px"},we=O.div`
  line-height: 1;
  font-size: 1rem;
  font-weight: 700;
  ...
  @media (min-width: ${({breakpoint:e})=>Kt[e]}) {
    line-height: 1;
    font-weight: 700;
    padding: 0;
...
`,me=()=>{const[e,a]=g.useState(!1),{title:r,parentOrg:s,parentOrgUrl:i,baseUrl:o,breakpoint:p,animateTitle:h}=L();return g.useEffect(()=>{if(h!==!1){let A=o==="/"?window.location.hostname:o;!A.includes(window.location.hostname)&&A.indexOf("/")===0&&(A=window.location.hostname+A),Wt(A)&&a(!0)}},[e,h,o]),s?n.jsxs(we,{breakpoint:p,className:t.TITLE,"data-testid":"title",children:[n.jsx("a",{className:t.UNIT_NAME,href:i,onClick:()=>N({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:s}),title:`${s} home page`,children:s}),n.jsx("a",{className:E(t.SUBUNIT_NAME,e&&"active"),href:o,onClick:()=>N({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:r}),title:`${r} home page`,children:r})]}):n.jsx(we,{breakpoint:p,className:t.TITLE,"data-testid":"title",children:n.jsx("a",{className:E(t.TITLE_SUBUNIT_NAME,e&&"active"),href:o,onClick:()=>N({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:r}),title:`${r} home page`,children:r})})};me.propTypes={...Nt};me.__docgenInfo={description:"",methods:[],displayName:"Title",props:{baseUrl:{description:"",type:{name:"string"},required:!1},parentOrg:{description:"",type:{name:"string"},required:!1},parentOrgUrl:{description:"",type:{name:"string"},required:!1},animate:{description:"",type:{name:"bool"},required:!1}}};const mt=()=>{const{breakpoint:e,isPartner:a,hasNavigation:r}=L(),[s,i]=g.useState(!1),o=te(e),p=()=>{i(A=>!A)},h=()=>{p(),N({event:"collapse",action:s?"close":"open",type:"click",text:"menu button tablet"})};return n.jsxs(n.Fragment,{children:[!o&&n.jsx(ce,{}),n.jsx(Dt,{breakpoint:e,children:n.jsx("div",{className:"container-xl",children:n.jsx("div",{className:t.HEADER_MAIN,children:n.jsxs("div",{className:E(t.NAVBAR,t.NAVBAR_EXPAND_XL,a&&t.PARTNER),children:[!a&&n.jsx(dt,{}),n.jsxs("button",{className:E(t.NAVBAR_TOGGLER,!s&&t.COLLAPSED),type:"button",onClick:h,"aria-label":s?"Close menu":"Open menu","aria-expanded":s,children:[n.jsx("img",{src:Et,alt:"Menu and Search Icon",className:t.MENU_SEARCH_ICON}),n.jsx(Q,{icon:vt,alt:"",className:t.MENU_CLOSE_ICON})]}),n.jsxs("div",{className:E(!a&&t.EXPAND_TITLE,!r&&t.NO_NAVIGATION),children:[a?n.jsx(ht,{}):n.jsx(me,{}),!o&&n.jsx(de,{})]}),s&&o&&n.jsx(ue,{}),s&&o&&n.jsx(de,{})]})})})})]})};mt.__docgenInfo={description:"",methods:[],displayName:"HeaderMain"};const Yt=(e,a)=>e==null?void 0:e.findIndex(r=>{var s;return(r==null?void 0:r.href)===a||Array.isArray(r.items)&&((s=r.items)==null?void 0:s.flat().find(({href:i})=>i===a))}),zt=e=>e==null?void 0:e.find(a=>a.selected),xe=e=>{if(!Array.isArray(e)||e.length===0||zt(e))return e;let a="";if(window!=null&&window.location&&(a=window.location.pathname+window.location.search),!a)return e;const r=Yt(e,a);if(r===-1)return e;const s=[...e];return s[r].selected=!0,s},At={Lg:"992px",Xl:"1260px"},Gt=O.header`
  font-family:
  ...
  *::after {
  ...
  a {
    ...
    &:focus {
      ...
      box-shadow:
        0px 0px 0px 2px ${R},
        0px 0px 0px 4px ${I} !important;
    }
  }
  @media (min-width: ${({breakpoint:e})=>At[e]}) {
    &.scrolled {
      .${t.TITLE} {
        margin: 0.5rem 0 0 0;
      }
...
`,ne=({isPartner:e=!1,navTree:a,title:r,baseUrl:s="/",parentOrg:i,parentOrgUrl:o,partnerLogo:p,logo:h,loggedIn:A,userName:x,loginLink:v,onLoginClick:c,logoutLink:f,onLogoutClick:T,buttons:w,breakpoint:b="Xl",animateTitle:u,expandOnHover:m=!1,mobileNavTree:y,searchUrl:B,site:P,renderDiv:X="false"})=>{const k=xe(a),D=xe(y),S=g.useRef(null),q=()=>{const F=window.scrollY;S!=null&&S.current&&(F>S.current.getBoundingClientRect().top?S.current.classList.add("scrolled"):S.current.classList.remove("scrolled"))};g.useEffect(()=>{typeof window<"u"&&Ct({packageName:"component-header",component:"Component Header",type:"NA",configuration:{site:P,isPartner:e,searchUrl:B,navTree:k,parentOrg:i,buttons:w,mobileNavTree:D}})},[]),g.useEffect(()=>{const F=()=>Tt(q,100);return window.addEventListener("scroll",F),()=>{window.removeEventListener("scroll",F)}},[]);const V=()=>{const F=X==="true"?Zt:Gt;return n.jsx(F,{id:"asuHeader",breakpoint:b,ref:S,children:n.jsx(mt,{})})};return n.jsx(le,{initialValue:{isPartner:e,navTree:k,title:r,baseUrl:s,parentOrg:i,parentOrgUrl:o,partnerLogo:p,logo:h,loggedIn:A,userName:x,loginLink:v,onLoginClick:c,logoutLink:f,onLogoutClick:T,buttons:w,breakpoint:b,animateTitle:u,expandOnHover:m,mobileNavTree:D,hasNavigation:!!(k!=null&&k.length)||!!(D!=null&&D.length),searchUrl:B,site:P},children:V()})};ne.propTypes={...$e};ne.__docgenInfo={description:`@param {HeaderProps} props
@returns {JSX.Element}`,methods:[],displayName:"ASUHeader",props:{isPartner:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},baseUrl:{defaultValue:{value:'"/"',computed:!1},description:"",type:{name:"string"},required:!1},breakpoint:{defaultValue:{value:'"Xl"',computed:!1},description:"",type:{name:"enum",value:[{value:'"Lg"',computed:!1},{value:'"Xl"',computed:!1}]},required:!1},expandOnHover:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},renderDiv:{defaultValue:{value:'"false"',computed:!1},description:"",type:{name:"enum",value:[{value:'"true"',computed:!1},{value:'"false"',computed:!1}]},required:!1},navTree:{description:"",type:{name:"arrayOf",value:{name:"custom",raw:"NavTreePropTypes"}},required:!1},partnerLogo:{description:"",type:{name:"shape",value:{alt:{name:"string",required:!1},title:{name:"string",required:!1},src:{name:"string",required:!1},mobileSrc:{name:"string",required:!1},brandLink:{name:"string",required:!1}}},required:!1},logo:{description:"",type:{name:"shape",value:{alt:{name:"string",required:!1},title:{name:"string",required:!1},src:{name:"string",required:!1},mobileSrc:{name:"string",required:!1},brandLink:{name:"string",required:!1}}},required:!1},title:{description:"",type:{name:"string"},required:!1},parentOrg:{description:"",type:{name:"string"},required:!1},parentOrgUrl:{description:"",type:{name:"string"},required:!1},loggedIn:{description:"",type:{name:"bool"},required:!1},userName:{description:"",type:{name:"string"},required:!1},loginLink:{description:"",type:{name:"string"},required:!1},onLoginClick:{description:"",type:{name:"func"},required:!1},logoutLink:{description:"",type:{name:"string"},required:!1},onLogoutClick:{description:"",type:{name:"func"},required:!1},buttons:{description:"",type:{name:"arrayOf",value:{name:"shape",value:{text:{name:"string",required:!0},color:{name:"enum",value:[{value:'"gold"',computed:!1},{value:'"maroon"',computed:!1},{value:'"light"',computed:!1},{value:'"dark"',computed:!1}],required:!1},href:{name:"string",required:!1},classes:{name:"string",required:!1},onClick:{name:"func",required:!1},onFocus:{name:"func",required:!1}}}},required:!1},animateTitle:{description:"",type:{name:"bool"},required:!1},mobileNavTree:{description:"",type:{name:"arrayOf",value:{name:"custom",raw:"NavTreePropTypes"}},required:!1},hasNavigation:{description:"",type:{name:"bool"},required:!1},searchUrl:{description:"",type:{name:"string"},required:!1},site:{description:"",type:{name:"string"},required:!1}}};const tn={title:"UDS/ASU Header",component:ne,argTypes:{renderDiv:{control:"select",options:["true","false"],description:"Either 'true' or 'false'. If 'true', the header will be rendered as a div instead of a header element."}}},U=e=>n.jsxs(n.Fragment,{children:[n.jsx(ne,{...e}),n.jsx("div",{style:{width:"100%",height:"200vh",background:"#f0f0f0",paddingTop:40,marginTop:140},children:n.jsx("h1",{style:{textAlign:"center",fontFamily:"Arial"},children:"Scroll section"})})]}),Jt=e=>{const a=()=>{localStorage.getItem("title_loaded")&&localStorage.removeItem("title_loaded"),setTimeout(()=>{window.location.reload()},1e3)};return n.jsxs(n.Fragment,{children:[n.jsx(ne,{...e,animateTitle:!0}),n.jsx("div",{style:{marginTop:200,textAlign:"center"},children:n.jsx($,{text:"Animate Title",color:"dark",onClick:a})})]})},H=U.bind({});H.args={loggedIn:!1,userName:"",navTree:ee,title:"Subdomain name",breakpoint:"Lg",searchUrl:"https://search.asu.edu/search",site:"subdomain",renderDiv:"false"};const M=U.bind({});M.args={};const j=U.bind({});j.args={title:"Subdomain name",loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const W=U.bind({});W.args={title:"Subdomain name",buttons:[{href:"/",text:"CTA Button 1",color:"gold"},{text:"CTA Button 2",href:"#",color:"light"}],loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const K=U.bind({});K.args={loggedIn:!1,userName:"",logoutLink:"/caslogout",loginLink:"/cas",navTree:ee,title:"Subdomain name",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const Y=U.bind({});Y.args={loggedIn:!1,userName:"",logoutLink:"/caslogout",loginLink:"/cas",navTree:ee,mobileNavTree:It,title:"Subdomain name",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const z=U.bind({});z.args={navTree:Ot,title:"Subdomain name",buttons:[{href:"/",text:"CTA Button 1",color:"gold",classes:"custom-class"},{text:"CTA Button 2",href:"#",color:"light"}],loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const G=U.bind({});G.args={navTree:at,title:"Subdomain name",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const Z=U.bind({});Z.args={navTree:at,title:"Subdomain name",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",expandOnHover:!0,searchUrl:"https://search.asu.edu/search",site:"subdomain"};const J=U.bind({});J.args={isPartner:!0,navTree:ee,loggedIn:!1,userName:"",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const _=Jt.bind({});_.args={title:"Subdomain name",navTree:ee,loggedIn:!1,logoutLink:"/caslogout",loginLink:"/cas",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain",animateTitle:!0};var be,ye,Ne;H.parameters={...H.parameters,docs:{...(be=H.parameters)==null?void 0:be.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(Ne=(ye=H.parameters)==null?void 0:ye.docs)==null?void 0:Ne.source}}};var ve,Ce,Te;M.parameters={...M.parameters,docs:{...(ve=M.parameters)==null?void 0:ve.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(Te=(Ce=M.parameters)==null?void 0:Ce.docs)==null?void 0:Te.source}}};var Oe,Ie,Ee;j.parameters={...j.parameters,docs:{...(Oe=j.parameters)==null?void 0:Oe.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(Ee=(Ie=j.parameters)==null?void 0:Ie.docs)==null?void 0:Ee.source}}};var Be,Se,Le;W.parameters={...W.parameters,docs:{...(Be=W.parameters)==null?void 0:Be.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(Le=(Se=W.parameters)==null?void 0:Se.docs)==null?void 0:Le.source}}};var Ue,ke,De;K.parameters={...K.parameters,docs:{...(Ue=K.parameters)==null?void 0:Ue.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(De=(ke=K.parameters)==null?void 0:ke.docs)==null?void 0:De.source}}};var qe,Ve,Re;Y.parameters={...Y.parameters,docs:{...(qe=Y.parameters)==null?void 0:qe.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(Re=(Ve=Y.parameters)==null?void 0:Ve.docs)==null?void 0:Re.source}}};var Pe,Xe,Fe;z.parameters={...z.parameters,docs:{...(Pe=z.parameters)==null?void 0:Pe.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(Fe=(Xe=z.parameters)==null?void 0:Xe.docs)==null?void 0:Fe.source}}};var Qe,He,Me;G.parameters={...G.parameters,docs:{...(Qe=G.parameters)==null?void 0:Qe.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(Me=(He=G.parameters)==null?void 0:He.docs)==null?void 0:Me.source}}};var je,We,Ke;Z.parameters={...Z.parameters,docs:{...(je=Z.parameters)==null?void 0:je.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(Ke=(We=Z.parameters)==null?void 0:We.docs)==null?void 0:Ke.source}}};var Ye,ze,Ge;J.parameters={...J.parameters,docs:{...(Ye=J.parameters)==null?void 0:Ye.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(Ge=(ze=J.parameters)==null?void 0:ze.docs)==null?void 0:Ge.source}}};var Ze,Je,_e;_.parameters={..._.parameters,docs:{...(Ze=_.parameters)==null?void 0:Ze.docs,source:{originalSource:`args => {
  const handleClick = () => {
...
}`,...(_e=(Je=_.parameters)==null?void 0:Je.docs)==null?void 0:_e.source}}};const nn=["Default","Empty","NoNavigation","NoNavigationWithButtons","BreakpointXL","WithMobileNavTree","WithButtons","WithMenuColumns","ExpandOnHover","Partner","AnimatedTitle"];export{_ as AnimatedTitle,K as BreakpointXL,H as Default,M as Empty,Z as ExpandOnHover,j as NoNavigation,W as NoNavigationWithButtons,J as Partner,z as WithButtons,G as WithMenuColumns,Y as WithMobileNavTree,nn as __namedExportsOrder,tn as default};
