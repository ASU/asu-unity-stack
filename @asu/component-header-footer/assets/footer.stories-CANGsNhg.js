import{j as e,F as k,f as ye,P as t,p as c,B as we,t as o,q as ke,A as pe,a as Se}from"./index.es-CKbmsMe1.js";import{r as f}from"./index-B2SEcK1p.js";import"./_commonjsHelpers-B3tUAs5q.js";const ge=""+new URL("endorsedLogo-DPPmUtP1.png",import.meta.url).href,M=({columnIndex:r,column:{title:n,links:a},isOpen:d=!1,onToggle:g})=>{const[F,b]=f.useState(d),xe=typeof window<"u"?window.innerWidth>=1260:!1,[h,be]=f.useState(xe),I=f.useRef(null);f.useEffect(()=>{!h&&g&&V(d),b(d)},[d,h,g]),f.useEffect(()=>{const s=window.matchMedia("screen and (min-width: 1260px)"),i=O=>be(O.matches);return s.addEventListener("change",i),i(s),()=>s.removeEventListener("change",i)},[]);const V=s=>{const i=I==null?void 0:I.current;if(!i||!i.animate)return;i.classList.add("footer-collapsing");const O=i.animate([{maxHeight:s?`${i.scrollHeight}px`:"0px"}],{duration:250,easing:"ease-in-out",fill:"forwards"});O.onfinish=()=>{i.classList.remove("footer-collapsing"),s?i.classList.add("footer-column-show"):i.classList.remove("footer-column-show")}},ve=()=>{if(h){b(!0);return}g?g():b(s=>{const i=!s;return V(i),i})};return e.jsx("div",{className:"col-xl flex-footer testname-column",children:e.jsxs("div",{className:"card accordion-item desktop-disable-xl",children:[e.jsx("div",{className:"footer-accordion-header",children:e.jsx("div",{className:"h5",children:h?e.jsx("p",{className:"accordion-button",children:n}):e.jsxs("button",{id:`footlink-header-${r}`,className:"footer-accordion-button","aria-expanded":F||h,"aria-controls":`footlink-${r}`,onClick:ve,type:"button",disabled:h,children:[n,e.jsx(k,{className:F||h?"column-open":"",icon:ye})]})})}),e.jsx("div",{id:`footlink-${r}`,className:"footer-accordion-body",role:"region",ref:I,children:a.map(s=>e.jsx("a",{className:"nav-link",href:s.url,title:s.title,children:s.text},`footlink-${n}-link-${s.text}`))})]})})};M.propTypes={columnIndex:t.number.isRequired,column:c.shape({title:t.string,links:c.arrayOf(c.shape({url:t.string.isRequired,title:t.string,text:t.string.isRequired}))}),isOpen:t.bool,onToggle:t.func};M.__docgenInfo={description:`@param {Object} props - The component props
...
}`,computed:!1},description:"",type:{name:"shape",value:{unitLogo:{name:"string",required:!0},mediaLinks:{name:"shape",value:{facebook:{name:"string",required:!1},twitter:{name:"string",required:!1},linkedIn:{name:"string",required:!1},instagram:{name:"string",required:!1},youtube:{name:"string",required:!1}},required:!1}}},required:!1}}};const Ie=pe`
  padding-left: 0;
  margin-bottom: 0;
  list-style: none;
`,Ue=pe`
