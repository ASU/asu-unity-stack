...
`,Oe={section:"topbar"},ft=()=>{const{loggedIn:e,userName:s,logoutLink:n,loginLink:i,onLoginClick:o,onLogoutClick:r,breakpoint:f}=q();return a.jsx(Yt,{className:P(t.NAV_LINK,t.LOGIN_STATUS),breakpoint:f,children:e?a.jsxs(a.Fragment,{children:[s?a.jsx("span",{className:t.USER_NAME,"data-testid":"user-name",children:s}):"",a.jsx("a",{className:t.SIGNOUT,href:n,onFocus:()=>I({...Oe,text:"sign out"}),onClick:A=>r==null?void 0:r(A),children:"Sign Out"})]}):a.jsx("a",{href:i,onFocus:()=>I({...Oe,text:"sign in"}),onClick:A=>o==null?void 0:o(A),children:"Sign In"})})};ft.__docgenInfo={description:"",methods:[],displayName:"Login"};const zt=L.form`
  display: flex;
  align-items: center;
  button {
    border: none;
...
`,ue=({inputRef:e,hasInputValue:s,setHasInputValue:n,isMobile:i,style:o={},className:r="",onBlur:f})=>{const A=y=>{const T=y.target.value;n(T.length>0)},w={ref:e,className:`form-control ${r}`,type:"search",name:"q",placeholder:"Search asu.edu",required:!0,onChange:A,onBlur:f,style:{paddingLeft:s&&i?"1rem":void 0,...o}};return i?a.jsxs(a.Fragment,{children:[!s&&a.jsx(Y,{className:t.SEARCH_ICON,icon:pe}),a.jsx("input",{...w}),s&&a.jsx("button",{type:"submit","aria-label":"Submit search",className:t.SUBMIT_SEARCH,children:a.jsx(Y,{icon:pe,size:"lg"})})]}):a.jsx("input",{...w})};ue.propTypes={inputRef:c.shape({current:c.instanceOf(Element)}).isRequired,hasInputValue:c.bool.isRequired,setHasInputValue:c.func.isRequired,isMobile:c.bool.isRequired,style:c.object,className:c.string,onBlur:c.func};ue.__docgenInfo={description:`Reusable search input component
@param {Object} props
...
@param {React.FocusEventHandler<HTMLInputElement>} [props.onBlur] - Optional blur handler`,methods:[],displayName:"SearchInput",props:{style:{defaultValue:{value:"{}",computed:!1},description:"",type:{name:"object"},required:!1},className:{defaultValue:{value:'""',computed:!1},description:"",type:{name:"string"},required:!1},inputRef:{description:"",type:{name:"shape",value:{current:{name:"instanceOf",value:"Element",required:!1}}},required:!0},hasInputValue:{description:"",type:{name:"bool"},required:!0},setHasInputValue:{description:"",type:{name:"func"},required:!0},isMobile:{description:"",type:{name:"bool"},required:!0},onBlur:{description:"",type:{name:"func"},required:!1}}};const Ie={event:"search",action:"type",name:"onenter",type:"main search",region:"navbar",section:"topbar"},Ae=()=>{const{breakpoint:e,searchUrl:s="",site:n=""}=q(),i=oe(e),o=h.useRef(null),[r,f]=h.useState(!1),[A,w]=h.useState(!1);h.useEffect(()=>{var u;r&&typeof((u=o==null?void 0:o.current)==null?void 0:u.focus)=="function"&&o.current.focus()},[r]);const y=u=>{const p=u==null?void 0:u.currentTarget;u.preventDefault();const U=p&&p.elements?p.elements.namedItem("q"):null;I({...Ie,text:U?U.value:""}),setTimeout(()=>{typeof(p==null?void 0:p.submit)=="function"&&p.submit()},100)},T=()=>{f(u=>{const p=!u;return I({...Ie,event:"link",action:"click",name:"onclick",text:p?"search icon":"close search icon"}),p})};return a.jsx("search",{children:a.jsxs(zt,{breakpoint:e,action:s,onSubmit:y,method:"get",name:"gs",className:r?t.OPEN_SEARCH:"","data-testid":"universal-nav-search-form",role:"search",children:[i?a.jsx("label",{children:a.jsx(ue,{inputRef:o,hasInputValue:A,setHasInputValue:w,isMobile:i})}):a.jsxs(a.Fragment,{children:[!r&&a.jsxs("button",{type:"button","aria-label":"Search asu.edu",onClick:T,className:t.SEARCH_BUTTON,"data-testid":"search-button",children:[a.jsx("span",{children:"Search"}),a.jsx(Y,{icon:pe})]}),r&&a.jsxs(a.Fragment,{children:[a.jsx(ue,{inputRef:o,hasInputValue:A,setHasInputValue:w,isMobile:i,onBlur:()=>{A||f(!1)}}),a.jsx(z,{color:"dark",text:"Search",as:"button",classes:t.SUBMIT_BUTTON})]})]}),a.jsx("input",{name:"url_host",value:n,type:"hidden"}),a.jsx("input",{name:"site",value:"default_collection",type:"hidden"}),a.jsx("input",{name:"sort",value:"date:D:L:d1",type:"hidden"}),a.jsx("input",{name:"output",value:"xml_no_dtd",type:"hidden"}),a.jsx("input",{name:"ie",value:"UTF-8",type:"hidden"}),a.jsx("input",{name:"oe",value:"UTF-8",type:"hidden"}),a.jsx("input",{name:"client",value:"asu_frontend",type:"hidden"}),a.jsx("input",{name:"proxystylesheet",value:"asu_frontend",type:"hidden"})]})})};Ae.__docgenInfo={description:"",methods:[],displayName:"Search"};const Gt={event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"topbar",text:""},we=()=>{const{breakpoint:e}=q(),s=oe(e);function n(){try{return window.location.href}catch(o){return console.error(o),""}}const i=[{className:P(t.NAV_LINK,t.VISUALLY_HIDDEN_FOCUSABLE),href:"#skip-to-content",text:"Skip to main content"},{className:P(t.NAV_LINK,t.VISUALLY_HIDDEN_FOCUSABLE),href:`https://accessibility.asu.edu/report#a11yref=${n()}`,text:"Report an accessibility problem"},{className:t.NAV_LINK,href:"https://asu.edu",text:"ASU Home"},{className:t.NAV_LINK,href:"https://my.asu.edu",text:"My ASU"},{className:t.NAV_LINK,href:"https://www.asu.edu/academics/colleges-schools",text:"Colleges and Schools"}];return a.jsx(Kt,{breakpoint:e,className:t.UNIVERSAL_NAV,"data-testid":"universal-navbar","data-elastic-exclude":"data-elastic-exclude",children:a.jsx("div",{className:"container-xl",children:a.jsx("div",{className:t.HEADER_TOP,children:a.jsxs("nav",{className:"nav","aria-label":"ASU Global",children:[a.jsxs("div",{className:t.LINKS_CONTAINER,children:[i.map(o=>a.jsx("a",{className:o.className,href:o.href,onClick:()=>I({...Gt,text:o.text}),children:o.text},o.href)),a.jsx(ft,{})]}),!s&&a.jsx(Ae,{})]})})})})};we.__docgenInfo={description:"",methods:[],displayName:"UniversalNavbar"};const Zt=L.div`
  background-color: ${X};
  border-bottom: 1px solid ${D};
  padding: 0 12px;
  .navbar {
  ...
  .navbar.${t.MOBILE_MENU_OPEN} {
    ...
    height: calc(100dvh - ${({headerTop:e})=>e}px);
    overflow: hidden;
...
`,mt=""+new URL("arizona-state-university-logo-vertical-uITMCR3E.png",import.meta.url).href,At=""+new URL("arizona-state-university-logo-Dgr35ctq.png",import.meta.url).href,Jt=L.a`
  display: unset;
  padding: 0;
  margin: 0;
  font-size: unset;
  line-height: unset;
  white-space: unset;
`,wt=()=>{const{logo:e}=q();return a.jsxs(Jt,{href:(e==null?void 0:e.brandLink)??"https://asu.edu",className:t.NAVBAR_BRAND,"data-testid":"logo",onFocus:()=>I({text:"asu logo"}),children:[a.jsx("img",{className:t.LOGO_VERT,src:(e==null?void 0:e.src)??mt,alt:(e==null?void 0:e.alt)??"Arizona State University logo",title:(e==null?void 0:e.title)??"ASU homepage",width:"303",height:"234",decoding:"async",fetchpriority:"high"}),a.jsx("img",{className:t.LOGO_HORIZ,src:(e==null?void 0:e.mobileSrc)??At,alt:(e==null?void 0:e.alt)??"Arizona State University logo",title:(e==null?void 0:e.title)??"ASU homepage",width:"400",height:"72",decoding:"async",fetchpriority:"high"})]})};wt.__docgenInfo={description:"",methods:[],displayName:"Logo"};const _t=L.nav`
  white-space: nowrap;
  > .${t.CONTENT_CONTAINER} {
    display: flex;
    align-items: center;
...
`,$t=L.div`
  ...
  > .${t.DROPDOWN_CONTAINER} {
    ...
    */
    max-height: calc(
      100vh - ${({headerHeight:e})=>e}px - 2rem - 4rem
    );
    overflow-y: auto;
    overflow-x: hidden;
    display: flex;
...
`,ea={event:"link",action:"click",name:"onclick",type:"internal link",region:"navbar",section:"main navbar",component:"dropdown menu",text:""},xt=({text:e})=>a.jsx("h3",{className:t.UL_HEADING,children:e});xt.propTypes={text:c.string};const bt=({link:e,dropdownName:s,handleLinkEvent:n})=>a.jsx("div",{className:t.NAV_BUTTON,children:a.jsx(z,{text:e.text,color:e.color||"maroon",href:e.href,onClick:i=>n(i,e),onKeyDown:i=>n(i,e)})});bt.propTypes={link:c.shape({text:c.string,color:c.string,href:c.string}),dropdownName:c.string,handleLinkEvent:c.func};const yt=({link:e,dropdownName:s,handleLinkEvent:n})=>a.jsx("li",{className:t.NAV_LINK,children:a.jsx("a",{...e.href?{}:{tabIndex:0},href:e.href,onClick:i=>n(i,e),onKeyDown:i=>n(i,e),children:e.text})});yt.propTypes={link:c.shape({text:c.string,href:c.string}),dropdownName:c.string,handleLinkEvent:c.func};const xe=({dropdownName:e,items:s=[],buttons:n=[],classes:i="",listId:o,opened:r,parentLink:f})=>{const{breakpoint:A,headerHeight:w,setItemOpened:y,setMobileMenuOpen:T,mobileMenuOpen:u}=q(),p=s.reduce((l,g)=>g!=null&&g[0]?l+(g[0].span||1):l,0),U=p>2,N=h.useRef(null),[F,b]=h.useState(!1),C=s.length>1;h.useEffect(()=>{var l;if(typeof window<"u"&&N.current){const g=(l=N==null?void 0:N.current)==null?void 0:l.getBoundingClientRect().left,x=window.innerWidth*.55;b(g>x)}},[]),h.useEffect(()=>{var l;r&&((l=N==null?void 0:N.current)!=null&&l.parentElement)&&N.current.parentElement.scrollIntoView({behavior:"smooth",block:"start"})},[N,r]);const S=l=>l==null?void 0:l.stopPropagation(),k=(l,g)=>{var j,K;const{key:x,type:m,target:v}=l,E=v==null?void 0:v.parentElement,O=()=>{var Q;const B=(Q=E==null?void 0:E.nextElementSibling)==null?void 0:Q.firstChild;typeof(B==null?void 0:B.focus)=="function"&&B.focus()},W=()=>{var Q;const B=(Q=E==null?void 0:E.previousElementSibling)==null?void 0:Q.firstChild;typeof(B==null?void 0:B.focus)=="function"&&B.focus()};S(l),x==="ArrowDown"?(l.preventDefault(),O()):x==="ArrowUp"?(l.preventDefault(),W()):x==="Escape"&&r?(y(),typeof((j=f==null?void 0:f.current)==null?void 0:j.focus)=="function"&&f.current.focus()):x==="Escape"&&!r&&u?T(!1):(x==="Enter"||x===" "||m==="click")&&(T(!1),y(),(K=g==null?void 0:g.onClick)==null||K.call(g,l),I({...ea,text:g.text}))},H=(l,g)=>{if(!l)return null;const x=`${l.text}-${l.href}-${g}`;return l.type==="heading"?a.jsx(xt,{text:l.text},x):l.type==="button"?a.jsx(bt,{link:l,dropdownName:e,handleLinkEvent:k},x):a.jsx(yt,{link:l,dropdownName:e,handleLinkEvent:k},x)};return a.jsxs($t,{ref:N,className:`${i}${F?" aligned-right":""}${U?" mega":""}`,breakpoint:A,headerHeight:w,children:[a.jsx("div",{style:{"--cols":p<3?4:p},id:C?o:"",className:t.DROPDOWN_CONTAINER,children:a.jsx(a.Fragment,{children:s==null?void 0:s.map((l,g)=>{const m=ht(`dropdown-item-${g}-`).next().value;return l!=null&&l.length?a.jsx("div",{className:t.DROPDOWN_CONTAINER_COLUMN,style:{"--span":l[0].span||1},id:C?`${o}-${m}`:o,children:(()=>{let v=[];const E=[];return l.forEach((O,W)=>{O.type==="heading"?(v.length>0&&(E.push(v),v=[]),E.push([O])):O.type==="button"?(v.length>0&&(E.push(v),v=[]),E.push([O])):v.push(O)}),v.length>0&&E.push(v),E.map((O,W)=>{const j=`${m}-group-${W}`;return O.length===1&&O[0].type==="heading"||O.length===1&&O[0].type==="button"?H(O[0],W):a.jsx("ul",{children:O.map((K,B)=>H(K,B))},j)})})()},`${o}-${m}`):null})})}),n.length>0&&a.jsx("div",{className:t.DROPDOWN_BUTTON_CONTAINER,children:a.jsx("div",{children:n.map((l,g)=>a.jsx(z,{color:l.color,text:l.text,href:l.href,onClick:S},`${l.text}-${l.href||g}`))})})]})};xe.propTypes={dropdownName:c.string,items:c.arrayOf(c.arrayOf(c.shape({text:c.string,selected:c.bool,onClick:c.func,href:c.string}))),buttons:c.arrayOf(c.shape(Ut)),classes:c.string,listId:c.string,opened:c.bool,setItemOpened:c.func,parentLink:c.shape({current:c.instanceOf(HTMLElement)})};xe.__docgenInfo={description:`@param {DropdownItemProps} props
...
`,aa={event:"collapse",type:"click"},he={event:"link",action:"click",name:"onclick",type:"internal link",region:"navbar",section:"main navbar",component:"navigation link",text:""},vt=({children:e})=>a.jsxs(a.Fragment,{children:[a.jsx(Y,{icon:Lt,className:t.ICON_NAV_ITEM,alt:""}),a.jsx("span",{className:t.MOBILE_ONLY,children:e})]});vt.propTypes={children:c.node};const be=({link:e,setItemOpened:s,itemOpened:n})=>{const i=h.useRef(null),o=h.useRef(null),r=e.id===n,{breakpoint:f,expandOnHover:A=!1,title:w,mobileMenuOpen:y=!1,setMobileMenuOpen:T}=q(),u=oe(f);h.useEffect(()=>{const b=S=>{var k;r&&!u&&!((k=i==null?void 0:i.current)!=null&&k.contains(S==null?void 0:S.target))&&s()},C=()=>{requestAnimationFrame(()=>{const S=i.current;r&&!u&&S&&!S.contains(document.activeElement)&&s()})};return document.addEventListener("click",b,!0),document.addEventListener("focusin",C),()=>{document.removeEventListener("click",b,!0),document.removeEventListener("focusin",C)}},[r,s,u]);const p=h.useMemo(()=>{var b;return e.type==="icon-home"?a.jsx(vt,{children:e.text}):a.jsxs("span",{children:[e.text,!!((b=e.items)!=null&&b.length)&&a.jsx(Y,{icon:Dt,className:P(t.CHEVRON_ICON,r&&t.OPEN),alt:""})]})},[e]),U=()=>{var k;const b=!!((k=e.items)!=null&&k.length),C=r?"close":"open",{text:S}=e;I(b?{...he,...aa,action:C,text:S}:{...he,text:e.type==="icon-home"?"home button":S})},N=b=>{var k,H,l,g;if(!e.items&&(e.href||e.onClick)&&(b.key==="Enter"||b.key===" "||b.type==="click")){I({...he,text:e.text}),T(!1),s(),(k=e.onClick)==null||k.call(e,b);return}const{key:C}=b;if(["ArrowUp","ArrowDown","ArrowLeft","ArrowRight","Enter"," ","Escape","Click"].includes(C)){if(b.preventDefault(),C==="Escape"&&r){typeof((H=i==null?void 0:i.current)==null?void 0:H.focus)=="function"&&i.current.focus(),s();return}if(C==="Escape"&&!r&&y){T(!1);return}if((C==="Enter"||C===" ")&&(e.items?s():(T(!1),s(),(l=e.onClick)==null||l.call(e,b)),U()),(C==="ArrowDown"||C==="ArrowRight")&&r){const x=document.querySelector(`.${Ce(e.id)} li.${t.NAV_LINK} a`);typeof(x==null?void 0:x.focus)=="function"&&x.focus()}}else b.type==="click"&&e.items?(b.preventDefault(),U(),s()):b.type==="click"&&(U(),(g=e.onClick)==null||g.call(e,b))},F=()=>{A&&!u&&(s(),U())};return a.jsxs(ta,{breakpoint:f,ref:i,onMouseEnter:F,onMouseLeave:F,children:[a.jsx("a",{onKeyDown:N,onClick:N,href:e.href,...e.items?{"aria-expanded":r}:{},...e.href?{}:{tabIndex:0},"aria-owns":e.items?`dropdown-${e.id}`:null,className:P(e.class,e.selected&&t.NAV_ITEM_SELECTED,r&&t.OPEN_LINK),"data-testid":"nav-item",title:e.type==="icon-home"&&w?`${w} home page`:e.text,ref:o,children:p}),e.items&&a.jsx(xe,{items:e.items,buttons:e.buttons,dropdownName:e.text,classes:P(Ce(e.id),r&&t.OPENED),listId:`dropdown-${e.id}`,opened:r,parentLink:o})]})};be.propTypes={link:Vt,setItemOpened:c.func,itemOpened:c.number};be.__docgenInfo={description:`@param {{ link: NavTreeProps, setItemOpened: Function, itemOpened: number }} props
@returns {JSX.Element}`,methods:[],displayName:"NavItem",props:{link:{description:"",type:{name:"shape",value:{id:{name:"number",required:!1},href:{name:"string",required:!1},text:{name:"string",required:!1},type:{name:"string",required:!1},selected:{name:"bool",required:!1},items:{name:"arrayOf",value:{name:"arrayOf",value:{name:"object"}},required:!1},buttons:{name:"arrayOf",value:{name:"shape",value:{text:{name:"string",required:!0},color:{name:"enum",value:[{value:'"gold"',computed:!1},{value:'"maroon"',computed:!1},{value:'"light"',computed:!1},{value:'"dark"',computed:!1}],required:!1},href:{name:"string",required:!1},classes:{name:"string",required:!1},onClick:{name:"func",required:!1},onFocus:{name:"func",required:!1}}},required:!1},class:{name:"string",required:!1}}},required:!1},setItemOpened:{description:"",type:{name:"func"},required:!1},itemOpened:{description:"",type:{name:"number"},required:!1}}};const sa="Header buttons cannot have both an onClick and an href property as this breaks accessibility. Please remove one",ge=()=>{const{navTree:e=[],mobileNavTree:s=[],buttons:n=[],breakpoint:i,itemOpened:o,setItemOpened:r}=q(),f=oe(i),A=u=>{o===u?r(()=>{}):setTimeout(()=>r(()=>u),1)},w=u=>{u.onClick&&u.href&&console.error(sa)},y=u=>()=>{I({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:u.text}),u.onClick&&u.onClick()},T=(u,p)=>{const U={...u,id:p},F=ht(`${u.text}-${p}-`).next().value;return a.jsx(be,{link:U,setItemOpened:()=>A(p),itemOpened:o},F)};return a.jsxs(_t,{breakpoint:i,"data-testid":"navigation","aria-label":"Site",children:[((e==null?void 0:e.length)||(s==null?void 0:s.length)||(n==null?void 0:n.length))&&a.jsxs("div",{className:t.CONTENT_CONTAINER,children:[((e==null?void 0:e.length)||(s==null?void 0:s.length))&&a.jsx("ul",{className:t.NAV_LIST,children:s!=null&&s.length&&f?s==null?void 0:s.map((u,p)=>T(u,p)):e==null?void 0:e.map((u,p)=>T(u,p))}),!!(n!=null&&n.length)&&a.jsx("form",{className:t.BUTTONS_CONTAINER,"data-testid":"buttons-container",children:n.map(u=>(w(u),h.createElement(z,{...u,key:u.text,onClick:y(u)})))})]}),f&&a.jsx(we,{})]})};ge.__docgenInfo={description:"",methods:[],displayName:"NavbarContainer"};const na=""+new URL("asu-starbucks-CqsAj6pt.png",import.meta.url).href,ra=L.div`
  margin: 0.5rem 0;
  a {
    display: inline-block;
    &:not(:last-child) {
...
`,Tt=()=>{const{partnerLogo:e,logo:s,breakpoint:n}=q();return a.jsxs(ra,{breakpoint:n,"data-testid":"partner",children:[a.jsx("a",{href:(e==null?void 0:e.brandLink)??"https://starbucks.asu.edu/",onClick:()=>I({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:"partner logo"}),children:a.jsx("img",{src:(e==null?void 0:e.src)??na,alt:(e==null?void 0:e.alt)??"ASU Starbucks logo",width:"232",height:"81",decoding:"async",fetchpriority:"high"})}),a.jsxs("a",{href:(s==null?void 0:s.brandLink)??"https://asu.edu",onClick:()=>I({text:"asu logo"}),children:[a.jsx("img",{className:t.LOGO_VERT,src:(s==null?void 0:s.src)??mt,alt:(s==null?void 0:s.alt)??"Arizona State University logo",width:"303",height:"234",decoding:"async",fetchpriority:"high"}),a.jsx("img",{className:t.LOGO_HORIZ,src:(s==null?void 0:s.mobileSrc)??At,alt:(s==null?void 0:s.alt)??"Arizona State University logo",width:"400",height:"72",decoding:"async",fetchpriority:"high"})]})]})};Tt.__docgenInfo={description:"",methods:[],displayName:"Partner"};const ia=(e,s)=>{const n=new Date(e);return n.setMinutes(n.getMinutes()+s),n},oa=e=>{const s="localhost",n="title_loaded",i=new Date,o=e||window.location.hostname,r=localStorage.getItem("title_loaded"),f=i.getTime()>parseInt(r,10),A=o===s,w=document.referrer.includes(o);if(A||!w&&(!r||f)){const T=ia(i,10).getTime();return localStorage.setItem(n,T.toString()),!0}return!1},la={"992px":"993px","1260px":"1261px"},Se=L.div`
  line-height: 1;
  font-size: 1rem;
  font-weight: 700;
  ...
  @media (min-width: ${({breakpoint:e})=>la[e]}) {
    line-height: 1;
    font-weight: 700;
    padding: 0;
...
`,ye=()=>{const[e,s]=h.useState(!1),{title:n,parentOrg:i,parentOrgUrl:o,baseUrl:r,breakpoint:f,animateTitle:A}=q();return h.useEffect(()=>{if(A!==!1){let w=r==="/"?window.location.hostname:r;!w.includes(window.location.hostname)&&w.indexOf("/")===0&&(w=window.location.hostname+w),oa(w)&&s(!0)}},[e,A,r]),i?a.jsxs(Se,{breakpoint:f,className:t.TITLE,"data-testid":"title",children:[a.jsx("a",{className:t.UNIT_NAME,href:o,onClick:()=>I({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:i}),title:`${i} home page`,children:i}),a.jsx("a",{className:P(t.SUBUNIT_NAME,e&&"active"),href:r,onClick:()=>I({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:n}),title:`${n} home page`,children:n})]}):a.jsx(Se,{breakpoint:f,className:t.TITLE,"data-testid":"title",children:a.jsx("a",{className:P(t.TITLE_SUBUNIT_NAME,e&&"active"),href:r,onClick:()=>I({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:n}),title:`${n} home page`,children:n})})};ye.propTypes={...Pt};ye.__docgenInfo={description:"",methods:[],displayName:"Title",props:{baseUrl:{description:"",type:{name:"string"},required:!1},parentOrg:{description:"",type:{name:"string"},required:!1},parentOrgUrl:{description:"",type:{name:"string"},required:!1},animate:{description:"",type:{name:"bool"},required:!1}}};const Nt=()=>{const{breakpoint:e,isPartner:s,hasNavigation:n,itemOpened:i,setItemOpened:o,mobileMenuOpen:r,setMobileMenuOpen:f,mobileMenuToggleRef:A,headerTop:w}=q(),y=oe(e),T=()=>{f(p=>!p)};h.useEffect(()=>(document.body.style.overflow=r||i!==void 0?"hidden":"unset",()=>{document.body.style.overflow="unset"}),[r,i,y]),h.useEffect(()=>{f(!1),o()},[y]);const u=()=>{T(),I({event:"collapse",action:r?"close":"open",type:"click",text:"menu button tablet"})};return a.jsxs(a.Fragment,{children:[!y&&a.jsx(we,{}),a.jsx(Zt,{breakpoint:e,headerTop:w,children:a.jsx("div",{className:"container-xl",children:a.jsx("div",{className:t.HEADER_MAIN,children:a.jsxs("div",{className:P(t.NAVBAR,t.NAVBAR_EXPAND_XL,s&&t.PARTNER,r&&t.MOBILE_MENU_OPEN),children:[!s&&a.jsx(wt,{}),a.jsxs("button",{ref:A,className:P(t.NAVBAR_TOGGLER,!r&&t.COLLAPSED),type:"button",onClick:u,"aria-label":r?"Close menu":"Open menu","aria-expanded":r,children:[a.jsx("img",{src:Qt,alt:"Menu and Search Icon",className:t.MENU_SEARCH_ICON}),a.jsx(Y,{icon:Rt,alt:"",className:t.MENU_CLOSE_ICON})]}),a.jsxs("div",{className:P(!s&&t.EXPAND_TITLE,s&&t.PARTNER_TITLE,!n&&t.NO_NAVIGATION),children:[s?a.jsx(Tt,{}):a.jsx(ye,{}),!y&&a.jsx(ge,{})]}),r&&y&&a.jsx(Ae,{}),r&&y&&a.jsx(ge,{})]})})})})]})};Nt.__docgenInfo={description:"",methods:[],displayName:"HeaderMain"};const da=(e,s)=>e==null?void 0:e.findIndex(n=>{var i;return(n==null?void 0:n.href)===s||Array.isArray(n.items)&&((i=n.items)==null?void 0:i.flat().find(({href:o})=>o===s))}),ua=e=>e==null?void 0:e.find(s=>s.selected),Ee=e=>{if(!Array.isArray(e)||e.length===0||ua(e))return e;let s="";if(window!=null&&window.location&&(s=window.location.pathname+window.location.search),!s)return e;const n=da(e,s);if(n===-1)return e;const i=[...e];return i[n].selected=!0,i},Ct={Lg:"992px",Xl:"1260px"},ca=qt`
  html {
...
`,le=({isPartner:e=!1,navTree:s,title:n,baseUrl:i="/",parentOrg:o,parentOrgUrl:r,partnerLogo:f,logo:A,loggedIn:w,userName:y,loginLink:T,onLoginClick:u,logoutLink:p,onLogoutClick:U,buttons:N,breakpoint:F="Xl",animateTitle:b=!1,expandOnHover:C=!1,mobileNavTree:S,searchUrl:k,site:H,renderDiv:l="false"})=>{const g=Ee(s)||[],x=Ee(S)||[],m=h.useRef(null),v=h.useRef(null),[E,O]=h.useState(void 0),[W,j]=h.useState(!1),[K,B]=h.useState(150),[Q,ve]=h.useState(0),Te=(R=void 0)=>{O(R)},Ne=(R=!1)=>{v!=null&&v.current&&typeof v.current.focus=="function"&&v.current.focus(),j(R)},Ot=()=>{m!=null&&m.current&&(m.current.focus(),typeof window<"u"&&window.scrollTo(0,0)),Ne(),Te(),typeof document<"u"&&(document.body.style.overflow="unset")},It=()=>{if(typeof window>"u")return;const R=window.scrollY;m!=null&&m.current&&(R>m.current.getBoundingClientRect().top?m.current.classList.add("scrolled"):m.current.classList.remove("scrolled"),ve(m.current.getBoundingClientRect().top),B(m.current.getBoundingClientRect().bottom))};h.useEffect(()=>{typeof window<"u"&&Mt({packageName:"component-header",component:"Component Header",type:"NA",configuration:{site:H,isPartner:e,searchUrl:k,navTree:g,parentOrg:o,buttons:N,mobileNavTree:x}})},[]),h.useEffect(()=>{m!=null&&m.current&&(B(m.current.getBoundingClientRect().bottom),ve(m.current.getBoundingClientRect().top))},[m,W]),h.useEffect(()=>{if(typeof window>"u")return;const R=()=>Ht(It,100);return window.addEventListener("scroll",R),()=>{window.removeEventListener("scroll",R)}},[]);const St=()=>{const R=l==="true"?pa:ha;return a.jsx(R,{id:"asuHeader",breakpoint:F,ref:m,children:a.jsx(Nt,{})})};return a.jsxs(me,{initialValue:{isPartner:e,navTree:g,title:n,baseUrl:i,parentOrg:o,parentOrgUrl:r,partnerLogo:f,logo:A,loggedIn:w,userName:y,loginLink:T,onLoginClick:u,logoutLink:p,onLogoutClick:U,buttons:N,breakpoint:F,animateTitle:b,expandOnHover:C,mobileNavTree:x,hasNavigation:!!(g!=null&&g.length)||!!(x!=null&&x.length),searchUrl:k,headerTop:Q,headerHeight:K,itemOpened:E,setItemOpened:Te,mobileMenuOpen:W,setMobileMenuOpen:Ne,singlePageAppReset:Ot,mobileMenuToggleRef:v,site:H},children:[a.jsx(ca,{}),St()]})};le.propTypes={...Ft};le.__docgenInfo={description:`@param {HeaderProps} props
@returns {JSX.Element}`,methods:[],displayName:"ASUHeader",props:{isPartner:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},baseUrl:{defaultValue:{value:'"/"',computed:!1},description:"",type:{name:"string"},required:!1},breakpoint:{defaultValue:{value:'"Xl"',computed:!1},description:"",type:{name:"enum",value:[{value:'"Lg"',computed:!1},{value:'"Xl"',computed:!1}]},required:!1},animateTitle:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},expandOnHover:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},renderDiv:{defaultValue:{value:'"false"',computed:!1},description:"",type:{name:"enum",value:[{value:'"true"',computed:!1},{value:'"false"',computed:!1}]},required:!1},navTree:{description:"",type:{name:"arrayOf",value:{name:"custom",raw:"NavTreePropTypes"}},required:!1},partnerLogo:{description:"",type:{name:"shape",value:{alt:{name:"string",required:!1},title:{name:"string",required:!1},src:{name:"string",required:!1},mobileSrc:{name:"string",required:!1},brandLink:{name:"string",required:!1}}},required:!1},logo:{description:"",type:{name:"shape",value:{alt:{name:"string",required:!1},title:{name:"string",required:!1},src:{name:"string",required:!1},mobileSrc:{name:"string",required:!1},brandLink:{name:"string",required:!1}}},required:!1},title:{description:"",type:{name:"string"},required:!1},parentOrg:{description:"",type:{name:"string"},required:!1},parentOrgUrl:{description:"",type:{name:"string"},required:!1},loggedIn:{description:"",type:{name:"bool"},required:!1},userName:{description:"",type:{name:"string"},required:!1},loginLink:{description:"",type:{name:"string"},required:!1},onLoginClick:{description:"",type:{name:"func"},required:!1},logoutLink:{description:"",type:{name:"string"},required:!1},onLogoutClick:{description:"",type:{name:"func"},required:!1},buttons:{description:"",type:{name:"arrayOf",value:{name:"shape",value:{text:{name:"string",required:!0},color:{name:"enum",value:[{value:'"gold"',computed:!1},{value:'"maroon"',computed:!1},{value:'"light"',computed:!1},{value:'"dark"',computed:!1}],required:!1},href:{name:"string",required:!1},classes:{name:"string",required:!1},onClick:{name:"func",required:!1},onFocus:{name:"func",required:!1}}}},required:!1},mobileNavTree:{description:"",type:{name:"arrayOf",value:{name:"custom",raw:"NavTreePropTypes"}},required:!1},hasNavigation:{description:"",type:{name:"bool"},required:!1},searchUrl:{description:"",type:{name:"string"},required:!1},site:{description:"",type:{name:"string"},required:!1}}};const ba={title:"UDS/ASU Header",component:le,argTypes:{renderDiv:{control:"select",options:["true","false"],description:"Either 'true' or 'false'. If 'true', the header will be rendered as a div instead of a header element."}}},fe="Disabled",ga="Enabled";function ke(e){e.preventDefault(),e.returnValue=""}function fa(e){e.target.textContent===fe?(window.addEventListener("beforeunload",ke),e.target.textContent=ga):(window.removeEventListener("beforeunload",ke),e.target.textContent=fe)}const M=e=>a.jsxs(a.Fragment,{children:[a.jsx(le,{...e}),a.jsxs("div",{id:"skip-to-content",style:{width:"100%",height:"200vh",background:"#f0f0f0",paddingTop:40,marginTop:140,fontFamily:"Arial"},children:[a.jsxs("h1",{style:{textAlign:"center"},children:["Scroll section to test header scroll behavior"," "]}),a.jsxs("div",{style:{maxWidth:"1200px",width:"calc(100% - 4rem)",padding:"2rem",textAlign:"center",margin:"2rem auto"},children:[a.jsx("h2",{children:"Add Page Unload Warning"}),a.jsx("p",{children:"This button toggles a page unload warning that prompts the user to confirm before leaving the page. This is useful for testing the header's behavior when there is a potential for unintentionally navigating away from the page."}),a.jsx("p",{children:"This button also serves as a focusable element for testing accessibility."}),a.jsx("p",{children:a.jsx(z,{color:"dark",tabIndex:0,onClick:fa,text:fe})})]})]})]}),ma=e=>{const s=()=>{localStorage.getItem("title_loaded")&&localStorage.removeItem("title_loaded"),setTimeout(()=>{window.location.reload()},1e3)};return a.jsxs(a.Fragment,{children:[a.jsx(le,{...e,animateTitle:!0}),a.jsx("div",{style:{marginTop:200,textAlign:"center"},children:a.jsx(z,{text:"Animate Title",color:"dark",onClick:s})})]})},G=M.bind({});G.args={loggedIn:!1,userName:"",navTree:ie,title:"Subdomain name",breakpoint:"Lg",searchUrl:"https://search.asu.edu/search",site:"subdomain",renderDiv:"false"};const Z=M.bind({});Z.args={};const J=M.bind({});J.args={title:"Subdomain name",loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const _=M.bind({});_.args={title:"Subdomain name",buttons:[{href:"/",text:"CTA Button 1",color:"gold"},{text:"CTA Button 2",href:"#",color:"light"}],loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const $=M.bind({});$.args={loggedIn:!1,userName:"",logoutLink:"/caslogout",loginLink:"/cas",navTree:ie,title:"Subdomain name",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const ee=M.bind({});ee.args={loggedIn:!1,userName:"",logoutLink:"/caslogout",loginLink:"/cas",navTree:ie,mobileNavTree:Xt,title:"Subdomain name",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const te=M.bind({});te.args={navTree:Wt,title:"Subdomain name",buttons:[{href:"/",text:"CTA Button 1",color:"gold",classes:"custom-class"},{text:"CTA Button 2",href:"#",color:"light"}],loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const ae=M.bind({});ae.args={navTree:pt,title:"Subdomain name",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const se=M.bind({});se.args={navTree:pt,title:"Subdomain name",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",expandOnHover:!0,searchUrl:"https://search.asu.edu/search",site:"subdomain"};const ne=M.bind({});ne.args={isPartner:!0,navTree:ie,loggedIn:!1,userName:"",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const re=ma.bind({});re.args={title:"Subdomain name",navTree:ie,loggedIn:!1,logoutLink:"/caslogout",loginLink:"/cas",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain",animateTitle:!0};var Be,Ue,De;G.parameters={...G.parameters,docs:{...(Be=G.parameters)==null?void 0:Be.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
  ...
  </>`,...(De=(Ue=G.parameters)==null?void 0:Ue.docs)==null?void 0:De.source}}};var Le,Ve,Pe;Z.parameters={...Z.parameters,docs:{...(Le=Z.parameters)==null?void 0:Le.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div id="skip-to-content" style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(Pe=(Ve=Z.parameters)==null?void 0:Ve.docs)==null?void 0:Pe.source}}};var Re,qe,Me;J.parameters={...J.parameters,docs:{...(Re=J.parameters)==null?void 0:Re.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div id="skip-to-content" style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(Me=(qe=J.parameters)==null?void 0:qe.docs)==null?void 0:Me.source}}};var Fe,He,We;_.parameters={..._.parameters,docs:{...(Fe=_.parameters)==null?void 0:Fe.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div id="skip-to-content" style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(We=(He=_.parameters)==null?void 0:He.docs)==null?void 0:We.source}}};var Xe,Qe,je;$.parameters={...$.parameters,docs:{...(Xe=$.parameters)==null?void 0:Xe.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div id="skip-to-content" style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(je=(Qe=$.parameters)==null?void 0:Qe.docs)==null?void 0:je.source}}};var Ke,Ye,ze;ee.parameters={...ee.parameters,docs:{...(Ke=ee.parameters)==null?void 0:Ke.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div id="skip-to-content" style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(ze=(Ye=ee.parameters)==null?void 0:Ye.docs)==null?void 0:ze.source}}};var Ge,Ze,Je;te.parameters={...te.parameters,docs:{...(Ge=te.parameters)==null?void 0:Ge.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div id="skip-to-content" style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(Je=(Ze=te.parameters)==null?void 0:Ze.docs)==null?void 0:Je.source}}};var _e,$e,et;ae.parameters={...ae.parameters,docs:{...(_e=ae.parameters)==null?void 0:_e.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div id="skip-to-content" style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(et=($e=ae.parameters)==null?void 0:$e.docs)==null?void 0:et.source}}};var tt,at,st;se.parameters={...se.parameters,docs:{...(tt=se.parameters)==null?void 0:tt.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div id="skip-to-content" style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(st=(at=se.parameters)==null?void 0:at.docs)==null?void 0:st.source}}};var nt,rt,it;ne.parameters={...ne.parameters,docs:{...(nt=ne.parameters)==null?void 0:nt.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div id="skip-to-content" style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(it=(rt=ne.parameters)==null?void 0:rt.docs)==null?void 0:it.source}}};var ot,lt,dt;re.parameters={...re.parameters,docs:{...(ot=re.parameters)==null?void 0:ot.docs,source:{originalSource:`args => {
  const handleClick = () => {
...
}`,...(dt=(lt=re.parameters)==null?void 0:lt.docs)==null?void 0:dt.source}}};const ya=["Default","Empty","NoNavigation","NoNavigationWithButtons","BreakpointXL","WithMobileNavTree","WithButtons","WithMenuColumns","ExpandOnHover","Partner","AnimatedTitle"];export{re as AnimatedTitle,$ as BreakpointXL,G as Default,Z as Empty,se as ExpandOnHover,J as NoNavigation,_ as NoNavigationWithButtons,ne as Partner,te as WithButtons,ae as WithMenuColumns,ee as WithMobileNavTree,ya as __namedExportsOrder,ba as default};
