...
`,ViewSelector=({view,setView,label})=>react.createElement(GridViewSelectorContainer,{className:"view-toggle",role:"group","aria-label":"View options"},react.createElement("span",{className:"view-label",id:"view-label"},label),react.createElement("div",{className:"view-buttons",role:"toolbar","aria-labelledby":"view-label"},react.createElement("button",{className:"view-button "+(view?"active":""),"aria-label":"Grid view",type:"button",onClick:()=>setView(!0),"aria-pressed":view},react.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},react.createElement("rect",{x:"1",y:"1",width:"6",height:"6",rx:"2"}),react.createElement("rect",{x:"9",y:"1",width:"6",height:"6",rx:"2"}),react.createElement("rect",{x:"17",y:"1",width:"6",height:"6",rx:"2"}),react.createElement("rect",{x:"1",y:"9",width:"6",height:"6",rx:"2"}),react.createElement("rect",{x:"9",y:"9",width:"6",height:"6",rx:"2"}),react.createElement("rect",{x:"17",y:"9",width:"6",height:"6",rx:"2"}),react.createElement("rect",{x:"1",y:"17",width:"6",height:"6",rx:"2"}),react.createElement("rect",{x:"9",y:"17",width:"6",height:"6",rx:"2"}),react.createElement("rect",{x:"17",y:"17",width:"6",height:"6",rx:"2"}))),react.createElement("button",{className:"view-button "+(view?"":"active"),"aria-label":"List view",type:"button",onClick:()=>setView(!1),"aria-pressed":!view},react.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},react.createElement("rect",{x:"2",y:"1",width:"6",height:"6",rx:"2"}),react.createElement("rect",{x:"11",y:"2",width:"14",height:"4.5",rx:"3"}),react.createElement("rect",{x:"2",y:"9",width:"6",height:"6",rx:"2"}),react.createElement("rect",{x:"11",y:"10",width:"14",height:"4.5",rx:"3"}),react.createElement("rect",{x:"2",y:"17",width:"6",height:"6",rx:"2"}),react.createElement("rect",{x:"11",y:"18",width:"14",height:"4.5",rx:"3"})))));ViewSelector.displayName="ViewSelector",ViewSelector.propTypes={view:prop_types_default().bool,setView:prop_types_default().func,label:prop_types_default().string},ViewSelector.__docgenInfo={description:"",methods:[],displayName:"ViewSelector",props:{view:{description:"",type:{name:"bool"},required:!1},setView:{description:"",type:{name:"func"},required:!1},label:{description:"",type:{name:"string"},required:!1}}};const WebDirLayout=styled_components_browser_esm.Ay.div`
  display: grid;
...
`,FacultyRankLayout=styled_components_browser_esm.Ay.div`
  display: flex;
  flex-wrap: wrap;
  .uds-grid > .row {
    gap: 1rem;
