import{j as e}from"./jsx-runtime-DvmJwJjP.js";import{r as o}from"./index-DUDtsY9M.js";import{A as b,e as a,S as ee,w as S,s as te,k as _,a as N}from"./sort-DisWf-UL.js";import{q as I,P as t,F as se}from"./styled-components.browser.esm-V80J5lJN.js";import{a as re}from"./index-BDvQmEWF.js";import{s as ne}from"./index-BnrikOIn.js";import{Q as ae}from"./index-DvfggIMO.js";import"./_commonjsHelpers-B3tUAs5q.js";import"./index-Cke5fq-D.js";import"./dataConverter-B8rLz1e4.js";const oe=I.div`
...
@returns {JSX.Element} The LocalTab component.`,methods:[],displayName:"LocalTab",props:{term:{description:"",type:{name:"string"},required:!1},engines:{description:"",type:{name:"object"},required:!1},site:{description:"",type:{name:"string"},required:!1},loggedIn:{description:"",type:{name:"bool"},required:!1}}};const k=({engines:n,term:i,loggedIn:s})=>e.jsx(pe,{children:e.jsx(b,{term:i,engine:n[a.STUDENTS],itemsPerPage:6,type:"full",GASource:"all student results",titleText:"All Student results",loggedIn:s,showSearchMessage:!0,restClientTag:"asuis"})});k.propTypes={term:t.string,engines:t.object,loggedIn:t.bool};k.__docgenInfo={description:`React component for displaying search results on the Students tab.
...
@param {string} props.site - The specific site to display results for.
@param {boolean} props.loggedIn - Indicates whether the user is logged in.
@returns {JSX.Element} The LocalTab component.`,methods:[],displayName:"LocalTab",props:{term:{description:"",type:{name:"string"},required:!1},engines:{description:"",type:{name:"object"},required:!1},site:{description:"",type:{name:"string"},required:!1},loggedIn:{description:"",type:{name:"bool"},required:!1}}};k.__docgenInfo={description:`React component for displaying search results on the Students tab.
...
`;function O({API_URL:n,searchApiVersion:i,loggedIn:s,deptAdmin:p,profileURLBase:u,appPathFolder:U}){const g="search-tabs",m="q",q="url_host",[d,J]=o.useState(""),[h,x]=o.useState(""),[y,l]=o.useState(0),[f,X]=o.useState(""),[c,Y]=re({[g]:j.all}),[K]=o.useState({}),[T,Q]=o.useState(null),F=o.useRef(null),A={filters:K,API_URL:n,searchApiVersion:i,profileURLBase:u||"https://search.asu.edu",appPathFolder:U},v={[a.FACULTY]:{...N[a.FACULTY],...A},[a.STUDENTS]:{...N[a.STUDENTS],...A},[a.SITES_LOCAL]:{...N[a.SITES_LOCAL],...A,site:T},[a.SITES]:{...N[a.SITES],...A}},z=(r,Z)=>{const C={};for(const V of c.entries())C[V[0]]=V[1];C[r]=Z,Y(C)},D=()=>{f.length>0&&(l(0),z(m,f))},W=r=>{x(r)};o.useEffect(()=>{c.get(q)&&Q(c.get(q)),c.get(m)&&(J(c.get(m)),X(c.get(m)))},[c,h]),o.useEffect(()=>{F.current&&F.current.focus()},[]);const G=r=>{z(g,r),l(0)},H=r=>{r.keyCode===13&&(r.preventDefault(),D())},w=r=>d?r:ne[c.get(g)];return e.jsxs(ce,{children:[e.jsx("h1",{children:e.jsx("span",{className:"highlight-gold",children:"Search"})}),e.jsxs("div",{className:"options-area",children:[e.jsx("form",{className:"uds-form",children:e.jsxs("div",{className:"form-group",children:[e.jsx("input",{type:"text",className:"form-control",id:"search-input",placeholder:"Search asu.edu",value:f,onChange:r=>X(r.target.value),onKeyDown:H,ref:F}),e.jsx(S,{color:"maroon",icon:["fas","search"],label:"Search",onClick:()=>D()})]})}),e.jsxs("div",{className:"profile-options",children:[e.jsx("div",{className:"desktop-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Edit my profile",href:"/profile-edit"})}),e.jsx("div",{className:"mobile-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Edit my profile",href:"/profile-edit",size:"small"})}),s&&p&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"desktop-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Department admin",href:"/groups"})}),e.jsx("div",{className:"mobile-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Department admin",href:"/groups",size:"small"})})]})]})]}),e.jsxs(te,{initialTab:c.get(g),onTabChange:r=>G(r),children:[e.jsx(_,{id:j.all,title:"All ASU Search",children:w(e.jsx(R,{totalResults:y,setTotalResults:l,engines:v,site:T,goToTab:G,term:d,loggedIn:s}))}),T&&e.jsx(_,{id:j.sites,title:T,children:w(e.jsx(E,{loggedIn:s,engines:v,site:T,term:d}))}),e.jsx(_,{id:j.faculty,title:"Faculty and Staff",children:w(e.jsx(L,{engines:v,term:d,sort:h,onSortChange:r=>W(r)}))}),e.jsx(_,{id:j.students,icon:["fa","lock"],title:"Students",children:w(e.jsx(k,{loggedIn:s,engines:v,term:d}))})]})]})}O.propTypes={API_URL:t.string,searchApiVersion:t.string,loggedIn:t.bool,deptAdmin:t.bool,profileURLBase:t.string,appPathFolder:t.string};O.__docgenInfo={description:`React component for the ASU search page.
