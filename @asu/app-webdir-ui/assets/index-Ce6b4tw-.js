import{r as l,j as e}from"./iframe-CPKfTg6u.js";import{P as t,g as q}from"./styled-components.browser.esm-kZNv9HdV.js";import{b as C,a as c,n as V,Q as $,A as B,e as K,S as M}from"./sort-d9ZIR-6T.js";function z({packageName:n="",component:u="",type:f="",configuration:b={}}){if(!n||!u){console.error("trackReactComponent: Missing required arguments.");return}window.uds=window.uds||{},window.uds.package=window.uds.package||{},window.uds.package[n]={component:u,type:f,configuration:b}}const F={1:"Faculty",2:"Academic Professionals",3:"Other Faculty and Academic Professionals"},O=({filters:n,API_URL:u,searchApiVersion:f,appPathFolder:b,deptIds:h,display:y,profileURLBase:g,searchType:r,grid:w})=>{const[T,a]=l.useState({}),[j,P]=l.useState(null),[R,m]=l.useState(!0),[_,S]=l.useState({}),D=6,s="faculty_rank",i=new URL(`${u}${f}${C[c.WEB_DIRECTORY_FACULTY_RANK].url}`);i.searchParams.append("sort_by",r),i.searchParams.append("dept_ids",h),i.searchParams.append("page","1"),i.searchParams.append("size","1");const x=async p=>{var N;const o=`${i}&rank_group=${p}`,L=await(await fetch(o)).json();return{rankGroup:p,length:(N=L.results)==null?void 0:N.length}};l.useEffect(()=>{const p={...n};p.deptIds=h.split(","),a(p);const o=Object.keys(F).map(x);Promise.all(o).then(d=>{const L=d.reduce((N,{rankGroup:W,length:Y})=>(Y>0&&(N[W]=F[W]),N),{});S(L),m(!1)})},[h,j]);const E={filters:n,API_URL:u,searchApiVersion:f,profileURLBase:g||"https://search.asu.edu",appPathFolder:b},v={[c.WEB_DIRECTORY_FACULTY_RANK]:{...C[c.WEB_DIRECTORY_FACULTY_RANK],...E}},I={faculty_rank:c.WEB_DIRECTORY_FACULTY_RANK};return R?e.jsx("div",{children:"Loading..."}):Object.keys(_).length?e.jsx(V,{onTabChange:P,children:Object.keys(_).map(p=>e.jsx($,{id:`faculty-${p}`,title:F[p],children:e.jsx(B,{engine:v[I[r]],itemsPerPage:parseInt(y.profilesPerPage,10)||D,size:"large",sort:s,hidePaginator:y.usePager!=="1",filters:T,profilesToFilterOut:y.doNotDisplayProfiles,display:y,rankGroup:p.toString(),restClientTag:"asuis",grid:w})},p))}):e.jsxs("div",{children:["No faculty rank data found for department ",h]})};O.propTypes={deptIds:t.string,API_URL:t.string,searchApiVersion:t.string,searchType:t.string,profileURLBase:t.string,appPathFolder:t.string,display:t.shape({defaultSort:t.string,doNotDisplayProfiles:t.string,profilesPerPage:t.string,usePager:t.string}),filters:t.shape({employee:t.string,expertise:t.string,title:t.string,campuses:t.string}),grid:t.bool};O.__docgenInfo={description:`Prop types for FacultyRankTabPanels component.
@type {Object}
...
`,k=({filterLabel:n,choices:u=[],onChoose:f=()=>{},resetFilters:b=()=>{}})=>{const[h,y]=l.useState(null),[g,r]=l.useState(-1),[w,T]=l.useState(0),a=l.useRef(null),[j,P]=l.useState(0),[R,m]=l.useState(0);l.useEffect(()=>{const s=()=>{P(a.current.scrollLeft)};return a.current&&(a.current.addEventListener("scroll",s),s()),()=>{var i;return(i=a.current)==null?void 0:i.removeEventListener("scroll",s)}},[R]),l.useEffect(()=>{const s=()=>{a.current&&m(a.current.scrollWidth-a.current.offsetWidth)};return a.current&&(a.current.addEventListener("resize",s),s()),()=>{var i;return(i=a.current)==null?void 0:i.removeEventListener("resize",s)}},[]),l.useEffect(()=>{if(a.current){const s=a.current.children.length;T(s)}},[]);const _=s=>{var i;if(a.current){if(s.key==="ArrowRight"&&g+1<w){const x=(i=a.current)==null?void 0:i.children[g+1];r(g+1),x.focus()}else if(s.key==="ArrowLeft"&&g-1>=0){const x=a.current.children[g-1];r(g-1),x.focus()}}},S=s=>{y(s),f(s)},D=s=>{const i=a.current,x=i.scrollWidth-i.clientWidth;let v=i.scrollLeft+200*s;v=Math.max(0,Math.min(x,v)),i.scrollTo({left:v,behavior:"smooth"})};return e.jsxs(H,{className:"filter-container",children:[e.jsx("legend",{children:n}),e.jsxs("div",{className:"choices-wrapper",children:[e.jsx(K,{hidePrev:j<=0,hideNext:j>=R-5,clickPrev:()=>{D(-1)},clickNext:()=>{D(1)}}),e.jsxs("div",{role:"radiogroup",tabIndex:0,onKeyDown:_,className:"choices-container",ref:a,"aria-label":`${n} filter options}`,children:[b&&e.jsx("button",{role:"radio",type:"button",onClick:s=>{s.preventDefault(),S(null),b()},tabIndex:-1,"aria-label":"All","aria-checked":h===null,className:"choice",children:"All"}),u.map(s=>e.jsx("button",{role:"radio",type:"button",onClick:i=>{i.preventDefault(),S(s)},"aria-checked":h===s,className:`${h===s?"selected":""} choice`,"aria-label":`Filter by ${s}`,tabIndex:-1,children:s},s))]})]})]})};k.propTypes={filterLabel:t.string.isRequired,choices:t.arrayOf(t.string).isRequired,onChoose:t.func.isRequired,resetFilters:t.func};k.__docgenInfo={description:`Prop types for FilterComponent component.
@type {Object}
...
@property {function} [resetFilters=() => {}] - A callback function triggered to reset the filters.`,methods:[],displayName:"FilterComponent",props:{choices:{defaultValue:{value:"[]",computed:!1},description:"",type:{name:"arrayOf",value:{name:"string"}},required:!1},onChoose:{defaultValue:{value:"() => {}",computed:!1},description:"",type:{name:"func"},required:!1},resetFilters:{defaultValue:{value:"() => {}",computed:!1},description:"",type:{name:"func"},required:!1},filterLabel:{description:"",type:{name:"string"},required:!0}}};const Q=q.div`
  display: flex;
  align-items: center;
...
`;function U({searchType:n,ids:u,deptIds:f,API_URL:b,searchApiVersion:h,profileURLBase:y,appPathFolder:g,display:r,filters:w,alphaFilter:T="false"}){const[a,j]=l.useState(s),[P,R]=l.useState(D),[m,_]=l.useState((r==null?void 0:r.grid)==="true"||(r==null?void 0:r.grid)===!0),S=6;l.useEffect(()=>{typeof window<"u"&&z({packageName:"app-webdir-ui",component:"WebDirectory",type:n,configuration:{...w,...r}})},[]);function D(){const o=w?{...w}:{};return n==="departments"||n==="faculty_rank"?(o.deptIds=f.split(","),o):(o.peopleInDepts=u.split(",").filter(d=>d.includes(":")).map(d=>d.split(":")).map(d=>({asurite_id:d[0],dept_id:d[1]})),o)}function s(){const o={last_name:"last_name_asc",people_order:"people_order"};return Object.prototype.hasOwnProperty.call(o,r==null?void 0:r.defaultSort)?o[r==null?void 0:r.defaultSort]:"last_name_asc"}function i(o,d){var L;return o==="departments"&&((L=d==null?void 0:d.split(","))==null?void 0:L.length)<2?[{value:"default",label:"Choose Sort",disabled:!0},{value:"last_name_asc",label:"Last Name (ascending)"},{value:"last_name_desc",label:"Last Name (descending)"}]:[{value:"default",label:"Choose Sort",disabled:!0},{value:"last_name_asc",label:"Last Name (ascending)"},{value:"last_name_desc",label:"Last Name (descending)"}]}const x=i(n,f),E={filters:w,API_URL:b,searchApiVersion:h,profileURLBase:y||"https://search.asu.edu",appPathFolder:g},v={[c.WEB_DIRECTORY_DEPARTMENTS]:{...C[c.WEB_DIRECTORY_DEPARTMENTS],...E},[c.WEB_DIRECTORY_PEOPLE_AND_DEPS]:{...C[c.WEB_DIRECTORY_PEOPLE_AND_DEPS],...E},[c.WEB_DIRECTORY_PEOPLE_AND_DEPS]:{...C[c.WEB_DIRECTORY_PEOPLE_AND_DEPS],...E},[c.WEB_DIRECTORY_FACULTY_RANK]:{...C[c.WEB_DIRECTORY_FACULTY_RANK],...E,deptIds:f,display:r,searchType:n}},I=o=>{j(o)},p={departments:c.WEB_DIRECTORY_DEPARTMENTS,people:c.WEB_DIRECTORY_PEOPLE_AND_DEPS,people_departments:c.WEB_DIRECTORY_PEOPLE_AND_DEPS,faculty_rank:c.WEB_DIRECTORY_FACULTY_RANK};return n!=="faculty_rank"?e.jsx(e.Fragment,{children:e.jsxs(J,{className:m?"grid-view":"",children:[e.jsx(A,{view:m,setView:_,label:"View"}),e.jsx("div",{className:"sort",children:e.jsx(M,{customSortOptions:x,sort:a,onChange:o=>I(o)})}),T==="true"&&e.jsx(k,{filterLabel:"Filter By Last Initial",choices:G,onChoose:o=>R({...P,lastInit:o}),resetFilters:()=>R({...P,lastInit:""})}),e.jsx("div",{className:"results",children:e.jsx(B,{engine:v[p[n]],itemsPerPage:parseInt(r==null?void 0:r.profilesPerPage,10)||S,sort:a,hidePaginator:(r==null?void 0:r.usePager)!=="1",filters:P,profilesToFilterOut:r==null?void 0:r.doNotDisplayProfiles,display:r,appPathFolder:g,restClientTag:"webdir",grid:m})})]})}):e.jsxs(X,{className:m?"grid-view":"",children:[e.jsx(A,{view:m,setView:_,label:"View"}),e.jsx(O,{...v[p[n]],alphaFilter:T,filters:P,grid:m,setGridView:_,className:"tabbed-panels"})]})}U.propTypes={deptIds:t.string,API_URL:t.string,searchApiVersion:t.string,searchType:t.string,ids:t.string,profileURLBase:t.string,appPathFolder:t.string,display:t.shape({defaultSort:t.string,doNotDisplayProfiles:t.string,profilesPerPage:t.string,usePager:t.string,grid:t.string||t.bool}),filters:t.shape({employee:t.string,expertise:t.string,title:t.string,campuses:t.string}),alphaFilter:t.string};U.__docgenInfo={description:`React component for displaying web directory search results.
