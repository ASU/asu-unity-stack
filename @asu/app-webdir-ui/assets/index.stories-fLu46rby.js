import{j as e}from"./jsx-runtime-DvmJwJjP.js";import{r as o}from"./index-DUDtsY9M.js";import{A as b,e as a,S as ee,w as S,t as te,v as _,a as N}from"./sort-DscC1NkV.js";import{q as I,P as t,F as se}from"./styled-components.browser.esm-B6_ApnWR.js";import{a as re}from"./index-Dm54Kt9Z.js";import{s as ne}from"./index-Tyx4BYch.js";import{Q as ae}from"./index-DDNuMqt8.js";import"./_commonjsHelpers-B3tUAs5q.js";import"./index-B-eQrFJv.js";import"./dataConverter-B_Z4K7iZ.js";const oe=I.div`
...
`;function O({API_URL:n,searchApiVersion:i,loggedIn:s,deptAdmin:p,profileURLBase:u,appPathFolder:U}){const g="search-tabs",m="q",v="url_host",[d,J]=o.useState(""),[h,x]=o.useState(""),[y,l]=o.useState(0),[f,X]=o.useState(""),[c,Y]=re({[g]:j.all}),[K]=o.useState({}),[T,Q]=o.useState(null),k=o.useRef(null),q={filters:K,API_URL:n,searchApiVersion:i,profileURLBase:u||"https://search.asu.edu",appPathFolder:U},A={[a.FACULTY]:{...N[a.FACULTY],...q},[a.STUDENTS]:{...N[a.STUDENTS],...q},[a.SITES_LOCAL]:{...N[a.SITES_LOCAL],...q,site:T},[a.SITES]:{...N[a.SITES],...q}},z=(r,Z)=>{const C={};for(const V of c.entries())C[V[0]]=V[1];C[r]=Z,Y(C)},D=()=>{f.length>0&&(l(0),z(m,f))},W=r=>{x(r)};o.useEffect(()=>{c.get(v)&&Q(c.get(v)),c.get(m)&&(J(c.get(m)),X(c.get(m)))},[c,h]),o.useEffect(()=>{k.current&&k.current.focus()},[]);const G=r=>{z(g,r),l(0)},H=r=>{r.keyCode===13&&(r.preventDefault(),D())},w=r=>d?r:ne[c.get(g)];return e.jsxs(ce,{children:[e.jsx("h1",{children:e.jsx("span",{className:"highlight-gold",children:"Search"})}),e.jsxs("div",{className:"options-area",children:[e.jsx("form",{className:"uds-form",children:e.jsxs("div",{className:"form-group",children:[e.jsx("input",{type:"text",className:"form-control",id:"search-input",placeholder:"Search asu.edu",value:f,onChange:r=>X(r.target.value),onKeyDown:H,ref:k}),e.jsx(S,{color:"maroon",icon:["fas","search"],label:"Search",onClick:()=>D()})]})}),e.jsxs("div",{className:"profile-options",children:[e.jsx("div",{className:"desktop-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Edit my profile",href:"/profile-edit"})}),e.jsx("div",{className:"mobile-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Edit my profile",href:"/profile-edit",size:"small"})}),s&&p&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"desktop-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Department admin",href:"/groups"})}),e.jsx("div",{className:"mobile-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Department admin",href:"/groups",size:"small"})})]})]})]}),e.jsxs(te,{initialTab:c.get(g),onTabChange:r=>G(r),children:[e.jsx(_,{id:j.all,title:"All ASU Search",children:w(e.jsx(R,{totalResults:y,setTotalResults:l,engines:A,site:T,goToTab:G,term:d,loggedIn:s}))}),T&&e.jsx(_,{id:j.sites,title:T,children:w(e.jsx(E,{loggedIn:s,engines:A,site:T,term:d}))}),e.jsx(_,{id:j.faculty,title:"Faculty and Staff",children:w(e.jsx(L,{engines:A,term:d,sort:h,onSortChange:r=>W(r)}))}),e.jsx(_,{id:j.students,icon:["fa","lock"],title:"Students",children:w(e.jsx(F,{loggedIn:s,engines:A,term:d}))})]})]})}O.propTypes={API_URL:t.string,searchApiVersion:t.string,loggedIn:t.bool,deptAdmin:t.bool,profileURLBase:t.string,appPathFolder:t.string};O.__docgenInfo={description:`React component for the ASU search page.
