import{r as o,j as e,u as ee}from"./iframe-CGe7Wy5A.js";import{A as f,e as n,S as se,a as T,U as te,c as I,b as _}from"./sort-D7ck2HSR.js";import{g as P,P as s,F as re}from"./styled-components.browser.esm-0ZuCFfxC.js";import{s as ae}from"./index-B-F0AvOV.js";import{Q as ne}from"./index-mO8pqslq.js";import"./preload-helper-Dp1pzeXC.js";import"./dataConverter-vtgfCe0N.js";const oe=P.div`
...
@returns {JSX.Element} The LocalTab component.`,methods:[],displayName:"LocalTab",props:{term:{description:"",type:{name:"string"},required:!1},engines:{description:"",type:{name:"object"},required:!1},site:{description:"",type:{name:"string"},required:!1},loggedIn:{description:"",type:{name:"bool"},required:!1}}};const U=({engines:a,term:i,loggedIn:t})=>e.jsx(ce,{children:e.jsx(f,{term:i,engine:a[n.STUDENTS],itemsPerPage:6,type:"full",GASource:"all student results",titleText:"All Student results",loggedIn:t,showSearchMessage:!0,restClientTag:"asuis"})});U.propTypes={term:s.string,engines:s.object,loggedIn:s.bool};U.__docgenInfo={description:`React component for displaying search results on the Students tab.
...
`;function F({API_URL:a,searchApiVersion:i,loggedIn:t,deptAdmin:c,profileURLBase:m,appPathFolder:O}){const u="search-tabs",A="url_host",[d,z]=o.useState(""),[g,x]=o.useState(""),[b,l]=o.useState(0),[h,D]=o.useState(""),[p,Y]=ee({[u]:S.all}),[K]=o.useState({}),[y,Q]=o.useState(null),R=o.useRef(null),v={filters:K,API_URL:a,searchApiVersion:i,profileURLBase:m||"https://search.asu.edu",appPathFolder:O},N={[n.FACULTY]:{..._[n.FACULTY],...v},[n.STUDENTS]:{..._[n.STUDENTS],...v},[n.SITES_LOCAL]:{..._[n.SITES_LOCAL],...v,site:y},[n.SITES]:{..._[n.SITES],...v}},G=(r,Z)=>{const E={};for(const J of p.entries())E[J[0]]=J[1];E[r]=Z,Y(E)},V=()=>{h.length>0&&(l(0),G("q",h))},W=r=>{x(r)};o.useEffect(()=>{p.get(A)&&Q(p.get(A)),p.get("q")&&(z(p.get("q")),D(p.get("q")))},[p,g]),o.useEffect(()=>{R.current&&R.current.focus()},[]);const B=r=>{G(u,r),l(0)},H=r=>{r.keyCode===13&&(r.preventDefault(),V())},w=r=>d?r:ae[p.get(u)];return e.jsxs(pe,{children:[e.jsx("h1",{children:e.jsx("span",{className:"highlight-gold",children:"Search"})}),e.jsxs("div",{className:"options-area",children:[e.jsx("search",{className:"search-page-form-wrapper",children:e.jsx("form",{className:"uds-form",children:e.jsxs("div",{className:"form-group",children:[e.jsx("input",{type:"text",className:"form-control",id:"search-input",placeholder:"Search asu.edu",value:h,onChange:r=>D(r.target.value),onKeyDown:H,ref:R}),e.jsx(T,{color:"maroon",icon:["fas","search"],label:"Search",onClick:()=>V()})]})})}),e.jsxs("div",{className:"profile-options",children:[e.jsx("div",{className:"desktop-button",children:e.jsx(T,{color:"gray",icon:["fas","lock"],label:"Edit my profile",href:"/profile-edit"})}),e.jsx("div",{className:"mobile-button",children:e.jsx(T,{color:"gray",icon:["fas","lock"],label:"Edit my profile",href:"/profile-edit",size:"small"})}),t&&c&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"desktop-button",children:e.jsx(T,{color:"gray",icon:["fas","lock"],label:"Department admin",href:"/groups"})}),e.jsx("div",{className:"mobile-button",children:e.jsx(T,{color:"gray",icon:["fas","lock"],label:"Department admin",href:"/groups",size:"small"})})]})]})]}),e.jsxs(te,{initialTab:p.get(u),onTabChange:r=>B(r),children:[e.jsx(I,{id:S.all,title:"All ASU Search",children:w(e.jsx(q,{totalResults:b,setTotalResults:l,engines:N,site:y,goToTab:B,term:d,loggedIn:t}))}),y&&e.jsx(I,{id:S.sites,title:y,children:w(e.jsx(C,{loggedIn:t,engines:N,site:y,term:d}))}),e.jsx(I,{id:S.faculty,title:"Faculty and Staff",children:w(e.jsx(k,{engines:N,term:d,sort:g,onSortChange:r=>W(r)}))}),e.jsx(I,{id:S.students,icon:["fa","lock"],title:"Students",children:w(e.jsx(U,{loggedIn:t,engines:N,term:d}))})]})]})}F.propTypes={API_URL:s.string,searchApiVersion:s.string,loggedIn:s.bool,deptAdmin:s.bool,profileURLBase:s.string,appPathFolder:s.string};F.__docgenInfo={description:`React component for the ASU search page.
...
@returns {JSX.Element} The SearchPage component.`,methods:[],displayName:"SearchPage",props:{API_URL:{description:"",type:{name:"string"},required:!1},searchApiVersion:{description:"",type:{name:"string"},required:!1},loggedIn:{description:"",type:{name:"bool"},required:!1},deptAdmin:{description:"",type:{name:"bool"},required:!1},profileURLBase:{description:"",type:{name:"string"},required:!1},appPathFolder:{description:"",type:{name:"string"},required:!1}}};const de="https://asuapp2dev.prod.acquia-sites.com/",me="api/v1/",Te={title:"Organisms/Search Page/Templates",decorators:[a=>e.jsx(re,{children:a()})]},j=()=>e.jsx("div",{className:"uds-content-align",children:e.jsx(F,{API_URL:de,searchApiVersion:me,loggedIn:!1})});j.__docgenInfo={description:"",methods:[],displayName:"searchPageExample"};var X,$,M;j.parameters={...j.parameters,docs:{...(X=j.parameters)==null?void 0:X.docs,source:{originalSource:`() => <div className="uds-content-align">
    <SearchPage API_URL={API_URL} searchApiVersion={searchApiVersion} loggedIn={false}
  // appPathFolder="/my/custom/path/to/component/root/example"
  />
  </div>`,...(M=($=j.parameters)==null?void 0:$.docs)==null?void 0:M.source}}};const Se=["searchPageExample"];export{Se as __namedExportsOrder,Te as default,j as searchPageExample};
