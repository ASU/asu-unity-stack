import{r as o,j as e,u as ee}from"./iframe-DO2iVblM.js";import{A as x,e as n,S as te,l as S,s as se,T as _,a as L}from"./sort-CKqG5oMe.js";import{q as v,P as t,F as re}from"./styled-components.browser.esm-Bxt65xdD.js";import{s as ae}from"./index-BvJkVvLc.js";import{Q as ne}from"./index-BbUxaSgB.js";import"./preload-helper-Dp1pzeXC.js";import"./dataConverter-DQJRV1k1.js";const oe=v.div`
...
`;function U({API_URL:a,searchApiVersion:i,loggedIn:s,deptAdmin:c,profileURLBase:u,appPathFolder:O}){const g="search-tabs",m="q",A="url_host",[d,z]=o.useState(""),[h,b]=o.useState(""),[y,l]=o.useState(0),[f,D]=o.useState(""),[p,Y]=ee({[g]:j.all}),[K]=o.useState({}),[T,Q]=o.useState(null),R=o.useRef(null),w={filters:K,API_URL:a,searchApiVersion:i,profileURLBase:u||"https://search.asu.edu",appPathFolder:O},N={[n.FACULTY]:{...L[n.FACULTY],...w},[n.STUDENTS]:{...L[n.STUDENTS],...w},[n.SITES_LOCAL]:{...L[n.SITES_LOCAL],...w,site:T},[n.SITES]:{...L[n.SITES],...w}},G=(r,Z)=>{const E={};for(const J of p.entries())E[J[0]]=J[1];E[r]=Z,Y(E)},V=()=>{f.length>0&&(l(0),G(m,f))},W=r=>{b(r)};o.useEffect(()=>{p.get(A)&&Q(p.get(A)),p.get(m)&&(z(p.get(m)),D(p.get(m)))},[p,h]),o.useEffect(()=>{R.current&&R.current.focus()},[]);const B=r=>{G(g,r),l(0)},H=r=>{r.keyCode===13&&(r.preventDefault(),V())},I=r=>d?r:ae[p.get(g)];return e.jsxs(pe,{children:[e.jsx("h1",{children:e.jsx("span",{className:"highlight-gold",children:"Search"})}),e.jsxs("div",{className:"options-area",children:[e.jsx("form",{className:"uds-form",children:e.jsxs("div",{className:"form-group",children:[e.jsx("input",{type:"text",className:"form-control",id:"search-input",placeholder:"Search asu.edu",value:f,onChange:r=>D(r.target.value),onKeyDown:H,ref:R}),e.jsx(S,{color:"maroon",icon:["fas","search"],label:"Search",onClick:()=>V()})]})}),e.jsxs("div",{className:"profile-options",children:[e.jsx("div",{className:"desktop-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Edit my profile",href:"/profile-edit"})}),e.jsx("div",{className:"mobile-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Edit my profile",href:"/profile-edit",size:"small"})}),s&&c&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"desktop-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Department admin",href:"/groups"})}),e.jsx("div",{className:"mobile-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Department admin",href:"/groups",size:"small"})})]})]})]}),e.jsxs(se,{initialTab:p.get(g),onTabChange:r=>B(r),children:[e.jsx(_,{id:j.all,title:"All ASU Search",children:I(e.jsx(q,{totalResults:y,setTotalResults:l,engines:N,site:T,goToTab:B,term:d,loggedIn:s}))}),T&&e.jsx(_,{id:j.sites,title:T,children:I(e.jsx(C,{loggedIn:s,engines:N,site:T,term:d}))}),e.jsx(_,{id:j.faculty,title:"Faculty and Staff",children:I(e.jsx(k,{engines:N,term:d,sort:h,onSortChange:r=>W(r)}))}),e.jsx(_,{id:j.students,icon:["fa","lock"],title:"Students",children:I(e.jsx(F,{loggedIn:s,engines:N,term:d}))})]})]})}U.propTypes={API_URL:t.string,searchApiVersion:t.string,loggedIn:t.bool,deptAdmin:t.bool,profileURLBase:t.string,appPathFolder:t.string};U.__docgenInfo={description:`React component for the ASU search page.
