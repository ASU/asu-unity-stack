import{j as e}from"./jsx-runtime-DvmJwJjP.js";import{r as o}from"./index-DUDtsY9M.js";import{A as b,e as a,S as ee,c as S,X as te,k as v,a as N}from"./sort-By_2pOOL.js";import{q as I,P as t,F as se}from"./styled-components.browser.esm-DeuVMhah.js";import{a as re}from"./index-DTk3tJoj.js";import{s as ne}from"./index-CUNdtNXJ.js";import{Q as ae}from"./index-DL9qck9d.js";import"./_commonjsHelpers-B3tUAs5q.js";import"./index-BqhcUH1-.js";import"./dataConverter-D3kguinv.js";const oe=I.div`
...
@returns {JSX.Element} The LocalTab component.`,methods:[],displayName:"LocalTab",props:{term:{description:"",type:{name:"string"},required:!1},engines:{description:"",type:{name:"object"},required:!1},site:{description:"",type:{name:"string"},required:!1},loggedIn:{description:"",type:{name:"bool"},required:!1}}};const k=({engines:n,term:i,loggedIn:s})=>e.jsx(ce,{children:e.jsx(b,{term:i,engine:n[a.STUDENTS],itemsPerPage:6,type:"full",GASource:"all student results",titleText:"All Student results",loggedIn:s,showSearchMessage:!0,restClientTag:"asuis"})});k.propTypes={term:t.string,engines:t.object,loggedIn:t.bool};k.__docgenInfo={description:`React component for displaying search results on the Students tab.
