import{j as e}from"./jsx-runtime-DvmJwJjP.js";import{r as o}from"./index-DUDtsY9M.js";import{A as b,e as a,S as ee,w as S,t as te,v as _,a as N}from"./sort-D60uOoNj.js";import{q as I,P as t,F as se}from"./styled-components.browser.esm-B6_ApnWR.js";import{a as re}from"./index-Dm54Kt9Z.js";import{s as ne}from"./index-Tyx4BYch.js";import{Q as ae}from"./index-DDNuMqt8.js";import"./_commonjsHelpers-B3tUAs5q.js";import"./index-B-eQrFJv.js";import"./dataConverter-Dgy66W89.js";const oe=I.div`
...
`;function O({API_URL:n,searchApiVersion:i,loggedIn:s,deptAdmin:c,profileURLBase:u,appPathFolder:U}){const g="search-tabs",m="q",w="url_host",[d,J]=o.useState(""),[h,x]=o.useState(""),[y,l]=o.useState(0),[f,X]=o.useState(""),[p,Y]=re({[g]:j.all}),[K]=o.useState({}),[T,Q]=o.useState(null),k=o.useRef(null),A={filters:K,API_URL:n,searchApiVersion:i,profileURLBase:u||"https://search.asu.edu",appPathFolder:U},v={[a.FACULTY]:{...N[a.FACULTY],...A},[a.STUDENTS]:{...N[a.STUDENTS],...A},[a.SITES_LOCAL]:{...N[a.SITES_LOCAL],...A,site:T},[a.SITES]:{...N[a.SITES],...A}},z=(r,Z)=>{const C={};for(const V of p.entries())C[V[0]]=V[1];C[r]=Z,Y(C)},D=()=>{f.length>0&&(l(0),z(m,f))},W=r=>{x(r)};o.useEffect(()=>{p.get(w)&&Q(p.get(w)),p.get(m)&&(J(p.get(m)),X(p.get(m)))},[p,h]),o.useEffect(()=>{k.current&&k.current.focus()},[]);const G=r=>{z(g,r),l(0)},H=r=>{r.keyCode===13&&(r.preventDefault(),D())},q=r=>d?r:ne[p.get(g)];return e.jsxs(pe,{children:[e.jsx("h1",{children:e.jsx("span",{className:"highlight-gold",children:"Search"})}),e.jsxs("div",{className:"options-area",children:[e.jsx("form",{className:"uds-form",children:e.jsxs("div",{className:"form-group",children:[e.jsx("input",{type:"text",className:"form-control",id:"search-input",placeholder:"Search asu.edu",value:f,onChange:r=>X(r.target.value),onKeyDown:H,ref:k}),e.jsx(S,{color:"maroon",icon:["fas","search"],label:"Search",onClick:()=>D()})]})}),e.jsxs("div",{className:"profile-options",children:[e.jsx("div",{className:"desktop-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Edit my profile",href:"/profile-edit"})}),e.jsx("div",{className:"mobile-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Edit my profile",href:"/profile-edit",size:"small"})}),s&&c&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"desktop-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Department admin",href:"/groups"})}),e.jsx("div",{className:"mobile-button",children:e.jsx(S,{color:"gray",icon:["fas","lock"],label:"Department admin",href:"/groups",size:"small"})})]})]})]}),e.jsxs(te,{initialTab:p.get(g),onTabChange:r=>G(r),children:[e.jsx(_,{id:j.all,title:"All ASU Search",children:q(e.jsx(R,{totalResults:y,setTotalResults:l,engines:v,site:T,goToTab:G,term:d,loggedIn:s}))}),T&&e.jsx(_,{id:j.sites,title:T,children:q(e.jsx(E,{loggedIn:s,engines:v,site:T,term:d}))}),e.jsx(_,{id:j.faculty,title:"Faculty and Staff",children:q(e.jsx(L,{engines:v,term:d,sort:h,onSortChange:r=>W(r)}))}),e.jsx(_,{id:j.students,icon:["fa","lock"],title:"Students",children:q(e.jsx(F,{loggedIn:s,engines:v,term:d}))})]})]})}O.propTypes={API_URL:t.string,searchApiVersion:t.string,loggedIn:t.bool,deptAdmin:t.bool,profileURLBase:t.string,appPathFolder:t.string};O.__docgenInfo={description:`React component for the ASU search page.
