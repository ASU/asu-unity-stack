import{r as l,j as e}from"./iframe-CGe7Wy5A.js";import{P as r,g as q}from"./styled-components.browser.esm-0ZuCFfxC.js";import{b as L,e as c,U as V,c as $,A as U,k as K,S as M}from"./sort-D7ck2HSR.js";function z({packageName:n="",component:u="",type:f="",configuration:b={}}){if(!n||!u){console.error("trackReactComponent: Missing required arguments.");return}window.uds=window.uds||{},window.uds.package=window.uds.package||{},window.uds.package[n]={component:u,type:f,configuration:b}}const F={1:"Faculty",2:"Academic Professionals",3:"Other Faculty and Academic Professionals"},O=({filters:n,API_URL:u,searchApiVersion:f,appPathFolder:b,deptIds:h,display:y,profileURLBase:g,searchType:t,grid:w})=>{const[T,a]=l.useState({}),[j,P]=l.useState(null),[R,m]=l.useState(!0),[_,S]=l.useState({}),C=6,s="faculty_rank",i=new URL(`${u}${f}${L[c.WEB_DIRECTORY_FACULTY_RANK].url}`);i.searchParams.append("sort_by",t),i.searchParams.append("dept_ids",h),i.searchParams.append("page","1"),i.searchParams.append("size","1");const x=async p=>{var A;const o=`${i}&rank_group=${p}`,D=await(await fetch(o)).json();return{rankGroup:p,length:(A=D.results)==null?void 0:A.length}};l.useEffect(()=>{const p={...n};p.deptIds=h.split(","),a(p);const o=Object.keys(F).map(x);Promise.all(o).then(d=>{const D=d.reduce((A,{rankGroup:W,length:Y})=>(Y>0&&(A[W]=F[W]),A),{});S(D),m(!1)})},[h,j]);const E={filters:n,API_URL:u,searchApiVersion:f,profileURLBase:g||"https://search.asu.edu",appPathFolder:b},v={[c.WEB_DIRECTORY_FACULTY_RANK]:{...L[c.WEB_DIRECTORY_FACULTY_RANK],...E}},I={faculty_rank:c.WEB_DIRECTORY_FACULTY_RANK};return R?e.jsx("div",{children:"Loading..."}):Object.keys(_).length?e.jsx(V,{onTabChange:P,children:Object.keys(_).map(p=>e.jsx($,{id:`faculty-${p}`,title:F[p],children:e.jsx(U,{engine:v[I[t]],itemsPerPage:parseInt(y.profilesPerPage,10)||C,size:"large",sort:s,hidePaginator:y.usePager!=="1",filters:T,profilesToFilterOut:y.doNotDisplayProfiles,display:y,rankGroup:p.toString(),restClientTag:"asuis",grid:w})},p))}):e.jsxs("div",{children:["No faculty rank data found for department ",h]})};O.propTypes={deptIds:r.string,API_URL:r.string,searchApiVersion:r.string,searchType:r.string,profileURLBase:r.string,appPathFolder:r.string,display:r.shape({defaultSort:r.string,doNotDisplayProfiles:r.string,profilesPerPage:r.string,usePager:r.string}),filters:r.shape({employee:r.string,expertise:r.string,title:r.string,campuses:r.string}),grid:r.bool};O.__docgenInfo={description:`Prop types for FacultyRankTabPanels component.
@type {Object}
...
`,k=({filterLabel:n,choices:u=[],onChoose:f=()=>{},resetFilters:b=()=>{}})=>{const[h,y]=l.useState(null),[g,t]=l.useState(-1),[w,T]=l.useState(0),a=l.useRef(null),[j,P]=l.useState(0),[R,m]=l.useState(0);l.useEffect(()=>{const s=()=>{P(a.current.scrollLeft)};return a.current&&(a.current.addEventListener("scroll",s),s()),()=>{var i;return(i=a.current)==null?void 0:i.removeEventListener("scroll",s)}},[R]),l.useEffect(()=>{const s=()=>{a.current&&m(a.current.scrollWidth-a.current.offsetWidth)};return a.current&&(a.current.addEventListener("resize",s),s()),()=>{var i;return(i=a.current)==null?void 0:i.removeEventListener("resize",s)}},[]),l.useEffect(()=>{if(a.current){const s=a.current.children.length;T(s)}},[]);const _=s=>{var i;if(a.current){if(s.key==="ArrowRight"&&g+1<w){const x=(i=a.current)==null?void 0:i.children[g+1];t(g+1),x.focus()}else if(s.key==="ArrowLeft"&&g-1>=0){const x=a.current.children[g-1];t(g-1),x.focus()}}},S=s=>{y(s),f(s)},C=s=>{const i=a.current,x=i.scrollWidth-i.clientWidth;let v=i.scrollLeft+200*s;v=Math.max(0,Math.min(x,v)),i.scrollTo({left:v,behavior:"smooth"})};return e.jsxs(H,{className:"filter-container",children:[e.jsx("legend",{children:n}),e.jsxs("div",{className:"choices-wrapper",children:[e.jsx(K,{hidePrev:j<=0,hideNext:j>=R-5,slideNav:C}),e.jsxs("div",{role:"radiogroup",tabIndex:0,onKeyDown:_,className:"choices-container",ref:a,"aria-label":`${n} filter options}`,children:[b&&e.jsx("button",{role:"radio",type:"button",onClick:s=>{s.preventDefault(),S(null),b()},tabIndex:-1,"aria-label":"All","aria-checked":h===null,className:"choice",children:"All"}),u.map(s=>e.jsx("button",{role:"radio",type:"button",onClick:i=>{i.preventDefault(),S(s)},"aria-checked":h===s,className:`${h===s?"selected":""} choice`,"aria-label":`Filter by ${s}`,tabIndex:-1,children:s},s))]})]})]})};k.propTypes={filterLabel:r.string.isRequired,choices:r.arrayOf(r.string).isRequired,onChoose:r.func.isRequired,resetFilters:r.func};k.__docgenInfo={description:`Prop types for FilterComponent component.
@type {Object}
...
@property {function} [resetFilters=() => {}] - A callback function triggered to reset the filters.`,methods:[],displayName:"FilterComponent",props:{choices:{defaultValue:{value:"[]",computed:!1},description:"",type:{name:"arrayOf",value:{name:"string"}},required:!1},onChoose:{defaultValue:{value:"() => {}",computed:!1},description:"",type:{name:"func"},required:!1},resetFilters:{defaultValue:{value:"() => {}",computed:!1},description:"",type:{name:"func"},required:!1},filterLabel:{description:"",type:{name:"string"},required:!0}}};const J=q.div`
  display: flex;
  align-items: center;
...
`;function B({searchType:n,ids:u,deptIds:f,API_URL:b,searchApiVersion:h,profileURLBase:y,appPathFolder:g,display:t,filters:w,alphaFilter:T="false"}){const[a,j]=l.useState(s),[P,R]=l.useState(C),[m,_]=l.useState((t==null?void 0:t.grid)==="true"||(t==null?void 0:t.grid)===!0),S=6;l.useEffect(()=>{typeof window<"u"&&z({packageName:"app-webdir-ui",component:"WebDirectory",type:n,configuration:{...w,...t}})},[]);function C(){const o=w?{...w}:{};return n==="departments"||n==="faculty_rank"?(o.deptIds=f.split(","),o):(o.peopleInDepts=u.split(",").filter(d=>d.includes(":")).map(d=>d.split(":")).map(d=>({asurite_id:d[0],dept_id:d[1]})),o)}function s(){const o={last_name:"last_name_asc",people_order:"people_order"};return Object.prototype.hasOwnProperty.call(o,t==null?void 0:t.defaultSort)?o[t==null?void 0:t.defaultSort]:"last_name_asc"}function i(o,d){var D;return o==="departments"&&((D=d==null?void 0:d.split(","))==null?void 0:D.length)<2?[{value:"default",label:"Choose Sort",disabled:!0},{value:"last_name_asc",label:"Last Name (ascending)"},{value:"last_name_desc",label:"Last Name (descending)"}]:[{value:"default",label:"Choose Sort",disabled:!0},{value:"last_name_asc",label:"Last Name (ascending)"},{value:"last_name_desc",label:"Last Name (descending)"}]}const x=i(n,f),E={filters:w,API_URL:b,searchApiVersion:h,profileURLBase:y||"https://search.asu.edu",appPathFolder:g},v={[c.WEB_DIRECTORY_DEPARTMENTS]:{...L[c.WEB_DIRECTORY_DEPARTMENTS],...E},[c.WEB_DIRECTORY_PEOPLE_AND_DEPS]:{...L[c.WEB_DIRECTORY_PEOPLE_AND_DEPS],...E},[c.WEB_DIRECTORY_PEOPLE_AND_DEPS]:{...L[c.WEB_DIRECTORY_PEOPLE_AND_DEPS],...E},[c.WEB_DIRECTORY_FACULTY_RANK]:{...L[c.WEB_DIRECTORY_FACULTY_RANK],...E,deptIds:f,display:t,searchType:n}},I=o=>{j(o)},p={departments:c.WEB_DIRECTORY_DEPARTMENTS,people:c.WEB_DIRECTORY_PEOPLE_AND_DEPS,people_departments:c.WEB_DIRECTORY_PEOPLE_AND_DEPS,faculty_rank:c.WEB_DIRECTORY_FACULTY_RANK};return n!=="faculty_rank"?e.jsx(e.Fragment,{children:e.jsxs(X,{className:m?"grid-view":"",children:[e.jsx(N,{view:m,setView:_,label:"View"}),e.jsx("div",{className:"sort",children:e.jsx(M,{customSortOptions:x,sort:a,onChange:o=>I(o)})}),T==="true"&&e.jsx(k,{filterLabel:"Filter By Last Initial",choices:G,onChoose:o=>R({...P,lastInit:o}),resetFilters:()=>R({...P,lastInit:""})}),e.jsx("div",{className:"results",children:e.jsx(U,{engine:v[p[n]],itemsPerPage:parseInt(t==null?void 0:t.profilesPerPage,10)||S,sort:a,hidePaginator:(t==null?void 0:t.usePager)!=="1",filters:P,profilesToFilterOut:t==null?void 0:t.doNotDisplayProfiles,display:t,appPathFolder:g,restClientTag:"webdir",grid:m})})]})}):e.jsxs(Q,{className:m?"grid-view":"",children:[e.jsx(N,{view:m,setView:_,label:"View"}),e.jsx(O,{...v[p[n]],alphaFilter:T,filters:P,grid:m,setGridView:_,className:"tabbed-panels"})]})}B.propTypes={deptIds:r.string,API_URL:r.string,searchApiVersion:r.string,searchType:r.string,ids:r.string,profileURLBase:r.string,appPathFolder:r.string,display:r.shape({defaultSort:r.string,doNotDisplayProfiles:r.string,profilesPerPage:r.string,usePager:r.string,grid:r.string||r.bool}),filters:r.shape({employee:r.string,expertise:r.string,title:r.string,campuses:r.string}),alphaFilter:r.string};B.__docgenInfo={description:`React component for displaying web directory search results.
