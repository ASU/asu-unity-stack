import{j as e}from"./jsx-runtime-DvmJwJjP.js";import{r as o}from"./index-DUDtsY9M.js";import{A as b,e as a,S as ee,l as S,Y as te,y as v,a as N}from"./sort-Dz2RgMB7.js";import{q as I,P as t,F as se}from"./styled-components.browser.esm-BecGWgJO.js";import{a as re}from"./index-DBFMfKjU.js";import{s as ne}from"./index-BgDbvMny.js";import{Q as ae}from"./index-D1nafy8d.js";import"./_commonjsHelpers-B3tUAs5q.js";import"./index-BGABTqJC.js";import"./dataConverter-I0fDhMl5.js";const oe=I.div`
...
@returns {JSX.Element} The SearchPage component.`,methods:[],displayName:"SearchPage",props:{API_URL:{description:"",type:{name:"string"},required:!1},searchApiVersion:{description:"",type:{name:"string"},required:!1},loggedIn:{description:"",type:{name:"bool"},required:!1},deptAdmin:{description:"",type:{name:"bool"},required:!1},profileURLBase:{description:"",type:{name:"string"},required:!1},appPathFolder:{description:"",type:{name:"string"},required:!1}}};const Se={title:"Organisms/Search Page/Templates",decorators:[n=>e.jsx(se,{children:n()})]},P=()=>e.jsx("div",{className:"uds-content-align",children:e.jsx(O,{API_URL:"https://test-asu-isearch.ws.asu.edu",searchApiVersion:"/api/v1/",loggedIn:!1})});P.__docgenInfo={description:"",methods:[],displayName:"searchPageExample"};var B,Y,$;P.parameters={...P.parameters,docs:{...(B=P.parameters)==null?void 0:B.docs,source:{originalSource:`() => <div className="uds-content-align">
  ...
  />
  </div>`,...($=(Y=P.parameters)==null?void 0:Y.docs)==null?void 0:$.source}}};const je=["searchPageExample"];export{je as __namedExportsOrder,Se as default,P as searchPageExample};
