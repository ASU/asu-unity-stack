import{r as o,a as e,u as ee}from"./iframe-BNKedrEi.js";import{A as f,a as n,S as se,$ as T,e as te,G as I,b as _}from"./sort-DLSTO_aW.js";import{g as P,P as s,F as re}from"./styled-components.browser.esm-xIubysIi.js";import{s as ae}from"./index-BCcZQVf3.js";import{Q as ne}from"./index-szeKGDEa.js";import"./preload-helper-Dp1pzeXC.js";import"./dataConverter-O0cz1C4n.js";const oe=P.div`
...
`;function U({API_URL:a,searchApiVersion:i,loggedIn:t,deptAdmin:c,profileURLBase:m,appPathFolder:O}){const u="search-tabs",v="url_host",[d,G]=o.useState(""),[g,x]=o.useState(""),[b,l]=o.useState(0),[h,z]=o.useState(""),[p,Y]=ee({[u]:S.all}),[K]=o.useState({}),[y,Q]=o.useState(null),R=o.useRef(null),A={filters:K,API_URL:a,searchApiVersion:i,profileURLBase:m||"https://search.asu.edu",appPathFolder:O},N={[n.FACULTY]:{..._[n.FACULTY],...A},[n.STUDENTS]:{..._[n.STUDENTS],...A},[n.SITES_LOCAL]:{..._[n.SITES_LOCAL],...A,site:y},[n.SITES]:{..._[n.SITES],...A}},D=(r,Z)=>{const q={};for(const B of p.entries())q[B[0]]=B[1];q[r]=Z,Y(q)},V=()=>{h.length>0&&(l(0),D("q",h))},W=r=>{x(r)};o.useEffect(()=>{p.get(v)&&Q(p.get(v)),p.get("q")&&(G(p.get("q")),z(p.get("q")))},[p,g]),o.useEffect(()=>{R.current&&R.current.focus()},[]);const $=r=>{D(u,r),l(0)},H=r=>{r.keyCode===13&&(r.preventDefault(),V())},w=r=>d?r:ae[p.get(u)];return e.jsxs(pe,{children:[e.jsx("h1",{children:e.jsx("span",{className:"highlight-gold",children:"Search"})}),e.jsxs("div",{className:"options-area",children:[e.jsx("search",{className:"search-page-wrapper",children:e.jsx("form",{className:"uds-form",children:e.jsxs("div",{className:"form-group",children:[e.jsx("input",{type:"text",className:"form-control",id:"search-input",placeholder:"Search asu.edu",value:h,onChange:r=>z(r.target.value),onKeyDown:H,ref:R}),e.jsx(T,{color:"maroon",icon:["fas","search"],label:"Search",onClick:()=>V()})]})})}),e.jsxs("div",{className:"profile-options",children:[e.jsx("div",{className:"desktop-button",children:e.jsx(T,{color:"gray",icon:["fas","lock"],label:"Edit my profile",href:"/profile-edit"})}),e.jsx("div",{className:"mobile-button",children:e.jsx(T,{color:"gray",icon:["fas","lock"],label:"Edit my profile",href:"/profile-edit",size:"small"})}),t&&c&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"desktop-button",children:e.jsx(T,{color:"gray",icon:["fas","lock"],label:"Department admin",href:"/groups"})}),e.jsx("div",{className:"mobile-button",children:e.jsx(T,{color:"gray",icon:["fas","lock"],label:"Department admin",href:"/groups",size:"small"})})]})]})]}),e.jsxs(te,{initialTab:p.get(u),onTabChange:r=>$(r),children:[e.jsx(I,{id:S.all,title:"All ASU Search",children:w(e.jsx(E,{totalResults:b,setTotalResults:l,engines:N,site:y,goToTab:$,term:d,loggedIn:t}))}),y&&e.jsx(I,{id:S.sites,title:y,children:w(e.jsx(C,{loggedIn:t,engines:N,site:y,term:d}))}),e.jsx(I,{id:S.faculty,title:"Faculty and Staff",children:w(e.jsx(k,{engines:N,term:d,sort:g,onSortChange:r=>W(r)}))}),e.jsx(I,{id:S.students,icon:["fa","lock"],title:"Students",children:w(e.jsx(F,{loggedIn:t,engines:N,term:d}))})]})]})}U.propTypes={API_URL:s.string,searchApiVersion:s.string,loggedIn:s.bool,deptAdmin:s.bool,profileURLBase:s.string,appPathFolder:s.string};U.__docgenInfo={description:`React component for the ASU search page.
...
@returns {JSX.Element} The SearchPage component.`,methods:[],displayName:"SearchPage",props:{API_URL:{description:"",type:{name:"string"},required:!1},searchApiVersion:{description:"",type:{name:"string"},required:!1},loggedIn:{description:"",type:{name:"bool"},required:!1},deptAdmin:{description:"",type:{name:"bool"},required:!1},profileURLBase:{description:"",type:{name:"string"},required:!1},appPathFolder:{description:"",type:{name:"string"},required:!1}}};const be={title:"Organisms/Search Page/Templates",decorators:[a=>e.jsx(re,{children:a()})]},j=()=>e.jsx("div",{className:"uds-content-align",children:e.jsx(U,{API_URL:"https://asuapp2dev.prod.acquia-sites.com",searchApiVersion:"/api/v1/",loggedIn:!1})});j.__docgenInfo={description:"",methods:[],displayName:"searchPageExample"};var J,X,M;j.parameters={...j.parameters,docs:{...(J=j.parameters)==null?void 0:J.docs,source:{originalSource:`() => <div className="uds-content-align">
  ...
  />
  </div>`,...(M=(X=j.parameters)==null?void 0:X.docs)==null?void 0:M.source}}};const ye=["searchPageExample"];export{ye as __namedExportsOrder,be as default,j as searchPageExample};
