import{r as o,j as e,u as ee}from"./iframe-nXyLyRHV.js";import{A as f,e as n,S as se,y as T,P as te,b as I,a as _}from"./sort-Bq5Cm1j9.js";import{g as P,P as s,F as re}from"./styled-components.browser.esm-BIwExt8q.js";import{s as ae}from"./index-CWreucFA.js";import{Q as ne}from"./index-lHdoNuA0.js";import"./preload-helper-Dp1pzeXC.js";import"./dataConverter-CZCTEgLO.js";const oe=P.div`
...
`;function U({API_URL:a,searchApiVersion:i,loggedIn:t,deptAdmin:c,profileURLBase:m,appPathFolder:O}){const u="search-tabs",v="url_host",[d,z]=o.useState(""),[g,x]=o.useState(""),[b,l]=o.useState(0),[h,D]=o.useState(""),[p,Y]=ee({[u]:S.all}),[K]=o.useState({}),[y,Q]=o.useState(null),R=o.useRef(null),A={filters:K,API_URL:a,searchApiVersion:i,profileURLBase:m||"https://search.asu.edu",appPathFolder:O},N={[n.FACULTY]:{..._[n.FACULTY],...A},[n.STUDENTS]:{..._[n.STUDENTS],...A},[n.SITES_LOCAL]:{..._[n.SITES_LOCAL],...A,site:y},[n.SITES]:{..._[n.SITES],...A}},G=(r,Z)=>{const E={};for(const J of p.entries())E[J[0]]=J[1];E[r]=Z,Y(E)},V=()=>{h.length>0&&(l(0),G("q",h))},W=r=>{x(r)};o.useEffect(()=>{p.get(v)&&Q(p.get(v)),p.get("q")&&(z(p.get("q")),D(p.get("q")))},[p,g]),o.useEffect(()=>{R.current&&R.current.focus()},[]);const B=r=>{G(u,r),l(0)},H=r=>{r.keyCode===13&&(r.preventDefault(),V())},w=r=>d?r:ae[p.get(u)];return e.jsxs(pe,{children:[e.jsx("h1",{children:e.jsx("span",{className:"highlight-gold",children:"Search"})}),e.jsxs("div",{className:"options-area",children:[e.jsx("search",{className:"search-page-form-wrapper",children:e.jsx("form",{className:"uds-form",children:e.jsxs("div",{className:"form-group",children:[e.jsx("input",{type:"text",className:"form-control",id:"search-input",placeholder:"Search asu.edu",value:h,onChange:r=>D(r.target.value),onKeyDown:H,ref:R}),e.jsx(T,{color:"maroon",icon:["fas","search"],label:"Search",onClick:()=>V()})]})})}),e.jsxs("div",{className:"profile-options",children:[e.jsx("div",{className:"desktop-button",children:e.jsx(T,{color:"gray",icon:["fas","lock"],label:"Edit my profile",href:"/profile-edit"})}),e.jsx("div",{className:"mobile-button",children:e.jsx(T,{color:"gray",icon:["fas","lock"],label:"Edit my profile",href:"/profile-edit",size:"small"})}),t&&c&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"desktop-button",children:e.jsx(T,{color:"gray",icon:["fas","lock"],label:"Department admin",href:"/groups"})}),e.jsx("div",{className:"mobile-button",children:e.jsx(T,{color:"gray",icon:["fas","lock"],label:"Department admin",href:"/groups",size:"small"})})]})]})]}),e.jsxs(te,{initialTab:p.get(u),onTabChange:r=>B(r),children:[e.jsx(I,{id:S.all,title:"All ASU Search",children:w(e.jsx(q,{totalResults:b,setTotalResults:l,engines:N,site:y,goToTab:B,term:d,loggedIn:t}))}),y&&e.jsx(I,{id:S.sites,title:y,children:w(e.jsx(C,{loggedIn:t,engines:N,site:y,term:d}))}),e.jsx(I,{id:S.faculty,title:"Faculty and Staff",children:w(e.jsx(k,{engines:N,term:d,sort:g,onSortChange:r=>W(r)}))}),e.jsx(I,{id:S.students,icon:["fa","lock"],title:"Students",children:w(e.jsx(F,{loggedIn:t,engines:N,term:d}))})]})]})}U.propTypes={API_URL:s.string,searchApiVersion:s.string,loggedIn:s.bool,deptAdmin:s.bool,profileURLBase:s.string,appPathFolder:s.string};U.__docgenInfo={description:`React component for the ASU search page.
