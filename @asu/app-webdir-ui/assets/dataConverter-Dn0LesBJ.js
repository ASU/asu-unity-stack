import{j as a,u as b}from"./iframe-DsjrjHeq.js";import{g as k,P as i,t as w}from"./styled-components.browser.esm-b0qNIlxZ.js";const y=""+new URL("anon-CXWQnlvV.png",import.meta.url).href,_=k.div`
  padding: 4px;
  .person-name {
    display: block;
    font-weight: bold;
...
@returns {JSX.Element} The converted student data.`,methods:[],displayName:"studentsConverter",props:{options:{defaultValue:{value:`{
  size: "small",
  fill: false,
}`,computed:!1},required:!1}}};U.__docgenInfo={description:`Converts subdomain data to a ResultCard component.
...
@returns {JSX.Element} The ResultCard component.`,methods:[],displayName:"subdomainConverter",props:{options:{defaultValue:{value:`{
  size: "small",
  fill: false,
}`,computed:!1},required:!1},logClick:{defaultValue:{value:"() => {}",computed:!1},required:!1},localSection:{defaultValue:{value:"null",computed:!1},required:!1}}};export{q as a,U as b,A as s};
