import{r as l,j as e}from"./iframe-nXyLyRHV.js";import{P as r,g as q}from"./styled-components.browser.esm-BIwExt8q.js";import{a as L,e as c,P as V,b as $,A as B,Z as K,S as M}from"./sort-Bq5Cm1j9.js";function z({packageName:n="",component:u="",type:f="",configuration:b={}}){if(!n||!u){console.error("trackReactComponent: Missing required arguments.");return}window.uds=window.uds||{},window.uds.package=window.uds.package||{},window.uds.package[n]={component:u,type:f,configuration:b}}const F={1:"Faculty",2:"Academic Professionals",3:"Other Faculty and Academic Professionals"},O=({filters:n,API_URL:u,searchApiVersion:f,appPathFolder:b,deptIds:h,display:y,profileURLBase:g,searchType:t,grid:w})=>{const[T,a]=l.useState({}),[j,P]=l.useState(null),[R,m]=l.useState(!0),[_,S]=l.useState({}),C=6,s="faculty_rank",i=new URL(`${u}${f}${L[c.WEB_DIRECTORY_FACULTY_RANK].url}`);i.searchParams.append("sort_by",t),i.searchParams.append("dept_ids",h),i.searchParams.append("page","1"),i.searchParams.append("size","1");const x=async p=>{var N;const o=`${i}&rank_group=${p}`,D=await(await fetch(o)).json();return{rankGroup:p,length:(N=D.results)==null?void 0:N.length}};l.useEffect(()=>{const p={...n};p.deptIds=h.split(","),a(p);const o=Object.keys(F).map(x);Promise.all(o).then(d=>{const D=d.reduce((N,{rankGroup:W,length:Y})=>(Y>0&&(N[W]=F[W]),N),{});S(D),m(!1)})},[h,j]);const E={filters:n,API_URL:u,searchApiVersion:f,profileURLBase:g||"https://search.asu.edu",appPathFolder:b},v={[c.WEB_DIRECTORY_FACULTY_RANK]:{...L[c.WEB_DIRECTORY_FACULTY_RANK],...E}},I={faculty_rank:c.WEB_DIRECTORY_FACULTY_RANK};return R?e.jsx("div",{children:"Loading..."}):Object.keys(_).length?e.jsx(V,{onTabChange:P,children:Object.keys(_).map(p=>e.jsx($,{id:`faculty-${p}`,title:F[p],children:e.jsx(B,{engine:v[I[t]],itemsPerPage:parseInt(y.profilesPerPage,10)||C,size:"large",sort:s,hidePaginator:y.usePager!=="1",filters:T,profilesToFilterOut:y.doNotDisplayProfiles,display:y,rankGroup:p.toString(),restClientTag:"asuis",grid:w})},p))}):e.jsxs("div",{children:["No faculty rank data found for department ",h]})};O.propTypes={deptIds:r.string,API_URL:r.string,searchApiVersion:r.string,searchType:r.string,profileURLBase:r.string,appPathFolder:r.string,display:r.shape({defaultSort:r.string,doNotDisplayProfiles:r.string,profilesPerPage:r.string,usePager:r.string}),filters:r.shape({employee:r.string,expertise:r.string,title:r.string,campuses:r.string}),grid:r.bool};O.__docgenInfo={description:`Prop types for FacultyRankTabPanels component.
@type {Object}
...
@property {function} [resetFilters=() => {}] - A callback function triggered to reset the filters.`,methods:[],displayName:"FilterComponent",props:{choices:{defaultValue:{value:"[]",computed:!1},description:"",type:{name:"arrayOf",value:{name:"string"}},required:!1},onChoose:{defaultValue:{value:"() => {}",computed:!1},description:"",type:{name:"func"},required:!1},resetFilters:{defaultValue:{value:"() => {}",computed:!1},description:"",type:{name:"func"},required:!1},filterLabel:{description:"",type:{name:"string"},required:!0}}};const Z=q.div`
  display: flex;
  align-items: center;
