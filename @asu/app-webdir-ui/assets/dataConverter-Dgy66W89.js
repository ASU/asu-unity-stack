import{j as a}from"./jsx-runtime-DvmJwJjP.js";import"./index-DUDtsY9M.js";import{q as k,P as i,t as w}from"./styled-components.browser.esm-B6_ApnWR.js";import{a as L}from"./index-Dm54Kt9Z.js";const y=""+new URL("anon-CXWQnlvV.png",import.meta.url).href,_=k.div`
  padding: 4px;
  .person-name {
    display: block;
    font-weight: bold;
...
@returns {JSX.Element} The converted staff data.`,methods:[],displayName:"staffConverter",props:{options:{defaultValue:{value:`{
  ...
  fill: false,
  grid: false,
}`,computed:!1},required:!1}}};R.__docgenInfo={description:`Converts student data into ProfileCard components.
@param {SharedProps} props
...
@returns {JSX.Element} The ResultCard component.`,methods:[],displayName:"subdomainConverter",props:{options:{defaultValue:{value:`{
  size: "small",
  fill: false,
}`,computed:!1},required:!1},logClick:{defaultValue:{value:"() => {}",computed:!1},required:!1},localSection:{defaultValue:{value:"null",computed:!1},required:!1}}};export{v as a,R as b,q as s};
