import{p as ia,m as V,U as me,X as la,j as e,q,Y as ca,$ as da,a0 as pa,r as Vt,t as fe,P as d,a1 as Wt,i as xe,a2 as ye,d as X,a3 as be,a4 as Y,O as ma,Z as ua,h as ke,b as ga,a5 as ha,a6 as fa,c as xa,v as ya,o as Z,a7 as ue,_ as ba,a8 as Kt,W as ja,a9 as va,aa as de,ab as Sa,ac as wa,s as zt,ad as Pa,ae as Ca,af as Ht,ag as ge,ah as Jt,A as La,u as Fa,n as qa,x as Na,T as Ia,E as Aa,B as Ta,V as Xt,ai as Ua,G as Da,L as ka,aj as Ba,ak as Oa,al as Ra,M as Ma,am as _a,J as $a,R as he}from"./index-B8xjI1uW.js";import{r as x,R as Be}from"./index-B2SEcK1p.js";import"./index-CFuLqMBi.js";import"./_commonjsHelpers-B3tUAs5q.js";function Ea(t,r){const a=Math.floor(t/r),o=t%r;return a+(o>0?1:0)}function Ga(t){return""}function Va(t){return""}function Wa(){return""}function Q(t,r){let a=r||"";return a=a.replaceAll("{INSTITUTION_CODE}",t.getInstitution()).replaceAll("{ACAD_PLAN_CODE}",t.getAcadPlan()),a}function Yt(t,r){return`${Q(t,r)}#${ia.flexibleDegreeOptions.acceleratedId}`}function Oe({programs:t=[],filters:{collegeAcadOrg:r,departmentCode:a,acceleratedConcurrent:o,locations:s=[],keyword:n,blacklistAcadPlans:i,program:p,showCerts:c}}){const m=u=>!r||u.getCollegeAcadOrgJoint().includes(r),g=u=>!a||u.getDepartmentCode().includes(a),b=u=>{var h;return!s.length||((h=u.getCampusList())==null?void 0:h.some(I=>s.some(D=>D.value===I.campusCode)))},l=(u={})=>{var h;return!me(o)||((h=u[o.value])==null?void 0:h.length)>0},y=(u,h)=>!!(!h||new RegExp(h,"i").test(u.getMajorDesc())),f=(u,h)=>!!(!h||new RegExp(h,"i").test(u.getFullDescription())),v=u=>!(i!=null&&i.includes(u.getAcadPlan())),w=u=>p==="undergrad"?!0:c==="true"&&p==="graduate"?u.isMinorOrCertificate():u.isPhdOrMasters(),S=u=>{const h=V(u);return m(h)&&g(h)&&b(h)&&l(u)&&v(h)&&w(h)},C=[],A=[];return t.filter(u=>{const h=V(u),I=y(h,n),D=f(h,n);return(I||D)&&S(u)?(I?C.push(u):A.push(u),!0):!1}),C.concat(A)}const Ka=t=>t.sort((a,o)=>a.acadPlanMarketingDescription.localeCompare(o.acadPlanMarketingDescription)),za=({dataSource:t,tableView:r=[],programs:a,stateFilters:o})=>{const{collegeAcadOrg:s,departmentCode:n}=t;x.useEffect(()=>{if(!a||!la())return;const i="background:#eee; -webkit-text-stroke: 1px black; color: tomato; padding-left: 0.5rem;",p="font-size:30px;",c="font-size:24px;",m="font-size: 18px; margin-left: 0.5rem;";console.group("<< ASU Degree Page >>"),console.log("%c🏫 Listing Page Programs 📚",i+p),console.log(`%cTotal programs found: ${a.length}`,i+m),console.log("%cPrograms found",i+m),console.log(a),console.log(`%cTotal programs loaded: ${r.length}`,i+m),console.log("%cPrograms loaded",i+m),console.log(r),console.log("%cPage Filters",i+c),console.log(`%c- collegeAcadOrg:${s}`,i+m),console.log(`%c- departmentCode:${n}`,i+m),console.log("%cSearch Filters",i+c),console.log(o),console.groupEnd()})},Zt=()=>e.jsx("div",{className:"container","data-testid":"browse-title",children:e.jsx("h2",{children:e.jsx("span",{className:"highlight-gold",children:"Browse degrees"})})});Zt.__docgenInfo={description:"",methods:[],displayName:"BrowseTitle"};const J=({id:t,label:r,selected:a,multiple:o,options:s,onChange:n})=>e.jsxs("div",{className:"form-group",children:[e.jsx("label",{htmlFor:t,children:r}),e.jsx("select",{className:"form-select",id:t,"data-testid":t,multiple:o,onChange:i=>n(t,i),value:a,children:s==null?void 0:s.map(i=>e.jsx("option",{id:i.id,value:i.value,children:i.text},i.id))})]});J.__docgenInfo={description:`@param {SelectFormGroupProps} props
...
`,we=({programs:t,actionUrls:r})=>{var i,p,c,m,g;const{state:a}=x.useContext(Z),o=(p=(i=a==null?void 0:a.listPageProps)==null?void 0:i.programList)==null?void 0:p.settings,s=((g=(m=(c=a==null?void 0:a.listPageProps)==null?void 0:c.programList)==null?void 0:m.dataSource)==null?void 0:g.program)==="graduate",n=t.map(b=>{const l=V(b),y=()=>{var C;const w=l.isOnline()?l.getOnlineMajorMapURL():l.getGeneralDegreeMajorMap();let S;try{S=`<a href=${(C=new URL(w))==null?void 0:C.toString()}>${l.getRequiredCoursesLabel()} Map</a>`}catch{return""}return S},f=()=>`<div>
      ...
      </ul>`}}});return e.jsx(or,{"data-testid":"accordion-view",children:e.jsx(ba,{cards:n})})};we.propTypes={...ee};we.__docgenInfo={description:`@param {import("..").GridListingProps} props
...
`,gr={[Jt]:te,[ge]:ae};function Pe({dataViewComponent:t,loading:r,programs:a,actionUrls:o,degreesPerPage:s}){let n;s?typeof s!="number"&&(n=parseInt(s,10)):n=8;const i=s||n,p=Ea(a.length,i),c=gr[t],[m,g]=x.useState([]),b=(l,y)=>{const f=(y-1)*i,v=f+i;g(a.slice(f,v))};return x.useEffect(()=>{g(a.slice(0,i))},[a]),e.jsxs("section",{"data-testid":"program-list","data-view-type":t,children:[e.jsx(ur,{}),e.jsx("div",{className:"desktop-view",children:e.jsx(c,{loading:r,programs:m,totalRows:a==null?void 0:a.length,actionUrls:o,degreesPerPage:s||n})}),e.jsx("div",{className:"mobile-view mb-2",children:e.jsx(we,{loading:r,programs:m,totalRows:a==null?void 0:a.length,actionUrls:o,degreesPerPage:s||n})}),a.length>0?e.jsx(Pa,{totalNumbers:7,type:"default",background:"white",totalPages:p,onChange:b,showFirstButton:!0,showLastButton:!0}):e.jsx("section",{className:"container no-space",children:e.jsx(Ca,{message:"No result found for the filters applied"})})]})}Pe.propTypes={dataViewComponent:d.string,...ee,degreesPerPage:d.number};Pe.__docgenInfo={description:`@param {{
...
`,Ce=({value:t,onChange:r,onSearch:a})=>{const[o,s]=x.useState(!1);let n;x.useEffect(()=>()=>clearTimeout(n),[]);const i=p=>{fe({event:"search",action:"type",name:"onenter",type:"search degree programs",text:p})};return e.jsx(hr,{className:"container mt-5","data-searching":o,"data-testid":"search-bar",children:e.jsx("form",{"data-testid":"search-bar-form",className:"uds-form p-0 col-md-6 col-sm-12",onSubmit:p=>{p.preventDefault(),a(),s(!0),n=setTimeout(()=>s(!1),500),clearTimeout(n)},children:e.jsxs("div",{className:"form-group mb-0 me-2",children:[e.jsx("label",{htmlFor:"search-field",children:"Search"}),e.jsxs("div",{className:"d-flex row align-items-baseline g-3",children:[e.jsx("div",{className:"col-sm-12 col-md-6 align-self-end",children:e.jsx("input",{"data-testid":"search-field",id:"search-field",value:t,type:"text",className:"form-control",placeholder:"Search degree programs",onChange:p=>{r(p.target.value),i(p.target.value)}})}),e.jsx("div",{className:"col-sm-12 col-md-6 mt-2 mt-sm-0",children:e.jsx(Vt,{"data-testid":"search-button",color:"maroon",label:"Search now",ariaLabel:"Search now",size:"default",onClick:a})})]})]})})})};Ce.propTypes={value:d.string,onChange:d.func,onSearch:d.func};Ce.__docgenInfo={description:`@param {SearchBarProps} props
@returns {JSX.Element}`,methods:[],displayName:"SearchBar",props:{value:{description:"",type:{name:"string"},required:!1},onChange:{description:"",type:{name:"func"},required:!1},onSearch:{description:"",type:{name:"func"},required:!1}}};const fr=q(Ma)`
...
@returns {JSX.Element}`,methods:[],displayName:"AppComponent",props:{appPathFolder:{description:"",type:{name:"string"},required:!1},actionUrls:{description:"",type:{name:"shape",value:{applyNowUrl:{name:"string",required:!1}}},required:!1},hasSearchBar:{description:"",type:{name:"bool"},required:!1},hasFilters:{description:"",type:{name:"bool"},required:!1},hero:{description:"",type:{name:"shape",value:"Hero.propTypes",computed:!0},required:!1},introContent:{description:"",type:{name:"shape",value:{applyNowUrl:{name:"string",required:!1},type:{name:"enum",value:[{value:'"text"',computed:!1},{value:'"text-media"',computed:!1},{value:'"text-image-overlay"',computed:!1},{value:'"text-photo-grid"',computed:!1}],required:!0},video:{name:"shape",value:{},required:!1},image:{name:"shape",value:{},required:!1},header:{name:"custom",raw:"contentPropShape",required:!1},title:{name:"shape",value:{component:{name:"enum",value:[{value:'"h1"',computed:!1},{value:'"h2"',computed:!1},{value:'"h3"',computed:!1},{value:'"h4"',computed:!1},{value:'"h5"',computed:!1},{value:'"h6"',computed:!1}],required:!1}},required:!1},contents:{name:"arrayOf",value:{name:"custom",raw:"contentPropShape"},required:!1},photoGrid:{name:"shape",value:{images:{name:"arrayOf",value:{name:"custom",raw:"imagePropShape"},required:!1}},required:!1}}},required:!1},programList:{description:"",type:{name:"shape",value:{dataSource:{name:"custom",raw:"dataSourcePropShape",required:!1},settings:{name:"custom",raw:"columSettingsPropShape",required:!1}}},required:!1},degreesPerPage:{description:"",type:{name:"number"},required:!1}}};const Pr={component:re,title:"Program Listing Page",parameters:{docs:{description:{component:"@typedef {import('../../core/types/listing-page-types').ListingPageProps } AppProps"}}}},P=({appPathFolder:t,actionUrls:r,hero:a,introContent:o,programList:s,hasFilters:n,hasSearchBar:i,...p})=>e.jsx(re,{appPathFolder:t,actionUrls:r,hero:a,introContent:o,programList:s,hasSearchBar:i,hasFilters:n,...p}),W={applyNowUrl:"https://admission.asu.edu/apply",majorInfoUrl:`${he()}index.html?path=/story/program-detail-page--default&acadPlan={ACAD_PLAN_CODE}`},K={program:"undergrad"},L={appPathFolder:".",actionUrls:W,hero:null,introContent:{breadcrumbs:[{text:"Academic programs",url:"#"},{text:"Undergraduate degrees",url:`${he()}index.html?path=/story/program-listing-page--default`},{text:"Degree title",url:`${he()}index.html?path=/story/program-detail-page--with-content`,isActive:!0}],type:"text",title:{text:"This is introductory marketing copy. Lorem ipsum dolor sit amet"},contents:[{text:`<p>Lorem, <strong>ipsum</strong> dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?
     ...
     Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?
     Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?`}]},programList:{dataSource:K}},N=P.bind({});N.args={...L};const G=P.bind({});G.args={...L,introContent:null,programList:{...L.programList,dataSource:{...L.programList.dataSource,program:"graduate"}}};const k=P.bind({});k.args={...L,introContent:null,programList:{...L.programList,dataSource:{...L.programList.dataSource,blacklistAcadPlans:["BAACCBS","LAACTBS"]}}};const B=P.bind({});B.args={...L,degreesPerPage:2};const O=P.bind({});O.args={...L,introContent:null,programList:{...L.programList,dataSource:{...L.programList.dataSource,cert:"true",showInactivePrograms:"true"}}};const R=P.bind({});R.args={...N.args,hero:null,programList:{...N.args.programList,dataSource:{...N.args.programList.dataSource,departmentCode:"CPUBAFF",collegeAcadOrg:"CPP"}}};const M=P.bind({});M.args={actionUrls:W,hero:{image:{url:"examples/assets/img/ds_header_undergrad.jpg",altText:"Undergraduate Degrees",size:"medium"},title:{text:"Undergraduate Degrees",highlightColor:"gold"}},introContent:{type:"text",title:{text:"This is introductory marketing copy. Lorem ipsum dolor sit amet"},contents:[{text:`<b>Lorem</b>, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?
    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(ze=(Ke=G.parameters)==null?void 0:Ke.docs)==null?void 0:ze.source}}};var He,Je,Xe,Ye,Ze;k.parameters={...k.parameters,docs:{...(He=k.parameters)==null?void 0:He.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(Xe=(Je=k.parameters)==null?void 0:Je.docs)==null?void 0:Xe.source},description:{story:"@type {{ args: AppProps }}",...(Ze=(Ye=k.parameters)==null?void 0:Ye.docs)==null?void 0:Ze.description}}};var Qe,et,tt,at,rt;B.parameters={...B.parameters,docs:{...(Qe=B.parameters)==null?void 0:Qe.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(nt=(ot=O.parameters)==null?void 0:ot.docs)==null?void 0:nt.source},description:{story:"@type {{ args: AppProps }}",...(lt=(it=O.parameters)==null?void 0:it.docs)==null?void 0:lt.description}}};var ct,dt,pt,mt,ut;R.parameters={...R.parameters,docs:{...(ct=R.parameters)==null?void 0:ct.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(pt=(dt=R.parameters)==null?void 0:dt.docs)==null?void 0:pt.source},description:{story:"@type {{ args: AppProps}}",...(ut=(mt=R.parameters)==null?void 0:mt.docs)==null?void 0:ut.description}}};var gt,ht,ft,xt,yt;M.parameters={...M.parameters,docs:{...(gt=M.parameters)==null?void 0:gt.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(ft=(ht=M.parameters)==null?void 0:ht.docs)==null?void 0:ft.source},description:{story:"@type {{ args: AppProps }}",...(yt=(xt=M.parameters)==null?void 0:xt.docs)==null?void 0:yt.description}}};var bt,jt,vt,St,wt;_.parameters={..._.parameters,docs:{...(bt=_.parameters)==null?void 0:bt.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(At=(It=T.parameters)==null?void 0:It.docs)==null?void 0:At.source},description:{story:"@type {{ args: AppProps}}",...(Ut=(Tt=T.parameters)==null?void 0:Tt.docs)==null?void 0:Ut.description}}};var Dt,kt,Bt,Ot,Rt;U.parameters={...U.parameters,docs:{...(Dt=U.parameters)==null?void 0:Dt.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(Bt=(kt=U.parameters)==null?void 0:kt.docs)==null?void 0:Bt.source},description:{story:"@type {{ args: AppProps}}",...(Rt=(Ot=U.parameters)==null?void 0:Ot.docs)==null?void 0:Rt.description}}};var Mt,_t,$t,Et,Gt;$.parameters={...$.parameters,docs:{...(Mt=$.parameters)==null?void 0:Mt.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
