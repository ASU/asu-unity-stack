import{D as Dt,q as S,j as e,p as h,K as q,s as N,l as Ot,S as Lt,P as n,i as Pt,g as Fe,a as ie,b as X,O as ae,e as At,f as le,c as Et,G as _t,v as Ft,d as Ut,h as Wt,k as R,t as ne,m as z,n as Gt,w as Nt,A as Bt,u as Vt,o as Ue,r as Ht,x as $t,y as Xt,z as zt,B as Jt,T as Yt,E as Qt,C as Kt,F as Tt,H as Zt,M as ea,L as ta,I as aa,J as ra,N as na,Q as oa,R as sa,U as oe,V as ia,W as la,X as We}from"./index-BU9RufXh.js";import{r as k}from"./index-B2SEcK1p.js";import{g as pa}from"./_commonjsHelpers-B3tUAs5q.js";import"./index-BEWoeB4E.js";const Ge=a=>a.map(t=>({title:t.acadPlanDescription,url:t.academicOfficeUrl})).sort((t,r)=>t.title.localeCompare(r.title)),ca=a=>a==null?void 0:a.map(t=>({career:{text:t.alternateTitle,url:`${Dt}/career-details/${t.onetCode}`},growth:t.growth,medianSalary:t.salary.toLocaleString("en-US",{style:"currency",currency:"USD",maximumFractionDigits:0}),brightOutlook:!!t.brightOutlook,greenOccupation:!!t.green}));function ma(a,t){Promise.all(a).then(r=>{const i=r[0],o=r[1];t({accelerateData:i,concurrentData:o})}).catch(()=>{t({accelerateData:[],concurrentData:[]})})}const ua=S.section`
  position: relative;
