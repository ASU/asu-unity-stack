...
@returns {JSX.Element}`,methods:[],displayName:"AppComponent",props:{appPathFolder:{description:"",type:{name:"string"},required:!1},actionUrls:{description:"",type:{name:"shape",value:{applyNowUrl:{name:"string",required:!1}}},required:!1},hasSearchBar:{description:"",type:{name:"bool"},required:!1},hasFilters:{description:"",type:{name:"bool"},required:!1},hero:{description:"",type:{name:"shape",value:"Hero.propTypes",computed:!0},required:!1},introContent:{description:"",type:{name:"shape",value:{applyNowUrl:{name:"string",required:!1},type:{name:"enum",value:[{value:'"text"',computed:!1},{value:'"text-media"',computed:!1},{value:'"text-image-overlay"',computed:!1},{value:'"text-photo-grid"',computed:!1}],required:!0},video:{name:"shape",value:{},required:!1},image:{name:"shape",value:{},required:!1},header:{name:"custom",raw:"contentPropShape",required:!1},title:{name:"shape",value:{component:{name:"enum",value:[{value:'"h1"',computed:!1},{value:'"h2"',computed:!1},{value:'"h3"',computed:!1},{value:'"h4"',computed:!1},{value:'"h5"',computed:!1},{value:'"h6"',computed:!1}],required:!1}},required:!1},contents:{name:"arrayOf",value:{name:"custom",raw:"contentPropShape"},required:!1},photoGrid:{name:"shape",value:{images:{name:"arrayOf",value:{name:"custom",raw:"imagePropShape"},required:!1}},required:!1}}},required:!1},programList:{description:"",type:{name:"shape",value:{dataSource:{name:"custom",raw:"dataSourcePropShape",required:!1},settings:{name:"custom",raw:"columSettingsPropShape",required:!1}}},required:!1},degreesPerPage:{description:"",type:{name:"number"},required:!1}}};const wr={component:ee,title:"Program Listing Page",parameters:{docs:{description:{component:"@typedef {import('../../core/types/listing-page-types').ListingPageProps } AppProps"}}}},P=({appPathFolder:t,actionUrls:r,hero:a,introContent:o,programList:s,hasFilters:i,hasSearchBar:n,...p})=>e.jsx(ee,{appPathFolder:t,actionUrls:r,hero:a,introContent:o,programList:s,hasSearchBar:n,hasFilters:i,...p}),_={applyNowUrl:"https://admission.asu.edu/apply",majorInfoUrl:`${me()}index.html?path=/story/program-detail-page--default&acadPlan={ACAD_PLAN_CODE}`},$={program:"undergrad"},w={appPathFolder:".",actionUrls:_,hero:null,introContent:{breadcrumbs:[{text:"Academic programs",url:"#"},{text:"Undergraduate degrees",url:`${me()}index.html?path=/story/program-listing-page--default`},{text:"Degree title",url:`${me()}index.html?path=/story/program-detail-page--with-content`,isActive:!0}],type:"text",title:{text:"This is introductory marketing copy. Lorem ipsum dolor sit amet"},contents:[{text:`<p>Lorem, <strong>ipsum</strong> dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?
     ...
     Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?
     Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?`}]},programList:{dataSource:$}},F=P.bind({});F.args={...w};const M=P.bind({});M.args={...w,introContent:null,programList:{...w.programList,dataSource:{...w.programList.dataSource,program:"graduate"}}};const A=P.bind({});A.args={...w,introContent:null,programList:{...w.programList,dataSource:{...w.programList.dataSource,blacklistAcadPlans:["BAACCBS","LAACTBS"]}}};const T=P.bind({});T.args={...w,degreesPerPage:2};const U=P.bind({});U.args={...w,introContent:null,programList:{...w.programList,dataSource:{...w.programList.dataSource,cert:"true",showInactivePrograms:"true"}}};const D=P.bind({});D.args={...F.args,hero:null,programList:{...F.args.programList,dataSource:{...F.args.programList.dataSource,departmentCode:"CPUBAFF",collegeAcadOrg:"CPP"}}};const k=P.bind({});k.args={actionUrls:_,hero:{image:{url:"examples/assets/img/ds_header_undergrad.jpg",altText:"Undergraduate Degrees",size:"medium"},title:{text:"Undergraduate Degrees",highlightColor:"gold"}},introContent:{type:"text",title:{text:"This is introductory marketing copy. Lorem ipsum dolor sit amet"},contents:[{text:`<b>Lorem</b>, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?
    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?
    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?`}]},programList:{dataSource:$,settings:{hideCollegeSchool:!0,cardDefaultImage:{url:"examples/assets/img/ds_header_undergrad.jpg"}}}};const O=P.bind({});O.args={actionUrls:_,hero:{image:{url:"examples/assets/img/ds_header_undergrad.jpg",size:"medium"},title:{text:"Area of study degrees",highlightColor:"gold"}},introContent:{type:"text-photo-grid",title:{text:"This is introductory marketing copy. Lorem ipsum dolor sit amet"},contents:[{text:`<b>Lorem</b>, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?
    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?
    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?`}],photoGrid:{images:[{url:"examples/assets/img/demo-phot-1.jpeg"},{url:"examples/assets/img/demo-phot-2.jpeg"},{url:"examples/assets/img/demo-phot-3.jpeg"}]}},hasFilters:!1,hasSearchBar:!1,programList:{dataSource:$}};const C=P.bind({});C.args={actionUrls:_,hero:{image:{url:"examples/assets/img/ds_header_undergrad.jpg",size:"medium"},title:{text:"Area of study degrees",highlightColor:"gold"}},introContent:{type:"text-media",title:{text:"This is introductory marketing copy. Lorem ipsum dolor sit amet"},contents:[{text:`<b>Lorem</b>, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?
     Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?
     Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?`}],image:{url:"https://source.unsplash.com/random/800x400?a=1"}},programList:{dataSource:$}};const N=P.bind({});N.args={...C.args};N.args.introContent={...C.args.introContent,image:void 0,video:{url:"/examples/assets/video/stock-video-person-drawing.mp4",title:"",vttUrl:""}};const I=P.bind({});I.args={...C.args};I.args.introContent={...C.args.introContent,image:void 0,video:{type:"youtube",url:"https://www.youtube.com/embed/YW2p0ctzK9c"}};const B=P.bind({});B.args={actionUrls:_,hero:{image:{url:"examples/assets/img/ds_header_undergrad.jpg",size:"medium"},title:{text:"[Subdomain] degrees in [area of study]",highlightColor:"gold"}},introContent:{type:"text-image-overlay",header:{text:"Intro Content Image Overlay"},title:{text:"This is the contents that goes in the box"},contents:[{text:`<b>Instagram</b> tour operator travel sailing flying package.
         ...
         Budget Pacific guide caravan Barcelona place to stay maps gateway diary tour operator money`}],image:{url:"https://source.unsplash.com/random/800x600?a=1"}},programList:{dataSource:$}};var Be,Re,Me,_e,$e;F.parameters={...F.parameters,docs:{...(Be=F.parameters)==null?void 0:Be.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(ut=(mt=k.parameters)==null?void 0:mt.docs)==null?void 0:ut.source},description:{story:"@type {{ args: AppProps }}",...(ht=(gt=k.parameters)==null?void 0:gt.docs)==null?void 0:ht.description}}};var ft,xt,yt,bt,jt;O.parameters={...O.parameters,docs:{...(ft=O.parameters)==null?void 0:ft.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(yt=(xt=O.parameters)==null?void 0:xt.docs)==null?void 0:yt.source},description:{story:"@type {{ args: AppProps }}",...(jt=(bt=O.parameters)==null?void 0:bt.docs)==null?void 0:jt.description}}};var vt,St,Pt,wt,Ct;C.parameters={...C.parameters,docs:{...(vt=C.parameters)==null?void 0:vt.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(Pt=(St=C.parameters)==null?void 0:St.docs)==null?void 0:Pt.source},description:{story:"@type {{ args: AppProps}}",...(Ct=(wt=C.parameters)==null?void 0:wt.docs)==null?void 0:Ct.description}}};var Lt,Ft,qt,Nt,It;N.parameters={...N.parameters,docs:{...(Lt=N.parameters)==null?void 0:Lt.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(Ut=(Tt=I.parameters)==null?void 0:Tt.docs)==null?void 0:Ut.source},description:{story:"@type {{ args: AppProps}}",...(kt=(Dt=I.parameters)==null?void 0:Dt.docs)==null?void 0:kt.description}}};var Ot,Bt,Rt,Mt,_t;B.parameters={...B.parameters,docs:{...(Ot=B.parameters)==null?void 0:Ot.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(Rt=(Bt=B.parameters)==null?void 0:Bt.docs)==null?void 0:Rt.source},description:{story:`@param {AppProps} props
@returns {JSX.Element}`,...(_t=(Mt=B.parameters)==null?void 0:Mt.docs)==null?void 0:_t.description}}};const Cr=["Default","DefaultGraduate","DefaultWithBlacklistedPlanCodes","DefaultWithDegreesPerPageSet","DefaultWithCertificate","WithCollegeAcadOrgAndDepartmentCode","WithIntroText","WithIntroTextPhotoGrid","WithIntroTextMediaImage","WithIntroTextMediaVideo","WithIntroTextMediaYoutubeVideo","WithIntroTextImageOverlay"];export{F as Default,M as DefaultGraduate,A as DefaultWithBlacklistedPlanCodes,U as DefaultWithCertificate,T as DefaultWithDegreesPerPageSet,D as WithCollegeAcadOrgAndDepartmentCode,k as WithIntroText,B as WithIntroTextImageOverlay,C as WithIntroTextMediaImage,N as WithIntroTextMediaVideo,I as WithIntroTextMediaYoutubeVideo,O as WithIntroTextPhotoGrid,Cr as __namedExportsOrder,wr as default};
