...
`;function tr({applyNowUrl:t,title:r,contents:a,photoGrid:o}){const s=he(r);return e.jsx("section",{className:"container","data-type":"text-photo-grid","data-testid":"intro-content",children:e.jsxs("div",{className:"row",children:[e.jsxs("div",{className:"col-sm-12 col-md-5",children:[e.jsx(s,{className:"mt-0",children:e.jsx("span",{className:`${K(r.cssClass)}`,children:r.text})}),e.jsx(fe,{contents:a}),e.jsx(H,{href:t})]}),e.jsx("div",{className:"col-sm-12 col-md-7 d-none d-sm-none d-md-block",children:e.jsx(Qa,{className:"row",children:o.images.map((i,n)=>e.jsx("div",{className:"photo-item col-sm-12 col-md-6 col-lg-6",children:e.jsx("img",{className:`mg-fluid ${K(i.cssClass)}`,src:i.url,alt:i.altText,style:{maxWidth:"100%"}})},`img-${n+1}`))})})]})})}function ar({applyNowUrl:t,title:r,contents:a,image:o,video:s}){const i=he(r);return e.jsx(er,{className:"container","data-type":"text-media","data-testid":"intro-content",children:e.jsxs("div",{className:"row gy-3",children:[e.jsxs("div",{className:"col-sm-12 col-md-5",children:[e.jsx(i,{className:"mt-0",children:e.jsx("span",{className:`${K(r.cssClass)}`,children:r.text})}),e.jsx(fe,{contents:a}),e.jsx(H,{href:t})]}),e.jsxs("div",{className:"col-sm-12 col-md-7 mt-2 mt-sm-0",children:[s&&e.jsx(xa,{type:s.type,url:s.url,vttUrl:s.vttUrl,title:s.title,className:"mt-0"}),o&&e.jsx("div",{className:"uds-img",children:e.jsx("img",{src:o.url,className:"img-fluid",alt:o.altText})})]})]})})}function rr({applyNowUrl:t,title:r,contents:a,image:o}){return e.jsx("section",{className:"container","data-type":"text-image-overlay","data-testid":"intro-content",children:e.jsx("div",{className:"row",children:e.jsx("div",{className:"col-md-12",children:e.jsx(ya,{title:r.text,contents:a,image:o,contentDirection:"right",contentChildren:e.jsx("div",{className:"mt-2",children:e.jsx(H,{href:t})})})})})})}const sr=({applyNowUrl:t,title:r,contents:a})=>{const o=he(r);return e.jsx("section",{className:"container","data-type":"text","data-testid":"intro-content",children:e.jsxs("div",{className:"row",children:[e.jsx("div",{className:"col-sm-12 col-md-5",children:e.jsx(o,{className:"mt-0",children:e.jsx("span",{className:`${K(r.cssClass)}`,children:r.text})})}),e.jsxs("div",{className:"col-sm-12 col-md-7",children:[e.jsx(fe,{contents:a}),e.jsx(H,{href:t})]})]})})},be=({applyNowUrl:t,type:r,title:a,contents:o,image:s,video:i,photoGrid:n})=>({text:()=>sr({applyNowUrl:t,title:a,contents:o}),"text-media":()=>ar({applyNowUrl:t,title:a,contents:o,image:s,video:i}),"text-image-overlay":()=>rr({applyNowUrl:t,title:a,contents:o,image:s}),"text-photo-grid":()=>tr({applyNowUrl:t,title:a,contents:o,image:s,photoGrid:n}),undefined:()=>(console.error(`the type '${r}' is not supported by the 'IntroContent' component.`),null)})[r]();be.propTypes={applyNowUrl:d.string,type:d.oneOf(["text","text-media","text-image-overlay","text-photo-grid"]).isRequired,video:d.shape({...ma}),image:d.shape({...ua}),header:Te,title:d.shape({...ga,component:d.oneOf(ha)}),contents:d.arrayOf(Te),photoGrid:d.shape({images:d.arrayOf(fa)})};const Y={programs:d.arrayOf(d.object),totalRows:d.number,loading:d.bool,actionUrls:d.shape({applyNowUrl:d.string,majorInfoUrl:d.string,majorInfoOnlineUrl:d.string}),degreesPerPage:d.number},or=L.div`
  & {
    ul {
      margin-top: 1.5rem;
      margin-bottom: 0;
...
`;function Z({programs:t,loading:r,actionUrls:a}){var c,m,h,b;const{defaultState:o,state:s}=x.useContext(J),i=(b=(h=(m=(c=s==null?void 0:s.listPageProps)==null?void 0:c.programList)==null?void 0:m.settings)==null?void 0:h.cardDefaultImage)==null?void 0:b.url,n=o.detailPageDefault.hero.image.url,p=i||n;return e.jsx(nr,{id:Gt,className:"container row","data-loading":r,"data-testid":"grid-view",children:t.map(l=>{const y=z(l);return e.jsx("div",{className:"col col-sm-12 col-md-4 col-lg-3 mb-2",children:e.jsx(ja,{type:"degree",horizontal:!1,clickable:!1,image:p,imageAltText:"An example image",title:y.getMajorDesc(),linkLabel:"View Program Details",linkUrl:X(y,a.majorInfoUrl),buttons:[{color:"maroon",size:"small",label:"Reqeuest Info",href:Wa()},{color:"gold",size:"small",label:"Apply",href:a.applyNowUrl}]})})})})}Z.propTypes={...Y};Z.__docgenInfo={description:`@param {import("..").GridListingProps} props
@returns {JSX.Element}`,methods:[],displayName:"GridView",props:{programs:{description:"",type:{name:"arrayOf",value:{name:"object"}},required:!1},totalRows:{description:"",type:{name:"number"},required:!1},loading:{description:"",type:{name:"bool"},required:!1},actionUrls:{description:"",type:{name:"shape",value:{applyNowUrl:{name:"string",required:!1},majorInfoUrl:{name:"string",required:!1},majorInfoOnlineUrl:{name:"string",required:!1}}},required:!1},degreesPerPage:{description:"",type:{name:"number"},required:!1}}};const ir=[{dataKey:"Major",label:"Major",className:"major",sortable:!0,contentTemplate:({resolver:t,rowIndex:r,actionUrls:a,onClick:o})=>e.jsxs("div",{className:"cell-container",children:[e.jsx("a",{href:X(t,a==null?void 0:a.majorInfoUrl),children:t.getMajorDesc()}),e.jsx(va,{dataId:"show-row-detail",ariaLabel:`${t.getMajorDesc()} arrow`,ariaControls:`row-info-${r}`,onClick:s=>o(r,s)})]})},{dataKey:"Degree",label:"Degree",className:"degree",contentTemplate:({resolver:t})=>e.jsxs("div",{className:"cell-container",children:[e.jsx("span",{children:t.getDegree()}),e.jsx(ie,{popover:{title:t.getDegreeDesc(),body:t.getDegreeDescLong(),withAuto:!1}})]})},{dataKey:"RequiredCourses",label:"Required Courses",className:"required-course",contentTemplate:({resolver:t})=>{var s;const a=t.isOnline()?t.getOnlineMajorMapURL():t.getGeneralDegreeMajorMap();let o;try{const i=(s=new URL(a))==null?void 0:s.toString();o=e.jsxs("a",{href:i,children:[t.getRequiredCoursesLabel()," Map"]})}catch{return""}return o}},{dataKey:"Location",label:"Campus or location",className:"campus-location",sortable:!0,contentTemplate:({resolver:t})=>{const r=ge("campus-");return e.jsx("div",{children:t.getCampusList().map((a,o,s)=>e.jsxs("div",{className:"cell-container",children:[e.jsx("span",{children:`${de(Sa(a.campusCode))}${o<s.length-1?", ":""}`},a.campusCode),e.jsx("span",{children:e.jsx(ie,{popover:{title:de(a.campusCode),body:()=>fetch(Ga(a.campusCode)),withAuto:!0}})})]},r.next().value))})}},{dataKey:"AcceleratedConcurrent",label:"Accelerated/ Concurrent",className:"accelerated-concurrent",sortable:!0,contentTemplate:({resolver:t,actionUrls:r})=>e.jsxs("div",{children:[t.getConcurrentDegrees().then(a=>a).length>0&&e.jsx("div",{className:"cell-container",children:"concurrent"}),t.hasConcurrentOrAccelerateDegrees()&&e.jsxs("div",{className:"cell-container",children:[e.jsx("a",{href:Ht(t,r.majorInfoUrl),children:"4+1 years"}),e.jsx(ie,{popover:{title:"4+1 years",body:()=>fetch(Va(t.getAcadPlan())),withAuto:!1}})]})]})},{dataKey:"CollegeSchool",label:"College/School",className:"college",sortable:!0,contentTemplate:({resolver:t})=>e.jsx("a",{href:t.getCollegeUrl(),children:t.getCollegeDesc()})}],lr=wa`
  @keyframes loading {
    40% {
...
`,gr={[Kt]:Z,[pe]:Q};function ve({dataViewComponent:t,loading:r,programs:a,actionUrls:o,degreesPerPage:s}){let i;s?typeof s!="number"&&(i=parseInt(s,10)):i=8;const n=s||i,p=Ea(a.length,n),c=gr[t],[m,h]=x.useState([]),b=(l,y)=>{const f=(y-1)*n,v=f+n;h(a.slice(f,v))};return x.useEffect(()=>{h(a.slice(0,n))},[a]),e.jsxs("section",{"data-testid":"program-list","data-view-type":t,children:[e.jsx(ur,{}),e.jsx("div",{className:"desktop-view",children:e.jsx(c,{loading:r,programs:m,totalRows:a==null?void 0:a.length,actionUrls:o,degreesPerPage:s||i})}),e.jsx("div",{className:"mobile-view mb-2",children:e.jsx(je,{loading:r,programs:m,totalRows:a==null?void 0:a.length,actionUrls:o,degreesPerPage:s||i})}),a.length>0?e.jsx(Pa,{totalNumbers:7,type:"default",background:"white",totalPages:p,onChange:b,showFirstButton:!0,showLastButton:!0}):e.jsx("section",{className:"container no-space",children:e.jsx(Ca,{message:"No result found for the filters applied"})})]})}ve.propTypes={dataViewComponent:d.string,...Y,degreesPerPage:d.number};ve.__docgenInfo={description:`@param {{
...
@returns {JSX.Element}`,methods:[],displayName:"ListView",props:{programs:{description:"",type:{name:"arrayOf",value:{name:"object"}},required:!1},totalRows:{description:"",type:{name:"number"},required:!1},loading:{description:"",type:{name:"bool"},required:!1},actionUrls:{description:"",type:{name:"shape",value:{applyNowUrl:{name:"string",required:!1},majorInfoUrl:{name:"string",required:!1},majorInfoOnlineUrl:{name:"string",required:!1}}},required:!1},degreesPerPage:{description:"",type:{name:"number"},required:!1}}};const hr=L.div`
...
`,Se=({value:t,onChange:r,onSearch:a})=>{const[o,s]=x.useState(!1);let i;x.useEffect(()=>()=>clearTimeout(i),[]);const n=p=>{ue({event:"search",action:"type",name:"onenter",type:"search degree programs",text:p})};return e.jsx(hr,{className:"container mt-5","data-searching":o,"data-testid":"search-bar",children:e.jsx("form",{"data-testid":"search-bar-form",className:"uds-form p-0 col-md-6 col-sm-12",onSubmit:p=>{p.preventDefault(),a(),s(!0),i=setTimeout(()=>s(!1),500),clearTimeout(i)},children:e.jsxs("div",{className:"form-group mb-0 me-2",children:[e.jsx("label",{htmlFor:"search-field",children:"Search"}),e.jsxs("div",{className:"d-flex row align-items-baseline g-3",children:[e.jsx("div",{className:"col-sm-12 col-md-6 align-self-end",children:e.jsx("input",{"data-testid":"search-field",id:"search-field",value:t,type:"text",className:"form-control",placeholder:"Search degree programs",onChange:p=>{r(p.target.value),n(p.target.value)}})}),e.jsx("div",{className:"col-sm-12 col-md-6 mt-2 mt-sm-0",children:e.jsx(Et,{"data-testid":"search-button",color:"maroon",label:"Search now",ariaLabel:"Search now",size:"default",onClick:a})})]})]})})})};Se.propTypes={value:d.string,onChange:d.func,onSearch:d.func};Se.__docgenInfo={description:`@param {SearchBarProps} props
@returns {JSX.Element}`,methods:[],displayName:"SearchBar",props:{value:{description:"",type:{name:"string"},required:!1},onChange:{description:"",type:{name:"func"},required:!1},onSearch:{description:"",type:{name:"func"},required:!1}}};const fr=L(qa)`
...
`,yr=L.div.attrs({className:"container"})`
  border-bottom: 1px solid #d0d0d0;
  margin-bottom: calc(var(--uds-dp-section-margin) / 2);
  padding-bottom: calc(var(--uds-dp-section-margin) / 2);
`,we=({appPathFolder:t,actionUrls:r,hasSearchBar:a=!0,hasFilters:o=!0,hero:s,introContent:i,programList:n,degreesPerPage:p})=>{var Ae;const[{data:c,loading:m,error:h},b]=Ia(),[l,y]=x.useState(!1),[f,v]=x.useState([]),[S,u]=x.useState([]),[g,q]=x.useState(""),E=(Ae=n.settings)==null?void 0:Ae.defaultView,Xt=[pe,Kt].includes(E)?E:pe,[Yt,br]=x.useState(Xt),te=Aa(n.dataSource,Ma),{defaultState:Zt}=x.useContext(J),{listingPageDefault:Pe}=Zt,{collegeAcadOrg:Ce,departmentCode:Le,showInactivePrograms:Qt,blacklistAcadPlans:Fe,program:qe,cert:ea}=n.dataSource,[Ne,ae]=x.useState({...R}),[G,Ie]=x.useState({...R});za({dataSource:n.dataSource,tableView:f,programs:c,stateFilters:Ne}),x.useEffect(()=>{typeof window<"u"&&Ta({packageName:"app-degree-pages",component:"ListingPage",type:"NA",configuration:{programList:n,degreesPerPage:p}})},[]),x.useEffect(()=>{b(te)},[te]),x.useEffect(()=>{let j=Ka(c||[]);j=De({programs:j,filters:{collegeAcadOrg:Ce,departmentCode:Le,blacklistAcadPlans:Fe,program:qe,showCerts:ea}}),u(j),v(j)},[c,p]);const re=async j=>{const{acceleratedConcurrent:se,locations:V,asuLocals:oe,keyword:ne}=j;y(!0),b(te);const na=De({programs:S,filters:{collegeAcadOrg:Ce,departmentCode:Le,acceleratedConcurrent:se,locations:oe.length>0?V.concat($a):V,keyword:ne,showInactivePrograms:Qt??!1,blacklistAcadPlans:Fe,program:qe}});ae({...j}),Ie({...j}),v(na),y(!1)},ta=async()=>{const j={...G,keyword:g};re(j)},aa=j=>{m||l||re(j)},ra=async j=>{ae(j)},sa=()=>{ae(R),Ie(R),v(S),q("")},oa=(j,{value:se})=>{const V=j==="acceleratedConcurrent"?_a:G[j].filter(ne=>ne.value!==se),oe={...G,[j]:V};re(oe)};return e.jsxs(e.Fragment,{children:[e.jsx(Ua,{}),e.jsx(xr,{}),h&&e.jsx(Da,{message:ka}),s!=null&&s.hide?null:e.jsx("section",{"data-testid":"hero",children:e.jsx(zt,{image:(s==null?void 0:s.image)||Pe.hero.image,title:{text:Ba(n.dataSource),highlightColor:"gold",...s==null?void 0:s.title,maxWidth:"100%"},contents:s==null?void 0:s.contents})}),e.jsxs(fr,{"data-is-loading":m,className:"main-section dg-margin-top",children:[(i==null?void 0:i.breadcrumbs)&&e.jsx("div",{className:"container mt-4 mb-0",children:e.jsx(Oa,{breadcrumbs:i.breadcrumbs,section:s?s.title.text:""})}),i?e.jsx(be,{applyNowUrl:(r==null?void 0:r.applyNowUrl)||Pe.actionUrls.applyNowUrl,type:i.type,header:i.header,title:i.title,contents:i.contents,image:i.image,video:i.video,photoGrid:i.photoGrid}):null,a||o?e.jsxs("section",{className:"no-space",children:[e.jsx(Jt,{}),a?e.jsx(Se,{value:g,onChange:q,onSearch:ta}):null,o?e.jsx(xe,{value:Ne,onChange:ra,onApply:aa,onClean:sa}):null,e.jsx(yr,{})]}):null,e.jsx("section",{className:"container",children:e.jsx("div",{className:"d-flex justify-content-between filter-switch-container",children:o?e.jsx(ye,{value:G,onRemove:oa}):null})}),m||l?e.jsx(Ra,{}):e.jsx(ve,{dataViewComponent:Yt,loading:m||l,programs:f,actionUrls:r,degreesPerPage:p})]})]})};we.propTypes={appPathFolder:d.string,actionUrls:d.shape({applyNowUrl:d.string}),hasSearchBar:d.bool,hasFilters:d.bool,hero:d.shape(zt.propTypes),introContent:d.shape(be.propTypes),programList:d.shape({dataSource:La,settings:Fa}),degreesPerPage:d.number};const ee=t=>e.jsx(Na,{listPageProps:t,children:e.jsx(we,{...t})});ee.propTypes=we.propTypes;ee.__docgenInfo={description:`@param {ListingPageProps} props
