...
`,we=({programs:t,actionUrls:r})=>{var i,p,c,m,g;const{state:a}=x.useContext(Q),o=(p=(i=a==null?void 0:a.listPageProps)==null?void 0:i.programList)==null?void 0:p.settings,s=((g=(m=(c=a==null?void 0:a.listPageProps)==null?void 0:c.programList)==null?void 0:m.dataSource)==null?void 0:g.program)==="graduate",n=t.map(b=>{const l=V(b),y=()=>{var C;const w=l.isOnline()?l.getOnlineMajorMapURL():l.getGeneralDegreeMajorMap();let S;try{S=`<a href=${(C=new URL(w))==null?void 0:C.toString()}>${l.getRequiredCoursesLabel()} Map</a>`}catch{return""}return S},f=()=>`<div>
