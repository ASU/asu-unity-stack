import{D as Dt,q as S,j as e,p as h,n as q,s as C,c as Lt,w as pe,E as Et,P as r,i as Pt,g as Ue,a as se,b as X,O as ae,e as At,f as le,d as _t,h as Ft,v as Ut,k as Wt,l as Gt,m as I,t as ne,o as z,S as Bt,r as Ct,A as Vt,u as Ht,x as We,y as $t,z as Xt,B as zt,C as Jt,F as Yt,T as Qt,G as Kt,H as Zt,X as Nt,I as ea,M as ta,L as aa,J as ra,K as na,N as ia,Q as oa,R as sa,U as ie,V as la,W as pa,Y as Ge}from"./index-DXbF1A68.js";import{r as k}from"./index-B2SEcK1p.js";import"./index-DRhfoGl8.js";import"./_commonjsHelpers-B3tUAs5q.js";const Be=a=>a.map(t=>({title:t.acadPlanDescription,url:t.academicOfficeUrl})).sort((t,n)=>t.title.localeCompare(n.title)),ca=a=>a==null?void 0:a.map(t=>({career:{text:t.alternateTitle,url:`${Dt}/career-details/${t.onetCode}`},growth:t.growth,medianSalary:t.salary.toLocaleString("en-US",{style:"currency",currency:"USD",maximumFractionDigits:0}),brightOutlook:!!t.brightOutlook,greenOccupation:!!t.green}));function ma(a,t){Promise.all(a).then(n=>{const o=n[0],i=n[1];t({accelerateData:o,concurrentData:i})}).catch(()=>{t({accelerateData:[],concurrentData:[]})})}const ua=S.section`
  position: relative;
