...
const Base = ({ children }) => /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children });
Base.propTypes = {
...
const Container = ({ children, className = "container", ...rest }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className, ...rest, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row", children }) });
};
Container.propTypes = {
