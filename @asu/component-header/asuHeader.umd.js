...
`,no=Yi.a`
  ...
  line-height: unset;
  white-space: unset;
`,ro=Vr(),ao=`${ro}/assets/img/arizona-state-university-logo-vertical.png`,io=`${ro}/assets/img/arizona-state-university-logo.png`,oo=()=>{const{logo:e}=oa();return s.jsxs(no,{href:(null==e?void 0:e.brandLink)??"https://asu.edu",className:"navbar-brand","data-testid":"logo",onClick:()=>Kr({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:"asu logo"}),children:[s.jsx("img",{className:"vert",src:(null==e?void 0:e.src)??ao,alt:(null==e?void 0:e.alt)??"Arizona State University",title:(null==e?void 0:e.title)??"ASU home page",width:"303",height:"234",decoding:"async",fetchpriority:"high"}),s.jsx("img",{className:"horiz",src:(null==e?void 0:e.mobileSrc)??io,alt:(null==e?void 0:e.alt)??"Arizona State University",title:(null==e?void 0:e.title)??"ASU home page",width:"400",height:"72",decoding:"async",fetchpriority:"high"})]})},so=Yi.a`
