...
`,en=({isPartner:e=!1,navTree:t,title:n,baseUrl:r="/",parentOrg:a,parentOrgUrl:i,partnerLogo:o,logo:l,loggedIn:d,userName:c,loginLink:m,onLoginClick:x,logoutLink:T,onLogoutClick:R,buttons:w,breakpoint:_="Xl",animateTitle:h,expandOnHover:A=!1,mobileNavTree:S,searchUrl:L,site:N,renderDiv:F="false"})=>{const ee=Ii(t),ie=Ii(S),Z=Y.useRef(null),re=()=>{window.scrollY>Z.current.getBoundingClientRect().top?Z.current.classList.add("scrolled"):Z.current.classList.remove("scrolled")};Y.useEffect(()=>{typeof window<"u"&&Oc({packageName:"component-header",component:"Component Header",type:"NA",configuration:{site:N,isPartner:e,searchUrl:L,navTree:ee,parentOrg:a,buttons:w,mobileNavTree:ie}})},[]),Y.useEffect(()=>(window==null||window.addEventListener("scroll",re),()=>window.removeEventListener("scroll",re)),[]);const ce=()=>{const V=F==="true"?wd:xd;return p.jsx(V,{id:"asuHeader",ref:Z,breakpoint:_,children:p.jsx(Ds,{})})};return p.jsx(da,{initialValue:{isPartner:e,navTree:ee,title:n,baseUrl:r,parentOrg:a,parentOrgUrl:i,partnerLogo:o,logo:l,loggedIn:d,userName:c,loginLink:m,onLoginClick:x,logoutLink:T,onLogoutClick:R,buttons:w,breakpoint:_,animateTitle:h,expandOnHover:A,mobileNavTree:ie,hasNavigation:!!(ee!=null&&ee.length)||!!(ie!=null&&ie.length),searchUrl:L,site:N},children:ce()})};en.propTypes={...vo};en.__docgenInfo={description:`@param {HeaderProps} props
@returns {JSX.Element}`,methods:[],displayName:"ASUHeader",props:{isPartner:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},baseUrl:{defaultValue:{value:'"/"',computed:!1},description:"",type:{name:"string"},required:!1},breakpoint:{defaultValue:{value:'"Xl"',computed:!1},description:"",type:{name:"enum",value:[{value:'"Lg"',computed:!1},{value:'"Xl"',computed:!1}]},required:!1},expandOnHover:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},renderDiv:{defaultValue:{value:'"false"',computed:!1},description:"",type:{name:"enum",value:[{value:'"true"',computed:!1},{value:'"false"',computed:!1}]},required:!1},navTree:{description:"",type:{name:"arrayOf",value:{name:"custom",raw:"NavTreePropTypes"}},required:!1},partnerLogo:{description:"",type:{name:"shape",value:{alt:{name:"string",required:!1},title:{name:"string",required:!1},src:{name:"string",required:!1},mobileSrc:{name:"string",required:!1},brandLink:{name:"string",required:!1}}},required:!1},logo:{description:"",type:{name:"shape",value:{alt:{name:"string",required:!1},title:{name:"string",required:!1},src:{name:"string",required:!1},mobileSrc:{name:"string",required:!1},brandLink:{name:"string",required:!1}}},required:!1},title:{description:"",type:{name:"string"},required:!1},parentOrg:{description:"",type:{name:"string"},required:!1},parentOrgUrl:{description:"",type:{name:"string"},required:!1},loggedIn:{description:"",type:{name:"bool"},required:!1},userName:{description:"",type:{name:"string"},required:!1},loginLink:{description:"",type:{name:"string"},required:!1},onLoginClick:{description:"",type:{name:"func"},required:!1},logoutLink:{description:"",type:{name:"string"},required:!1},onLogoutClick:{description:"",type:{name:"func"},required:!1},buttons:{description:"",type:{name:"arrayOf",value:{name:"shape",value:{text:{name:"string",required:!0},color:{name:"enum",value:[{value:'"gold"',computed:!1},{value:'"maroon"',computed:!1},{value:'"light"',computed:!1},{value:'"dark"',computed:!1}],required:!1},href:{name:"string",required:!0},classes:{name:"string",required:!1},onClick:{name:"func",required:!1}}}},required:!1},animateTitle:{description:"",type:{name:"bool"},required:!1},mobileNavTree:{description:"",type:{name:"arrayOf",value:{name:"custom",raw:"NavTreePropTypes"}},required:!1},hasNavigation:{description:"",type:{name:"bool"},required:!1},searchUrl:{description:"",type:{name:"string"},required:!1},site:{description:"",type:{name:"string"},required:!1}}};const kd={title:"UDS/ASU Header",component:en,argTypes:{renderDiv:{control:"select",options:["true","false"],description:"Either 'true' or 'false'. If 'true', the header will be rendered as a div instead of a header element."}}},He=e=>p.jsxs(p.Fragment,{children:[p.jsx(en,{...e}),p.jsx("div",{style:{width:"100%",height:"200vh",background:"#f0f0f0",paddingTop:40,marginTop:140},children:p.jsx("h1",{style:{textAlign:"center",fontFamily:"Arial"},children:"Scroll section"})})]}),Sd=e=>{const t=()=>{localStorage.getItem("title_loaded")&&localStorage.removeItem("title_loaded"),setTimeout(()=>{window.location.reload()},1e3)};return p.jsxs(p.Fragment,{children:[p.jsx(en,{...e,animateTitle:!0}),p.jsx("div",{style:{marginTop:200,textAlign:"center"},children:p.jsx(St,{text:"Animate Title",color:"dark",onClick:t})})]})},Lt=He.bind({});Lt.args={loggedIn:!1,userName:"",navTree:Zt,title:"Subdomain name",breakpoint:"Lg",searchUrl:"https://search.asu.edu/search",site:"subdomain",renderDiv:"false"};const Rt=He.bind({});Rt.args={};const Mt=He.bind({});Mt.args={title:"Subdomain name",loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const Dt=He.bind({});Dt.args={title:"Subdomain name",buttons:[{href:"/",text:"CTA Button 1",color:"gold"},{text:"CTA Button 2",href:"#",color:"light"}],loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const Ft=He.bind({});Ft.args={loggedIn:!1,userName:"",logoutLink:"/caslogout",loginLink:"/cas",navTree:Zt,title:"Subdomain name",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const jt=He.bind({});jt.args={loggedIn:!1,userName:"",logoutLink:"/caslogout",loginLink:"/cas",navTree:Zt,mobileNavTree:oc,title:"Subdomain name",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const zt=He.bind({});zt.args={navTree:ic,title:"Subdomain name",buttons:[{href:"/",text:"CTA Button 1",color:"gold",classes:"custom-class"},{text:"CTA Button 2",href:"#",color:"light"}],loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const Ut=He.bind({});Ut.args={navTree:Mo,title:"Subdomain name",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const $t=He.bind({});$t.args={navTree:Mo,title:"Subdomain name",parentOrg:"Parent unit name",parentOrgUrl:"https://engineering.asu.edu",loggedIn:!0,userName:"Sparky",logoutLink:"/caslogout",loginLink:"/cas",expandOnHover:!0,searchUrl:"https://search.asu.edu/search",site:"subdomain"};const qt=He.bind({});qt.args={isPartner:!0,navTree:Zt,loggedIn:!1,userName:"",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain"};const Ht=Sd.bind({});Ht.args={title:"Subdomain name",navTree:Zt,loggedIn:!1,logoutLink:"/caslogout",loginLink:"/cas",breakpoint:"Xl",searchUrl:"https://search.asu.edu/search",site:"subdomain"};var Li,Ri,Mi;Lt.parameters={...Lt.parameters,docs:{...(Li=Lt.parameters)==null?void 0:Li.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(Mi=(Ri=Lt.parameters)==null?void 0:Ri.docs)==null?void 0:Mi.source}}};var Di,Fi,ji;Rt.parameters={...Rt.parameters,docs:{...(Di=Rt.parameters)==null?void 0:Di.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(ji=(Fi=Rt.parameters)==null?void 0:Fi.docs)==null?void 0:ji.source}}};var zi,Ui,$i;Mt.parameters={...Mt.parameters,docs:{...(zi=Mt.parameters)==null?void 0:zi.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...($i=(Ui=Mt.parameters)==null?void 0:Ui.docs)==null?void 0:$i.source}}};var qi,Hi,Wi;Dt.parameters={...Dt.parameters,docs:{...(qi=Dt.parameters)==null?void 0:qi.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div style={{
    width: "100%",
    height: "200vh",
  ...
  </>`,...(Wi=(Hi=Dt.parameters)==null?void 0:Hi.docs)==null?void 0:Wi.source}}};var Bi,Yi,Gi;Ft.parameters={...Ft.parameters,docs:{...(Bi=Ft.parameters)==null?void 0:Bi.docs,source:{originalSource:`args => <>
    <ASUHeader {...args} />
    <div style={{
    width: "100%",
    height: "200vh",
...
}`,...(fo=(uo=Ht.parameters)==null?void 0:uo.docs)==null?void 0:fo.source}}};const Ed=["Default","Empty","NoNavigation","NoNavigationWithButtons","BreakpointXL","WithMobileNavTree","WithButtons","WithMenuColumns","ExpandOnHover","Partner","AnimatedTitle"];export{Ht as AnimatedTitle,Ft as BreakpointXL,Lt as Default,Rt as Empty,$t as ExpandOnHover,Mt as NoNavigation,Dt as NoNavigationWithButtons,qt as Partner,zt as WithButtons,Ut as WithMenuColumns,jt as WithMobileNavTree,Ed as __namedExportsOrder,kd as default};
/**
 * @license React
