...
`,DEFAULT_GA_EVENT={event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"topbar"},Login=()=>{const{loggedIn,userName,logoutLink,loginLink,onLoginClick,onLogoutClick,breakpoint}=useAppContext();return react.createElement(LoginWrapper,{className:"nav-link login-status",breakpoint},loggedIn?react.createElement(react.Fragment,null,userName?react.createElement("span",{className:"name","data-testid":"user-name"},userName):"",react.createElement("a",{className:"signout",href:logoutLink,onClick:e=>{trackGAEvent({...DEFAULT_GA_EVENT,text:"sign out"}),onLogoutClick?.(e)}},"Sign Out")):react.createElement("a",{href:loginLink,onClick:e=>{trackGAEvent({...DEFAULT_GA_EVENT,text:"sign in"}),onLoginClick?.(e)}},"Sign In"))};Login.displayName="Login",Login.__docgenInfo={description:"",methods:[],displayName:"Login"};const SearchWrapper=styled_components_browser_esm.Ay.form`
  button {
    border: none;
...
`,SEARCH_GA_EVENT={event:"search",action:"type",name:"onenter",type:"main search",region:"navbar",section:"topbar"},Search=()=>{const{breakpoint,searchUrl,site}=useAppContext(),isMobile=useIsMobile(breakpoint),inputRef=(0,react.useRef)(null),[open,setOpen]=(0,react.useState)(!1);(0,react.useEffect)((()=>{open&&inputRef.current.focus()}),[open]);const handleChangeVisibility=()=>{setOpen((prevState=>{const newState=!prevState;return trackGAEvent({...SEARCH_GA_EVENT,event:"link",action:"click",name:"onclick",text:newState?"search icon":"close search icon"}),newState}))};return react.createElement(SearchWrapper,{breakpoint,action:searchUrl,onSubmit:e=>{const form=e.target;e.preventDefault(),trackGAEvent({...SEARCH_GA_EVENT,text:e.target.elements.q.value}),setTimeout((()=>{form.submit()}),100)},method:"get",name:"gs",className:open?"open-search":"","data-testid":"universal-nav-search-form"},isMobile?react.createElement("label",null,react.createElement(index_es.g,{icon:free_solid_svg_icons.MjD}),react.createElement("input",{ref:inputRef,className:"form-control",type:"search",name:"q","aria-labelledby":"header-top-search",placeholder:"Search asu.edu",required:!0,onChange:e=>trackGAEvent({...SEARCH_GA_EVENT,text:e.target.value})})):react.createElement(react.Fragment,null,react.createElement("button",{type:"button","aria-label":"Search asu.edu",onClick:handleChangeVisibility,className:"search-button","data-testid":"search-button"},react.createElement(index_es.g,{icon:free_solid_svg_icons.MjD})),open&&react.createElement(react.Fragment,null,react.createElement("input",{ref:inputRef,className:"form-control",type:"search",name:"q","aria-labelledby":"header-top-search",placeholder:"Search asu.edu",required:!0}),react.createElement("button",{type:"button","aria-label":"Search asu.edu",onClick:handleChangeVisibility,className:"close-search","data-testid":"close-search"},react.createElement(index_es.g,{icon:free_solid_svg_icons.GRI})))),react.createElement("input",{name:"url_host",value:site,type:"hidden"}),react.createElement("input",{name:"site",value:"default_collection",type:"hidden"}),react.createElement("input",{name:"sort",value:"date:D:L:d1",type:"hidden"}),react.createElement("input",{name:"output",value:"xml_no_dtd",type:"hidden"}),react.createElement("input",{name:"ie",value:"UTF-8",type:"hidden"}),react.createElement("input",{name:"oe",value:"UTF-8",type:"hidden"}),react.createElement("input",{name:"client",value:"asu_frontend",type:"hidden"}),react.createElement("input",{name:"proxystylesheet",value:"asu_frontend",type:"hidden"}))};Search.displayName="Search",Search.__docgenInfo={description:"",methods:[],displayName:"Search"};const UniversalNavbar_DEFAULT_GA_EVENT={event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"topbar",text:""},UniversalNavbar=()=>{const{breakpoint}=useAppContext();const universalNavLinks=[{className:"nav-link visually-hidden-focusable",href:"#skip-to-content",text:"Skip to main content"},{className:"nav-link visually-hidden-focusable",href:`https://accessibility.asu.edu/report?a11yref=${function getURL(){try{return window.location.href}catch(error){return console.error(error),""}}()}`,text:"Report an accessibility problem"},{className:"nav-link",href:"https://asu.edu",text:"ASU Home"},{className:"nav-link",href:"https://my.asu.edu",text:"My ASU"},{className:"nav-link",href:"https://www.asu.edu/academics/colleges-schools",text:"Colleges and Schools"}];return react.createElement(Wrapper,{breakpoint,className:"universal-nav","data-testid":"universal-navbar","data-elastic-exclude":"data-elastic-exclude"},react.createElement("div",{className:"container-xl"},react.createElement("div",{className:"header-top"},react.createElement("nav",{className:"nav","aria-label":"ASU Global"},react.createElement("div",{className:"links-container"},universalNavLinks.map((link=>react.createElement("a",{key:link.href,className:link.className,href:link.href,onClick:()=>trackGAEvent({...UniversalNavbar_DEFAULT_GA_EVENT,text:link.text})},link.text))),react.createElement(Login,null)),react.createElement(Search,null)))))};UniversalNavbar.displayName="UniversalNavbar",UniversalNavbar.__docgenInfo={description:"",methods:[],displayName:"UniversalNavbar"};const HeaderMainWrapper=styled_components_browser_esm.Ay.div`
  background-color: #ffffff;
  border-bottom: 1px solid #d0d0d0;
  padding: 0 12px;
  .navbar {
...
`,LINK_DEFAULT_PROPS={event:"link",action:"click",name:"onclick",type:"internal link",region:"navbar",section:"main navbar",text:""},HeadingItem=({text})=>react.createElement("h3",{className:"ul-heading"},text);HeadingItem.displayName="HeadingItem",HeadingItem.propTypes={text:prop_types_default().string};const ButtonItem=({link,dropdownName,handleLinkEvent})=>react.createElement("li",{className:"nav-button"},react.createElement(Button,{text:link.text,color:link.color||"dark",href:link.href,onClick:e=>handleLinkEvent(e,link),onKeyDown:handleLinkEvent,onFocus:()=>trackGAEvent({text:link.text,component:dropdownName}),"data-testid":"submenu-item"}));ButtonItem.displayName="ButtonItem",ButtonItem.propTypes={link:prop_types_default().shape({text:prop_types_default().string,color:prop_types_default().string,href:prop_types_default().string}),dropdownName:prop_types_default().string,handleLinkEvent:prop_types_default().func};const LinkItem=({link,dropdownName,handleLinkEvent})=>react.createElement("li",{className:"nav-link"},react.createElement("a",(0,esm_extends.A)({},link.href?{}:{tabIndex:0},{href:link.href,onClick:e=>handleLinkEvent(e,link),onKeyDown:e=>handleLinkEvent(e,link),onFocus:()=>trackGAEvent({text:link.text,component:dropdownName}),"data-testid":"submenu-item"}),link.text));LinkItem.displayName="LinkItem",LinkItem.propTypes={link:prop_types_default().shape({text:prop_types_default().string,href:prop_types_default().string}),dropdownName:prop_types_default().string,handleLinkEvent:prop_types_default().func};const DropdownItem=({dropdownName,items,buttons,classes,listId,setItemOpened,parentLink})=>{const{breakpoint}=useAppContext(),isMega=items?.length>2,dropdownRef=(0,react.useRef)(null),[alignedRight,setAlignedRight]=(0,react.useState)(!1),MULTIPLE_SUBMENUS=items?.length>1;(0,react.useEffect)((()=>{if(window&&dropdownRef.current){const elPosition=dropdownRef.current.getBoundingClientRect().left,breakpointPosition=.55*window.innerWidth;setAlignedRight(elPosition>breakpointPosition)}}),[]);const stopPropagation=e=>e.stopPropagation(),handleLinkEvent=(e,link)=>{const{key,type,target}=e,{parentElement}=target;stopPropagation(e),"ArrowDown"===key?(e.preventDefault(),(()=>{const nextLink=parentElement.nextElementSibling?.firstChild;nextLink&&nextLink.focus()})()):"ArrowUp"===key?(e.preventDefault(),(()=>{const prevLink=parentElement.previousElementSibling?.firstChild;prevLink&&prevLink.focus()})()):"Escape"===key?(setItemOpened(),parentLink&&parentLink.focus()):"Enter"!==key&&" "!==key&&"click"!==type||(link?.onClick?.(e),trackGAEvent({...LINK_DEFAULT_PROPS,text:link.text}))};return react.createElement(DropdownWrapper,{ref:dropdownRef,className:`${classes}${alignedRight?" aligned-right":""}${isMega?" mega":""}`,breakpoint},react.createElement("div",{id:MULTIPLE_SUBMENUS?listId:null,className:"dropdown-container"},items?.map(((item,index0)=>{const key=idGenerator(`dropdown-item-${index0}-`).next().value;return react.createElement("ul",{id:MULTIPLE_SUBMENUS?`${listId}-${key}`:listId,key},item.map(((link,index)=>((link,index)=>{const key=`${link.text}-${link.href||index}`;return"heading"===link.type?react.createElement(HeadingItem,{key,text:link.text}):"button"===link.type?react.createElement(ButtonItem,{key,link,dropdownName,handleLinkEvent}):react.createElement(LinkItem,{key,link,dropdownName,handleLinkEvent})})(link,index))))}))),buttons&&react.createElement("div",{className:"dropdown-button-container"},react.createElement("div",null,buttons.map(((button,index)=>react.createElement(Button,{key:`${button.text}-${button.href||index}`,color:button.color,text:button.text,href:button.href,onClick:stopPropagation}))))))};DropdownItem.displayName="DropdownItem",DropdownItem.propTypes={dropdownName:prop_types_default().string,items:prop_types_default().arrayOf(prop_types_default().arrayOf(prop_types_default().shape({text:prop_types_default().string,selected:prop_types_default().bool,onClick:prop_types_default().func,href:prop_types_default().string}))),buttons:prop_types_default().arrayOf(prop_types_default().shape(ButtonPropTypes)),classes:prop_types_default().string,listId:prop_types_default().string,setItemOpened:prop_types_default().func,parentLink:prop_types_default().shape({focus:prop_types_default().func})},DropdownItem.__docgenInfo={description:"@param {DropdownItemProps} props\n@returns {JSX.Element}",methods:[],displayName:"DropdownItem",props:{dropdownName:{description:"",type:{name:"string"},required:!1},items:{description:"",type:{name:"arrayOf",value:{name:"arrayOf",value:{name:"shape",value:{text:{name:"string",required:!1},selected:{name:"bool",required:!1},onClick:{name:"func",required:!1},href:{name:"string",required:!1}}}}},required:!1},buttons:{description:"",type:{name:"arrayOf",value:{name:"shape",value:{text:{name:"string",required:!0},color:{name:"enum",value:[{value:'"gold"',computed:!1},{value:'"maroon"',computed:!1},{value:'"light"',computed:!1},{value:'"dark"',computed:!1}],required:!1},href:{name:"string",required:!0},classes:{name:"string",required:!1},onClick:{name:"func",required:!1}}}},required:!1},classes:{description:"",type:{name:"string"},required:!1},listId:{description:"",type:{name:"string"},required:!1},setItemOpened:{description:"",type:{name:"func"},required:!1},parentLink:{description:"",type:{name:"shape",value:{focus:{name:"func",required:!1}}},required:!1}}};const NavItemWrapper=styled_components_browser_esm.Ay.li`
  position: relative;
  padding: 0;
  margin: 0 0.5rem 0 0;
...
`,DROPDOWNS_GA_EVENTS={event:"collapse",type:"click"},NavItem_LINK_DEFAULT_PROPS={event:"link",action:"click",name:"onclick",type:"internal link",region:"navbar",section:"main navbar",text:""},NavLinkIcon=({children})=>react.createElement(react.Fragment,null,react.createElement(index_es.g,{icon:free_solid_svg_icons.v02,className:"icon-nav-item",alt:""}),react.createElement("span",{className:"mobile-only"},children));NavLinkIcon.propTypes={children:prop_types_default().node};const NavItem=({link,setItemOpened,itemOpened})=>{const clickRef=(0,react.useRef)(null),parentLink=(0,react.useRef)(null),opened=link.id===itemOpened,{breakpoint,expandOnHover,title}=useAppContext(),isMobile=useIsMobile(breakpoint);(0,react.useEffect)((()=>{const handleClickOutside=event=>{opened&&!clickRef?.current?.contains(event.target)&&setItemOpened()};return document.addEventListener("click",handleClickOutside,!0),()=>{document.removeEventListener("click",handleClickOutside,!0)}}),[opened]);const renderNavLinks=(0,react.useMemo)((()=>"icon-home"===link.type?react.createElement(NavLinkIcon,null,link.text):react.createElement("span",null,link.text,!!link.items?.length&&react.createElement(index_es.g,{icon:free_solid_svg_icons.Jt$,className:"chevron-icon "+(opened?"open":""),alt:""}))),[link]),dispatchGAEvent=()=>{const isDropdown=!!link.items?.length,action=opened?"close":"open",{text}=link;trackGAEvent(isDropdown?{...NavItem_LINK_DEFAULT_PROPS,...DROPDOWNS_GA_EVENTS,action,text}:{...NavItem_LINK_DEFAULT_PROPS,text:"icon-home"===link.type?"home button":text})},handleKeyDown=e=>{if(!link.items&&link.href)return void trackGAEvent({...NavItem_LINK_DEFAULT_PROPS,text:link.text});const{key}=e;if(["ArrowUp","ArrowDown","ArrowLeft","ArrowRight","Enter"," ","Escape","Click"].includes(key)){if(e.preventDefault(),"Escape"===key&&opened)return void setItemOpened();if("Enter"!==key&&" "!==key||(link.items&&(expandOnHover||isMobile?isMobile&&setItemOpened():setItemOpened()),dispatchGAEvent(),link.onClick?.(e)),("ArrowDown"===key||"ArrowRight"===key)&&opened){const dropdownItems=document.querySelectorAll(`.header-dropdown-${link.id} li.nav-link a`);dropdownItems.length&&dropdownItems[0].focus()}}else"click"===e.type&&link.items?(e.preventDefault(),dispatchGAEvent(),setItemOpened()):"click"===e.type&&(dispatchGAEvent(),link.onClick?.(e))},handleOnMouseEnterLeave=()=>{expandOnHover&&!isMobile&&(setItemOpened(),dispatchGAEvent())};return react.createElement(NavItemWrapper,{breakpoint,ref:clickRef,onMouseEnter:handleOnMouseEnterLeave,onMouseLeave:handleOnMouseEnterLeave},react.createElement("a",(0,esm_extends.A)({onKeyDown:handleKeyDown,onClick:handleKeyDown,href:link.href},link.items?{"aria-expanded":opened}:{},link.href?{}:{tabIndex:0},{"aria-owns":link.items?`dropdown-${link.id}`:null,className:`${link.class?link.class:""}${link.selected?" nav-item-selected":""}${opened?" open-link":""}`,"data-testid":"nav-item",title:"icon-home"===link.type&&title?`${title} home page`:link.text,ref:parentLink}),renderNavLinks),link.items&&react.createElement(DropdownItem,{items:link.items,buttons:link.buttons,dropdownName:link.text,classes:`header-dropdown-${link.id} ${opened?"opened":""}`,listId:`dropdown-${link.id}`,setItemOpened,parentLink:parentLink?.current}))};NavItem.displayName="NavItem",NavItem.propTypes={link:NavTreePropTypes,setItemOpened:prop_types_default().func,itemOpened:prop_types_default().number},NavItem.__docgenInfo={description:"@param {{ link: NavTreeProps, setItemOpened: Function, itemOpened: number }} props\n@returns {JSX.Element}",methods:[],displayName:"NavItem",props:{link:{description:"",type:{name:"shape",value:{id:{name:"number",required:!1},href:{name:"string",required:!1},text:{name:"string",required:!1},type:{name:"string",required:!1},selected:{name:"bool",required:!1},items:{name:"arrayOf",value:{name:"arrayOf",value:{name:"object"}},required:!1},buttons:{name:"arrayOf",value:{name:"shape",value:{text:{name:"string",required:!0},color:{name:"enum",value:[{value:'"gold"',computed:!1},{value:'"maroon"',computed:!1},{value:'"light"',computed:!1},{value:'"dark"',computed:!1}],required:!1},href:{name:"string",required:!0},classes:{name:"string",required:!1},onClick:{name:"func",required:!1}}},required:!1},class:{name:"string",required:!1}}},required:!1},setItemOpened:{description:"",type:{name:"func"},required:!1},itemOpened:{description:"",type:{name:"number"},required:!1}}};const NavbarContainer=()=>{const{navTree,mobileNavTree,buttons,breakpoint}=useAppContext(),isMobile=useIsMobile(breakpoint),[itemOpened,setItemOpened]=(0,react.useState)(void 0),renderItem=(link,index)=>{const item={...link,id:index},key=idGenerator(`${link.text}-${index}-`).next().value;return react.createElement(NavItem,{key,link:item,setItemOpened:()=>{return itemId=index,void setItemOpened((prev=>itemOpened===itemId?void 0:itemId));var itemId},itemOpened})};return react.createElement(index_styles_Wrapper,{breakpoint,"data-testid":"navigation","aria-label":"Site"},(navTree?.length||mobileNavTree?.length||buttons?.length)&&react.createElement("div",{className:"content-container"},(navTree?.length||mobileNavTree?.length)&&react.createElement("ul",{className:"nav-list"},mobileNavTree?.length&&isMobile?mobileNavTree?.map(((link,i)=>renderItem(link,i))):navTree?.map(((link,i)=>renderItem(link,i)))),!!buttons?.length&&react.createElement("form",{className:"buttons-container","data-testid":"buttons-container"},buttons?.map((button=>react.createElement(Button,(0,esm_extends.A)({},button,{key:button.text,onClick:()=>trackGAEvent({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:button.text})})))))),isMobile&&react.createElement(UniversalNavbar,null))};NavbarContainer.displayName="NavbarContainer",NavbarContainer.__docgenInfo={description:"",methods:[],displayName:"NavbarContainer"};const PartnerLogosWrapper=styled_components_browser_esm.Ay.div`
  margin: 0.5rem 0;
  a {
    display: inline-block;
    &:not(:last-child) {
...
`,Title=()=>{const[active,setActive]=(0,react.useState)(!1),{title,parentOrg,parentOrgUrl,baseUrl,breakpoint,animateTitle}=useAppContext();return(0,react.useEffect)((()=>{if(!1!==animateTitle){let root="/"===baseUrl?window.location.hostname:baseUrl;root.includes(window.location.hostname)||0!==root.indexOf("/")||(root=window.location.hostname+root),checkFirstLoad(root)&&setActive(!0)}}),[active,animateTitle,baseUrl]),parentOrg?react.createElement(TitleWrapper,{breakpoint,className:"title","data-testid":"title"},react.createElement("a",{className:"unit-name",href:parentOrgUrl,onClick:()=>trackGAEvent({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:parentOrg}),title:`${parentOrg} home page`},parentOrg),react.createElement("a",{className:"subunit-name "+(active?"active":""),href:baseUrl,onClick:()=>trackGAEvent({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:title}),title:`${title} home page`},title)):react.createElement(TitleWrapper,{breakpoint,className:"title","data-testid":"title"},react.createElement("a",{className:"title-subunit-name "+(active?"active":""),href:baseUrl,onClick:()=>trackGAEvent({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:title}),title:`${title} home page`},title))};Title.displayName="Title",Title.propTypes={...TitlePropTypes},Title.__docgenInfo={description:"",methods:[],displayName:"Title",props:{baseUrl:{description:"",type:{name:"string"},required:!1},parentOrg:{description:"",type:{name:"string"},required:!1},parentOrgUrl:{description:"",type:{name:"string"},required:!1},animate:{description:"",type:{name:"bool"},required:!1}}};const HeaderMain=()=>{const{breakpoint,isPartner,hasNavigation}=useAppContext(),[mobileMenuOpen,setMobileMenuOpen]=(0,react.useState)(!1),isMobile=useIsMobile(breakpoint);return react.createElement(react.Fragment,null,!isMobile&&react.createElement(UniversalNavbar,null),react.createElement(HeaderMainWrapper,{breakpoint},react.createElement("div",{className:"container-xl"},react.createElement("div",{className:"header-main"},react.createElement("div",{className:"navbar navbar-expand-xl "+(isPartner?"partner":"")},!isPartner&&react.createElement(Logo,null),react.createElement("button",{className:"navbar-toggler"+(mobileMenuOpen?"":" collapsed"),type:"button",onClick:()=>{setMobileMenuOpen((prevState=>!prevState)),trackGAEvent({event:"collapse",action:mobileMenuOpen?"close":"open",type:"click",text:"menu button tablet"})},"aria-label":"Toggle navigation"},react.createElement(index_es.g,{icon:mobileMenuOpen?free_solid_svg_icons.GRI:free_solid_svg_icons.ckx,alt:""})),react.createElement("div",{className:`${isPartner?"":"expand-title"}${hasNavigation?"":" no-navigation"}`},isPartner?react.createElement(Partner,null):react.createElement(Title,null),!isMobile&&react.createElement(NavbarContainer,null)),mobileMenuOpen&&isMobile&&react.createElement(NavbarContainer,null))))))};HeaderMain.__docgenInfo={description:"",methods:[],displayName:"HeaderMain"};const tryAddActivePage=navTree=>{if(!Array.isArray(navTree)||0===navTree.length)return navTree;if((navTree=>navTree?.find((x=>x.selected)))(navTree))return navTree;let currentPath="";if(window?.location&&(currentPath=window.location.pathname+window.location.search),!currentPath)return navTree;const index=((navTree,path)=>navTree?.findIndex((item=>item?.href===path||Array.isArray(item.items)&&item.items?.flat().find((({href})=>href===path)))))(navTree,currentPath);if(-1===index)return navTree;const newTree=[...navTree];return newTree[index].selected=!0,newTree},header_styles_breakpoints={Lg:"992px",Xl:"1260px"},Header=styled_components_browser_esm.Ay.header`
  font-family: Arial, Helvetica, "Nimbus Sans L", "Liberation Sans", FreeSans,
    sans-serif;
  position: fixed;
  top: 0;
