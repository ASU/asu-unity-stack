...
`,to=Bi.a`
  ...
  line-height: unset;
  white-space: unset;
`,no=Xr(),ro=`${no}/assets/img/arizona-state-university-logo-vertical.png`,ao=`${no}/assets/img/arizona-state-university-logo.png`,io=()=>{const{logo:e}=ia();return o.jsxs(to,{href:(null==e?void 0:e.brandLink)??"https://asu.edu",className:"navbar-brand","data-testid":"logo",onClick:()=>Vr({event:"link",action:"click",name:"onclick",region:"navbar",type:"internal link",section:"main navbar",text:"asu logo"}),children:[o.jsx("img",{className:"vert",src:(null==e?void 0:e.src)??ro,alt:(null==e?void 0:e.alt)??"Arizona State University logo",title:(null==e?void 0:e.title)??"ASU homepage",width:"303",height:"234",decoding:"async",fetchpriority:"high"}),o.jsx("img",{className:"horiz",src:(null==e?void 0:e.mobileSrc)??ao,alt:(null==e?void 0:e.alt)??"Arizona State University logo",title:(null==e?void 0:e.title)??"ASU homepage",width:"400",height:"72",decoding:"async",fetchpriority:"high"})]})},oo=Bi.a`
